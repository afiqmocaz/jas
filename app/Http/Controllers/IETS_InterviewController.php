...
use App\Test;
use App\UserAction;
class IETS_InterviewController extends Controller
{
    /**
	...
	public function iets_iv(){
        ...
        $iets_interview = IvSchedule::all();
		//$iets_confirmediv=Confirmedietsiv::all();
		
		//if (IvSchedule::where('id_user', '=', Auth::id())->exists()){
		// return view('iets.iets_examconfirm',['iets_examschedule' => $iets_examschedule],compact('examuser'));
			//return view('iets.iets_ivconfirmed',['iets_interview' => $iets_interview,'iets_confirmediv' => $iets_confirmediv],compact('iets_interview','iets_confirmediv'));
		//return view('iets.iets_ivconfirmed',['iets_interview' => $iets_interview]);
		//}
		//else
		//{
			return view('iets.iets_iv',['iets_interview' => $iets_interview,'useraction'=>$useraction,'useresult'=>$useresult]);
		
		//return view('iets.iets_iv',['iets_interview' => $iets_interview,'iets_confirmediv' => $iets_confirmediv],compact('iets_interview','iets_confirmediv'));
	...
	public function iv_confirm(){
		...
		return response('You have already make the confirmation', 422);
			...
			$iets_interview = IvSchedule::take(1)->get();
