...
class EiaProfileController extends Controller
{
    /**
    ...
    {
        $category = 'eia';
        $sectionA=eiaSectionA::where('user_id',Auth::id())->first();
        $cert = Cert::where('user_id',Auth::id())->where('category','=',$category)->first();
        return view('eiaprofiles.create', compact('cert','sectionA','category'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('eiaprofiles.edit',compact('category','sectionA','cert'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('eiaprofiles/create');
    }
