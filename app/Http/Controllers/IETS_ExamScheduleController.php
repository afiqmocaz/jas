...
class IETS_ExamScheduleController extends Controller
{
    /**
    ...
    public function index()
    {
     ...
     $eia_examschedule = IetsSchedule::take(1)->get();
     $ietsuserexam=UserExamDetails::all();
      $venue =IetsVenue::all();
      ...
      //$examuser=ExamCandidate::count();
       // return view('examschedules.index', compact('eiaschedule', 'eiaexamtitles', 'eiavenues', 'examuser'));
        if (UserExamDetails::where('user_id', '=', Auth::id())->exists() && IetsRepeatExam::where('user_id', '=', Auth::id())->exists() ){
         ...
         return view('iets_schedules.iets_examconfirm',compact('examuser','ietsuserexam','venue','eia_examschedule','examschedule','useresult','useraction'));
        }
        ...
        return view('iets_schedules.index',['eia_examschedule' => $eia_examschedule,'ietsuserexam'=>$ietsuserexam,'useraction'=>$useraction,'useresult'=>$useresult],compact('examuser','ietsuserexam','useraction','useresult'))->withschedule($eia_examschedule);
         } 
 ...
 $useresult=Test::all();
    ...
    UserAction::create([
       ...
       $ietsuserexam = new UserExamDetails;
        ...
        return redirect() -> route(('iets_schedules.index'));
