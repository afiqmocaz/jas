...
class Tests3Controller extends Controller
{
    ...
    public function index()
    {
        ...
        $questions = QuizEia::where('module', '=', 'Module 3')->paginate(1);
        foreach ($questions as &$question) {
            $question->options = QuizOptions::where('question_id', $question->id)->get();
        }

        return view('tests3.create', compact('questions','selflearnings','module','title'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('results3.show', [$test->id]);
    }
