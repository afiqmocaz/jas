...
class Results4Controller extends Controller
{
    ...
    public function index()
    {
        ...
        return view('results4.index', compact('count','count2','count3','count4','count5','modules', 'results','sum','total','selflearnings','module','title'));
    }
...

    {
        ...
        return view('results4.show', compact('test', 'results','count4','module','title','selflearnings'));
