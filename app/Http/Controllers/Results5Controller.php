...
class Results5Controller extends Controller
{
    ...
    public function index()
    {
        ...
        return view('results5.index', compact('count','count2','count3','count4','count5','modules', 'results','sum','total','selflearnings','module','title'));
    }
...

    {
        ...
        return view('results5.show', compact('test', 'results','count5','selflearnings','module','title'));
