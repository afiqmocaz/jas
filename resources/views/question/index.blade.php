...
7. Secretariat APCS can click button "Save" to save the question of Comprehensive Exam.
    			...
    			{!! Form::open(array('route' => 'question.store', 'data-parsley-validate' => '', 'files' => true)) !!}
					    ...
					    <form action="{{ url('exam/create') }}" method="get">
				      ...
				      <tr>
				        <td rowspan="4">{{$questions->id}}</td>
				        <td rowspan="4">APCS</td>
				        <td rowspan="4">{{$questions->specialized}}</td>
				        <td rowspan="4"><img class="file" src="/images/{{$questions->fileToUpload}}" width="200px"></img><a class="file" href="/images/{{$questions->fileToUpload}}">{{$questions->fileToUpload}}</img></td>
				        ...
				        <td rowspan="4">{{$questions->related}}</td>
				        <td rowspan="4">{{$questions->level}}</td>
				        <td rowspan="4" id="but"><button>Approve<br>Question</button><br><br><form onclick="deleteRow(this)" align="center">
				        
							  {{ HTML::image('images/delete.ico', 'a Delete', array('class' => 'img-responsive cleaner', 'width' => '15', 'height' => '15' )) }}
							</form><br>

							{{ HTML::image('images/edit.png', 'a Delete', array('class' => 'img-responsive cleaner', 'width' => '15', 'height' => '15' )) }}
