...
7. Secretariat APCS can click button "Save" to save the question of Comprehensive Exam.
    			...
    			<!-- {!! Form::open(array('route' => 'question.store', 'data-parsley-validate' => '', 'files'=> true)) !!} -->

    			{!! Form::open(array('url'=>'question/uploadFiles', 'data-parsley-validate' => '', 'method'=>'POST', 'enctype' => 'multipart/form-data', 'files'=>true)) !!}
					    ...
					    <div class="form-group">
					      ...
					      <br><label for="usr">Image Label &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp : </label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="text" id="rr" name="limg" ><br><br>
							...
							<th>
					      	  ...
					      	  <label name="specialized_id" for="1">Specialized Area  &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp: </label>&nbsp&nbsp&nbsp&nbsp
					      	  ...
					      	  <select style="width:200px" id="specialized" name="specialized_id" required="">
  						...
  						<p>Your browser does not support iframes.</p>
							...
							<br><label for="usr">Question  &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp: </label>&nbsp&nbsp&nbsp&nbsp
					      	...
					      	<label for="usr">Sub-Answer &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp : </label>&nbsp&nbsp&nbsp&nbsp
					      	  ...
					      	  <textarea id="sub1" name="i" rows="3" cols="65"></textarea><br><br>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
					      	  <label for="usr">ii.</label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
					      	  <textarea id="sub2" name="ii" rows="3" cols="65"></textarea><br><br>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
					      	  <label for="usr">iii.</label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
					      	  <textarea id="sub3" name="iii" rows="3" cols="65"></textarea><br><br>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
					      	  <label for="usr">iv.</label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp      
					      	  <textarea id="sub4" name="iv" rows="3" cols="65"></textarea><br><br>

					      	<br><br>
					      	<label for="usr">Answer  &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp : </label>&nbsp&nbsp&nbsp&nbsp&nbsp
					      	  ...
					      	  <textarea id="ans3" name="c" rows="3" cols="65"></textarea><br><br>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
					      	...
					      	<tr>
					      	<th>
					      	<label name="related_id" for="usr">Related Reference &nbsp: </label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
					      	 <select style="width:200px" id="related" name="related_id" required="">
				        	<option value="0" disabled="true" selected="true">--Please Select--</option>
					    ...
					    <form action="{{ url('bank/create') }}" method="get">
				      ...
				      <tr>
				        <td rowspan="4"></td>
				        <td rowspan="4">APCS</td>
				        <td rowspan="4">{{$questions->specialized->specialized}}</td>
				        <td rowspan="4"><img class="file" src="/uploads/{{$questions->original_filename}}" width="100px"></img><a class="file" href="/uploads/{{$questions->original_filename}}"><br><center>{{$questions->limg}}</center></img></td>
				        <td rowspan="4">{{$questions->question}}</td>
				        <th id="i">I</th>
				        <td>{{$questions->i}}</td>
				        <th id="a">A</th>
				        <td>{{$questions->a}}</td>
				        <td rowspan="4">{{$questions->correct}}</td>
				        <td rowspan="4">{{$questions->related->related}}</td>
				        <td rowspan="4">{{$questions->level}}</td>
				        <td rowspan="4" id="but"><button>Approve<br>Question</button></td>
				        <td rowspan="4"><center><a href="{{ route('question.edit', $questions->id) }}" >
				        	{{ HTML::image('images/edit.png', 'a Edit', array( 'width' => '20')) }}</a> </center><br></td>

				        	<td rowspan="4">{!! Form::open(['route' => ['question.destroy', $questions->id], 'method' => 'DELETE', 'onsubmit' => 'return ConfirmDelete()']) !!}

				        	<center>{!! Form::image('images/delete.ico', 'a Delete', ['type' => 'submit',  'width' => '17'] ) !!}</center>

				        	{!! Form::close() !!}
				        	</td>
				        <td rowspan="4" id="by">Aizat Hamdan Jailani</td>
				      </tr>
