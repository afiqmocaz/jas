				...
				<!-- end of modal -->
				  ...
				  <table class="order-table table" id="list" style="width:90%;" align="center">
				      ...
				      <tr style="background-color: #4CAF50; color: white;">
				        ...
				        <th style="width:17%;" colspan="2">Sub-Answer</th>
				        <th style="width:17%;" colspan="2">Answer</th>
				      ...
				      <tr>
				       ...
				       <td rowspan="4">{{$eiaquestions->module}}</td>
                    ...
                    @endforeach
                      ...
                      @if($option->correct==1)
				       ...
				       @endif 
				        ...
				        <td rowspan="4"><button type="button" style="width:100%;" title="Question Preview" data-toggle="modal" data-target="#yourModal{{$eiaquestions->id}}">Preview</button>
				        </td>
				       
				        
				        <td><center><a href="{{ route('eiaqs.edit', $eiaquestions->id) }}" >
				        	{{ HTML::image('images/edit.png', 'a Edit', array( 'width' => '20', 'title' => 'Edit')) }}</a> </center><br></td>

				        	<td>{!! Form::open(['route' => ['eiaqs.destroy', $eiaquestions->id], 'method' => 'DELETE', 'onsubmit' => 'return ConfirmDelete()']) !!}
