    			...
    			{!! Form::model($question, ['route' =>['eiaqs.update', $question->id], 'method' => 'PUT', 'files' => true]) !!}
					    <div class="form-group">
					      ...
					      <div class="input-group" style="width: 100%;">
						    ...
						    {!! Form::textarea('option1', $option->option, ['class' => 'form-control ', 'placeholder' => '', 'id' => 'a', 'required' => '', 'style' => 'width:64.5%;', 'size' => '50x4']) !!}
						    @endif
						    @endforeach
					     ...
					     <th>
					      <center>{!! Html::linkRoute('eiaqs.show', 'Cancel', array($question->id), array('class' => 'btn btn-danger btn-block', 'style' => 'width:150px')) !!}</center>
					      </th>
					      </tr>
					      </table></center><br>
