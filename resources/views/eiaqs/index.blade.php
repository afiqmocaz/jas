	      	...
	      	<div class="breadcrumb flat">
    			...
    			<!-- {!! Form::open(array('route' => 'eiaquiz.store', 'data-parsley-validate' => '', 'files' => true)) !!} -->
				      ...
				      <tr>
				        ...
				        <td rowspan="4" id="but"><center><a href="{{ route('eiaqs.edit', $quizs->id) }}" >
				        	{{ HTML::image('images/edit.png', 'a Edit', array('class' => 'img-responsive cleaner', 'width' => '20', 'title' => 'Edit')) }}</a> </center><br></td>

				        	<td rowspan="4">{!! Form::open(['route' => ['eiaqs.destroy', $quizs->id], 'method' => 'DELETE', 'onsubmit' => 'return ConfirmDelete()']) !!}
				  ...
				  <a href="{{ route('eiaqs.create') }}">Check Stock</a>

				  <button class="btn btn-success" onclick="location.href='{{ route('eiaqs.create') }}'">
     Check Stock</button>
