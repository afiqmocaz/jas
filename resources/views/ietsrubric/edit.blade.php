...
<head>
	...
	<script>   
				    ...
				    function addRow() {
						...
						for(var i=0;i<cols;i++){
							cell = row.insertCell(i);
							cell.innerHTML = '<center><input type="text" onblur="findTotal()" id="percentage" name="percentage" style="width: 35px;">(%)</center>';
						}
						for(var i=0;i<cols;i++){
							cell = row.insertCell(i);
							cell.innerHTML = '<center><textarea name="criteria" rows="2" cols="23" id="add2"></textarea></center>';
						}
		...
		<div>
			...
			<div class="navbar templatemo-nav" id="navbar">
	      	...
	      	<div class="breadcrumb flat">
				    ...
				    <a href="#">MANAGE</a>
				    <a href="#">Assignment</a>
				    <a href="{{ url('/secretariat_assigment/apcs') }}">Applicant Assignment</a>
				...
				{!! Form::model($user, ['route' =>['ietsrubric.update', $user->id], 'method' => 'PUT', 'files' => true]) !!}
				...
				<table id="main" style="width:100%">
				  ...
				  <tr>
				  	...
				  	<tr>
				    <td width="30%" ><center>
				    <!-- <textarea rows="2" cols="23" id="add2" placeholder="Example: Understanding of Notification Process"></textarea> -->
				    {{ Form::textarea('criteria', null, ['id' => 'add2', 'placeholder' => 'Example: Understanding of Notification Process', 'rows' => '2', 'cols' => '23']) }}
				    </center></td>
				    <td width="10%"><form id="myForm"><center>
				    <input type="text" onblur="findTotal()" id="percentage" name="percentage" style="width: 35px;" placeholder="80">(%)
				    <!-- {{ Form::text('percentage', null, ['onblur' => 'findtotal()', 'id' => 'percentage', 'placeholder' => '80', 'style' => 'width: 35px;']) }}(%) -->
				    </center></form></td>
				  	...
				  	<tr>
				    <td width="30%"><center><textarea name="criteria" rows="2" cols="23" id="add2"></textarea></center></td>
					<td width="10%"><form id="myForm"><center>
					<input type="text" onblur="findTotal()" id="percentage" name="percentage" style="width: 35px;">(%)
					<!-- {{ Form::text('percentage', null, ['onblur' => 'findtotal()', 'id' => 'percentage', 'style' => 'width: 35px;']) }}(%) -->
					</center></form></td>
				...
				{{ Form::submit('Save', ['class' => 'btn btn-primary btn-block', 'style' => 'width:150px;']) }}<br><br>    
