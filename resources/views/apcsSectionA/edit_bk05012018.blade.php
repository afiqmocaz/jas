    ...
    <div class="panel panel-primary">
      <div class="panel-heading">
        <h4 class="panel-title">
          <a data-toggle="collapse" href="#collapse1">APCS Section A Instruction :</a>
        </h4>
      </div>
...
<!-- <td colspan="4">
    ...
    {{ Form::select('title', ['Mr' => 'Mr', 'Mrs' => 'Mrs', 'Miss' => 'Ms', 'Dr' => 'Dr', 'Prof' => 'Prof' ], $apcsSectionA->title, array('class' => 'form-control', 'style' => 'width: 20%', 'required' => ''))}}
      ...
      <tr>
        ...
        <td>
          <input type="value" pattern="\d+" id="postcode" name="postcode" class="form-control" style="width: 25%" placeholder="Eg: 42500" required title="Enter digit only. Min : 3, Max : 10" minlength="3" maxlength="10" oninput="this.value=this.value.replace(/[^0-9]/g,'');" value="{{$apcsSectionA->postcode}}"> 
...
<!--            <select name="state" class="form-control" style="width: 50%" required="" value = "" id="selectState">
      ...
      <tr>
       ...
       <tr>
        ...
        <td>
          <input type="value" pattern="\d+" id="mailpostcode" name="mailpostcode" class="form-control" style="width: 25%" placeholder="Eg: 42500" required title="Enter digit only. Min : 3, Max : 10" minlength="3" maxlength="10" oninput="this.value=this.value.replace(/[^0-9]/g,'');" value="{{$apcsSectionA->mailpostcode}}"> 
...
<div class="input-group date" id="datepickerDemo17">
        ...
        <input type="text" class="form-control inputan kusus" id="dateofissue" data-format="dd-MM-yyyy" name="dateofissue"  value="{{$apcsSectionA->dateofissue}}" style="width: 55%"/>
