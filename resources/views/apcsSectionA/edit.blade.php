      ...
      <div class="col-md-5">
            ...
            <div class="form-group">    
                <text><b>Address</b></text>
                   {{ Form::textarea('address', $apcsSectionA->address, array('id'=>'address', 'class'=>'form-control input-sm', 'rows' => 5, 'placeholder'=>'Enter your address', 'maxlength' => 255,'onchange' => 'validateaddress(this)','style'=>'font-size:15px'))}}             
              </div>

              <div class="form-group">    
                <text><b>City</b></text>
                  <input type="text" name="city" id="city" class="form-control input-sm" placeholder="Enter your city"  minlength="3" maxlength="35" oninput="this.value=this.value.replace(/[^A-Za-z ]/g,'');" onchange="cityValidation(this);" value="{{$apcsSectionA->city}}" style="font-size: 15px" >         
              </div>

               <div class="form-group">    
                <text><b>Postcode</b></text>
                  <input type="text" pattern="\d+" name="postcode" id="postcode" class="form-control input-sm" placeholder="Enter your postcode"   minlength="3" maxlength="10" oninput="this.value=this.value.replace(/[^0-9]/g,'');" onchange="postcodeValidation(this);" value="{{$apcsSectionA->postcode}}" style="font-size: 15px">         
              </div>

              <div class="form-group">    
                <text><b>Country</b></text>
                  <select class="form-control input-sm" name="country_id" id="country_id" onchange="myFunction()" style="font-size: 15px">
                      <option value="{{ $apcsSectionA->country_id}}">{{ $apcsSectionA->country_id}}</option>
               ...
               <div class="form-group" id="stateGroup">    
                <text><b>State</b></text>
                  <select class="form-control input-sm" name="state" id="state" style="font-size: 15px" onchange="myFunction2()">
                        ...
                        <option value="{{ $apcsSectionA->state}}">{{ $apcsSectionA->state}}</option>
                     @else
                      <option value="">--please select--</option>
                      @endif
            ...
            <div class="col-md-5 col-md-offset-1">
              ...
              <div class="form-group">    
                <text><b>Title</b></text>
                 {{ Form::select('title', ['Mr' => 'Mr', 'Mrs' => 'Mrs', 'Miss' => 'Ms', 'Dr' => 'Dr', 'Prof' => 'Prof' ], $apcsSectionA->title, array('class' => 'form-control input-sm','style'=>'font-size:15px'))}}               
              </div>
               ...
               <div class="form-group">    
                <text><b>Telephone Number</b></text>
                  <input name="phoneno" id="phoneno" type="text" maxlength="12" class="form-control input-sm" placeholder="Telephone Number" value="{{$apcsSectionA->phoneno}}" style="font-size: 15px">              
                  
              </div>

              <div class="form-group">    
                <text><b>Fax Number</b></text>
                  <input name="faxno" id="faxno" type="text" maxlength="12" class="form-control input-sm" placeholder="Fax Number" value="{{$apcsSectionA->faxno}}" style="font-size: 15px">              
          ...
          <text style="font-size: 12px;color: #0073e6">Check this box if Address and Mail Address are the same.</text>
                 ...
                 {{ Form::textarea('mailaddress', $apcsSectionA->mailaddress, array('class'=>'form-control input-sm', 'rows' => 5, 'placeholder'=>'Enter your address', 'maxlength' => 255, 'style'=>'font-size:15px'))}}   
              </div>

              <div class="form-group">    
                <text><b>Mail Postcode</b></text>
                   <input type="text" pattern="\d+" name="mailpostcode" id="mailpostcode" class="form-control input-sm" placeholder="Enter your postcode"   minlength="3" maxlength="10" oninput="this.value=this.value.replace(/[^0-9]/g,'');" onchange="postcodeValidation(this);" value="{{$apcsSectionA->mailpostcode}}"style="font-size: 15px" style="font-size: 15px">   
              </div>
              ...
              <br>
                  <text><b>Place of Issue</b></text>
                   ...
                   {{ Form::text('placeofissue', $apcsSectionA->placeofissue, array('id' => 'placeofissue', 'class' => 'form-control input-sm', 'placeholder'=>'Enter your place of issue', 'maxlength' => 45, 'style'=>'font-size:15px'))}}
              </div>
              ...
              <div class="form-group"  id="doi" style="display: none">
                ...
                <text><b>Date of Issue</b></text>
                   {{ Form::date('dateofissue', $apcsSectionA->dateofissue, array('id' => 'dateofissue', 'class' => 'form-control input sm', 'placeholder'=>'Enter your date of issue', 'maxlength' => 45, 'style'=>'font-size:15px'))}}
            ...
            <div class="col-md-11" style=" margin-top: 10px; margin-bottom: 10px;" align="right">
              <a class="btn btn-primary" href="/apcsSectionA/{{$apcsSectionA->id}}" role="button">Back</a>
