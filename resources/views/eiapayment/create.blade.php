		...
		<div>
			...
			<div class="navbar templatemo-nav" id="navbar">
	      	...
	      	<div class="breadcrumb flat">
				    ...
				    <a href="#">APPLICANT</a>
				    <a class="active" style="color:white">Applicant Payment</a>        
				  </div>
				</div>
    			...
    			<h1>Pre-Qualification Payment of Applicant <br></h1>         
				    ...
				    <div class="panel panel-primary" style="border-color:#4CAF50;">
				      <div class="panel-heading" style="background-color:#4CAF50;" >
				        <h4 class="panel-title" style="color:white;">
				          <a data-toggle="collapse" href="#collapse1">Pre-Qualification Payment of Applicant Instruction :</a>
				        </h4>
				      </div>
				      <div id="collapse1" class="panel-collapse collapse">
				        <div class="panel-body">
				        •  In this form, Secretariat EIA can view the list of applicant payment with proof.<br>
						•  Secretariat EIA can click the payment proof link to view applicant payment proof.<br>
						•  Secretariat EIA can click success if the payment is successful and the pending if the payment amount is not enough.<br>
						•  Secretariat EIA can click button "Save" to save the list of applicant payment after make changes.
						</div>
				      </div>
				    </div>
				  </div>
				...
				<input type="search" class="light-table-filter" data-table="order-table"  placeholder="Search..." style="width: 222px; margin-left: 668px"><br><br>
				...
				<table class="order-table table" id="myTable">
				    <thead valign="top">
				      ...
				      <tr>
				        ...
				        <th onclick="sortTable(3)"><center>Type of Payment</center></th>
				        <th onclick="sortTable(4)"><center>Mode of Payment</center></th>
				        <th onclick="sortTable(5)">Status</th>
				        <th onclick="sortTable(6)">Approval Panel</th>
				      </tr></thead>
				    <tbody>
				      @foreach($user as $users)
				    @foreach($eiapayment as $eiapayments)
				      <tr>
				        <td></td>
				        <td><a href="{{ route('eiapayinfo.edit', $eiapayments->id) }}" >
				        	{{ $users->name }}</a></td>
				        <td>{{$users->nric}}</td>
				        <td><center>{{$eiapayments->type}}</center></td>
				        <td><center>{{$eiapayments->paymentType}}</center></td>
				        <td>{{$eiapayments->status}}</td>
				        <td></td>
				      </tr>
				      @endforeach
				    @endforeach
