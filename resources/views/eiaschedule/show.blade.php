		...
		<div>
			...
			<div class="navbar templatemo-nav" id="navbar">
	      	...
	      	<div class="breadcrumb flat">
				...
				<div id="myModal1" class="modal2">
				  ...
				  <div class="modal2-content">
				    ...
				    <div class="modal2-body">
				      <nav>
					      	<iframe src="{{ url('eiaexamtitle') }}" width="200" height="450" scrolling="yes">
				  ...
				  <div class="modal-content">
				    ...
				    <div class="modal-body">
				      {!! Form::open(array('route' => 'eiaschedule.store', 'data-parsley-validate' => '')) !!}
						    ...
						    <span class="input-group-addon" style="width: 40%;" id="eiaexamtitle" name="eiaexamtitle_id">Exam Title</span>
						    <select style="width:97.7%" id="eiaexamtitle" name="eiaexamtitle_id" class="form-control" required="">
				        	<option value="0" disabled="true" selected="true">--Please Select--</option>
						    @foreach($eiaexamtitles as $cat)
				        	<option value="{!! $cat->id !!}">{!! $cat->eiaexamtitle !!}</option>
				        	@endforeach
				        	</select>
						    </div><br></nav>
						    ...
						    <select id="eiavenue" name="eiavenue_id" onchange='ChangeVal(this.value);' class="form-control" required="" style="width:97.7%">
				        	<option value="0" disabled="true" selected="true">--Please Select--</option>
				...
				<input type="search" class="light-table-filter" data-table="order-table"  placeholder="Search..." style="width: 17%; float:right; margin-right:187px;"><br><br>
				...
				<table class="order-table table" id="list" style="width:80%;" align="center">
				    <thead valign="top">
				      ...
				      <tr>
				        ...
				        <td>{{$eiaschedules->eiaexamtitle->eiaexamtitle}}</td>
				        ...
				        <td id="ex" align="right"><form action="{{ url('eiaexam/create') }}" method="get">
					    <input type="submit" value="Attendant"/></form></td>
				        <td><center><a href="{{ route('eiaschedule.edit', $eiaschedules->id) }}" >
				        	{{ HTML::image('images/edit.png', 'a Edit', array( 'width' => '20', 'title' => 'Edit')) }}</a> </center></td>

				        	<td>{!! Form::open(['route' => ['eiaschedule.destroy', $eiaschedules->id], 'method' => 'DELETE', 'onsubmit' => 'return ConfirmDelete()']) !!}
