		...
		<div>
			...
			<div class="navbar templatemo-nav" id="navbar">
					...
					<li class="active"><a href="{{ url('eiaindex/create') }}">HOME</a></li>
			          ...
			          <li class="dropdown"><a class="dropbtn">APPLICANT</a>
					    <div class="dropdown-content">
					      ...
					      <a href="{{ url('epaymentview/eia') }}">Applicant Payment</a>
					    </div>
					  </li>
	      	...
	      	<div class="breadcrumb flat">
    			...
    			<h2>Exam Schedule for Certified EIA Consultant<br></h2>
				    ...
				    <div class="panel panel-primary" style="border-color:#4CAF50;">
				      <div class="panel-heading" style="background-color:#4CAF50;" >
				        <h4 class="panel-title" style="color:white;">
				          <a data-toggle="collapse" href="#collapse1">Exam Schedule for Certified EIA Consultant Instruction :</a>
				        </h4>
				      </div>
				      <div id="collapse1" class="panel-collapse collapse">
				        <div class="panel-body">
				        •  Secretariat EIA can enter the title of exam at the text field provide.<br>
					    •  Secretariat EIA can choose the date, time and enter venue of exam at the text field provided.<br>
						•  Secretariat EIA can click "Confirm" button to confirm the date,time and venue that has been filled.<br>
						•  Secretariat EIA can view the date, time and date at the table below the "Confirm" button.
						</div>
				      </div>
				    </div>
				  </div>
    			...
    			{!! Form::open(array('route' => 'eiaschedule.store', 'data-parsley-validate' => '')) !!}
				        ...
				        <option data-foo="">--Please Choose--</option>
				        <option data-foo="EIA Exam">EIA Exam</option>
				        <option data-foo="Applicant EIA Exam">Applicant EIA Exam</option>
				        ...
				        <option data-foo="Selangor">Selangor</option>
					      	...
					      	<br><br>
					      	<label for="usr">Allocation of Seat : </label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="number" id="alloc" name="seat" required="">
				...
				<table class="order-table table" id="list">
				    <thead>
				      ...
				      <tr>
				        <td></td>
				        <td>{{$eiaschedules->typeofexam}}</td>
				        <td>{{$eiaschedules->examtitle}}</td>
				        ...
				        <td>{{$eiaschedules->venue}}<br>{{$eiaschedules->address}}<br>{{$eiaschedules->state}}</td>
				        <td><center>{{$eiaschedules->seat}}</center></td>
				        <td id="app"><center>1</center></td>
				        <td id="ex"><center><a href="{{ url('eiaexam/create') }}">Detail</a></center><br>
				        <center><a href="{{ route('eiaschedule.edit', $eiaschedules->id) }}" >
				        	{{ HTML::image('images/edit.png', 'a Edit', array('class' => 'img-responsive cleaner', 'width' => '15', 'height' => '15')) }}</a> </center><br>

				        	{!! Form::open(['route' => ['eiaschedule.destroy', $eiaschedules->id], 'method' => 'DELETE', 'onsubmit' => 'return ConfirmDelete()']) !!}
