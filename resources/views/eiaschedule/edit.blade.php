		...
		<div>
			...
			<div class="navbar templatemo-nav" id="navbar">
	      	...
	      	<div class="breadcrumb flat">
    			...
    			{!! Form::model($eiaschedule, ['route' =>['eiaschedule.update', $eiaschedule->id], 'method' => 'PUT']) !!}
						...
						<div class="input-group" style="width: 100%;">
						    ...
						    <nav>
							<div class="input-group" style="width: 100%;">
						    <span class="input-group-addon" style="width: 40%;" id="eiaexamtitle">Exam Title</span>
						    {{ Form::select('eiaexamtitle_id', $eiaexamtitles, null, ['style' => 'width:97.7%;', 'class' => 'form-control']) }}
						    </div><br></nav>
					        ...
					        <iframe src="{{ url('eiaexamtitle') }}" width="200" height="225" scrolling="yes">
					    ...
					    <center>
					     ...
					     <th>
					      <center>{!! Html::linkRoute('eiaschedule.show', 'Cancel', array($eiaschedule->id), array('class' => 'btn btn-danger btn-block', 'style' => 'width:150px')) !!}</center>
					      </th>
					      </tr>
					      </table></center><br>
					  {!! Form::close() !!}    
