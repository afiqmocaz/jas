        ...
        <div id="main_container">
            <div>
                ...
                <div class="breadcrumb flat">
                    ...
                    <a href="#">MANAGE</a>
                    <a href="#">Generating Question</a>
                    <a class="active">{{$type}}</a>        
                </div>
            </div>
            ...
            <div class="container" >
                ...
                <table class="table table-bordered" width="50%" align="center">
                    ...
                    <td>{{$eiaquestions->specialized->specialized}}</td>
                   ...
                   <td>
                    ...
                    <td>{{$eiaquestions->related->related}}</td>
                    <td>
                    <center>
                        <a href="{{ route('apcsquestion.edit', $eiaquestions->id) }}" >
                            {{ HTML::image('images/edit.png', 'a Edit', array( 'width' => '20', 'title' => 'Edit')) }}</a> 

                        {!! Form::open(['route' => ['apcsquestion.destroy', $eiaquestions->id], 'method' => 'DELETE', 'onsubmit' => 'return ConfirmDelete()']) !!}
            ...
            <div class="container">
                <button class="btn btn-default pull-right" onclick="location.href='/quizModul/view/{{$type}}'">Back</button>
            </div>
            <br>
            <footer>
            ...
            <!-- Modal -->
             {!! Form::open(array('url'=>'apcsquestion/uploadFiles', 'route'=> ['apcsquestion.store'], 'data-parsley-validate' => '', 'method'=>'POST', 'enctype' => 'multipart/form-data', 'files'=>true)) !!}
                                                ...
                                                <td>
                                                        ...
                                                        <div id="check">
                                                            ...
                                                            <div class="max_tickets1">
                                                                <iframe src="{{ url('related') }}" width="350" height="350" scrolling="yes">
                                        ...
                                        <table class="table table-bordered">
                                            <tr>
                                                <td>
                                                    <select id="specialized" name="specialized_id" class="form-control" required="" style="width:97.7%">
                                                        ...
                                                        @foreach($specializes as $catr)
                                                        <option value="{!! $catr->id !!}">{!! $catr->specialized !!}</option>
                                                        @endforeach
                                                    </select>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                        ...
                                                        <div id="check">
                                                            <input type="checkbox" class="maxtickets_enable_cb1" name="opwp_wootickets[tickets][0][enable]">Add New Specialized Area

                                                            <div class="max_tickets1">
                                                                <iframe src="{{ url('specialized') }}" width="350" height="350" scrolling="yes">
                                                                <p>Your browser does not support iframes.</p>
                                                                </iframe>
                                                            </div>
                                                        </div>
