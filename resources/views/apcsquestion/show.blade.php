	      	...
	      	<div class="breadcrumb flat">
				...
				<table class="order-table table" id="list" style="width:90%;" align="center">
				     ...
				     <tr style="background-color: #4CAF50; color: white;">
				        ...
				        <th style="width:35%;" >Sub-Answer</th>
				    ...
				    @endforeach    
				        ...
				        <td rowspan="4" id="but" align="right"><button type="button" title="Question Preview" data-toggle="modal" data-target="#yourModal{{$apcsquestions->id}}">Preview</button>
				        </td>
