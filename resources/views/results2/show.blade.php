...
<div class="container">
   ...
   <label style="padding-left:5%">Congratulations! You already finish quiz for Module 2</label><br><br>
   ...
   <center>
      ...
      <center>
   <div class="text">
        <label class="text-danger"><strong>* Please click next button to proceed to Module 3</strong></label>
      </div>
      <a href="/modules3" class="btn btn-primary">Next</a>
  </center>
