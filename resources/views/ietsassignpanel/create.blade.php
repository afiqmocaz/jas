			          ...
			          <li class="dropdown"><a class="dropbtn">MANAGE</a>
					    <div class="dropdown-content">
					      ...
					      <ul class="parent" ><a href="#">Comprehensive Examination <span class="caret"></span></a>
							...
							<ul class="child1" >
							 <a href="{{ url('ietsassignment/show') }}">Master File</a>
    			...
    			<div class="dropdown1">
					  ...
					  <div class="dropdown-content1">
					   1. The purpose of this page is to assign the assignment using assign code to the panel assignment.<br>  
						2. Secretariat IETS can select the panel name at the droplist given below at the field of Panel Name<br>
						3. Secretariat IETS can assign the code that have been generated at the master file to the panel.<br>
						
						4. Secretariat IETS can click the button "Save" to save the progress that have been made.<br>
					  </div>
