  ...
  <table class="table">
    ...
    {!! Form::open(['route' => 'eiaSectionD.store', 'data-parsley-validate'=> '']) !!}
      ...
      <tr>
        ...
        <td>
          {{ Form::textarea('project_name', '', array('style'=>'width: 90%', 'class'=>'form-control', 'rows' => 5, 'placeholder'=>'Eg: Integrated Research on the Development of Global Climate Risk Management Strategies', 'required' => ''))}}
        </td>
      </tr>
      <tr>
        <td>
      ...
      <tr>
        ...
        <td>
          {{ Form::textarea('responsibilities', '', array('style'=>'width: 90%', 'class'=>'form-control', 'rows' => 5, 'placeholder'=>'Eg: Prevent and remedy pollution incidents', 'required' => ''))}}
        </td>
      </tr>
      <tr>
        <td>
        ...
        <td>
          <div class="col-lg-6">
            <div class="input-group">
              ...
              {{ Form::date('dateStart', '', array('id' => 'datepicker', 'class' => 'form-control', 'style' => 'width: 80%','onchange' => 'cal();calculate()', 'required' => '' )) }}
            </div>
          </div>
          <div class="col-lg-6">
            <div class="input-group">
              <span class="input-group-addon">Date End</span>
              {{ Form::date('dateEnd', '', array('id' => 'datepicker2', 'class' => 'form-control', 'style' => 'width: 80%','onchange' => 'cal();calculate()', 'required' => '' )) }}
            </div>
          </div>
          <br><br><br>
          ...
          <td>
            ...
            <td>
                  ...
                  <input type="file" name="supportdoc" required="" accept=".pdf">
      ...
      <tr>
       ...
       <tr>
        ...
        <td>
          {{ Form::text('ref_name', '', array('style'=>'width: 90%', 'class' => 'form-control', 'placeholder'=>'Eg: Hussin Bin Muhammad', 'required' => ''))}}
        </td>
      </tr>
      <tr>
        <td>
        ...
        <td>
          {{ Form::textarea('ref_address', '', array('style'=>'width: 90%', 'class'=>'form-control', 'rows' => 5, 'placeholder'=>'Eg: No. 64, Jln Pahlawan 21, Taman Pahlawan', 'required' => ''))}}
        </td>
      </tr>
      <tr>
        <td>
        ...
        <td>
          {{ Form::email('ref_email', '', array('class' => 'form-control', 'style' => 'width: 30%', 'placeholder'=>'Eg: izzat@gmail.com', 'required' => ''))}}
          </td>
      </tr>
    </tbody>
  </table>
