...
@section('header', 'APCS: Guidelines')  
@section('content')
<html>
  <head>
  ...
  <div class="section" style="padding: 0px;">
    <div class="container">
    {!! Form::model($apcsguideline, ['route' =>['apcsguideline.update', $apcsguideline->id], 'method' => 'PUT', 'files' => true,'class'=>'formmodel']) !!}        <div  style="border: 1px solid #C8C8C8; margin-top: 10px; background-color: #FFFFFF; opacity: 0.9; filter: alpha(opacity=60);">
          <h3 class="text-center">GUIDELINES UPLOAD</h3>
          <hr/>
          
            <div class="form-group" style="margin-left: 3%">    
                <label class="">Subject</label>
                  <input name="subject" id="subject" type="text" maxlength="100" class="form-control input-sm" placeholder="Enter your subject" value="{{$apcsguideline->subject}}" style="width:97%" >  
                              
              </div>

              <div class="form-group" style="margin-left: 3%">
						    <label class="">File Uploaded</label><br />
						  <a style="color:blue" class="file" src="/guideline/{{$apcsguideline->original_filename}}" href="/guideline/{{$apcsguideline->original_filename}}" target="_blank">{{$apcsguideline->original_filename}}</a>
            ...
            <div class="col-md-12" style=" margin-top: 10px; margin-bottom: 10px;" align="right">
              <a href="/apcsguideline/show" class="btn btn-primary" role="button">Back To APCS Guidelines</a>
