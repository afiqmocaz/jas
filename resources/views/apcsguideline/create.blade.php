...
<html>
  ...
  <div class="section" style="padding: 0px;">
    <div class="container">
      <form id="applicantForm" action="{{ route('apcsguideline.store')}}" method="POST" enctype="multipart/form-data" style="width: 60%;">
        <div  style="border: 1px solid #C8C8C8; margin-top: 10px; background-color: #FFFFFF; opacity: 0.9; filter: alpha(opacity=60);">
          ...
          <hr/>
            ...
            <div class="col-md-12" style=" margin-top: 10px; margin-bottom: 10px;" align="right">
              <a href="show" class="btn btn-primary" role="button">Back To APCS Guidelines</a>
