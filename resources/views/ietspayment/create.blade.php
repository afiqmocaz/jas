		...
		<div>
			...
			<div class="navbar templatemo-nav" id="navbar">
	      	...
	      	<div class="breadcrumb flat">
				    ...
				    <a href="#">APPLICANT</a>
				    <a class="active">Applicant Payment</a>        
				  </div>
				</div>
				...
				<div style="width: 100%;" class="panel-group" >
				    <div class="panel panel-primary" style="border-color:#4CAF50;">
				      ...
				      <div id="collapse1" class="panel-collapse collapse">
				        ...
				        •  In this form, Secretariat IETS can view the list of applicant payment with proof.<br>
						•  Secretariat IETS can click the payment proof link to view applicant payment proof.<br>
						•  Secretariat IETS can click success if the payment is successful and the pending if the payment amount is not enough.<br>
						•  Secretariat IETS can click button "Save" to save the list of applicant payment after make changes.
				        </div>
				      </div>
				    </div>
				  </div>
				...
				<table class="order-table table" id="myTable">
				    ...
				    @foreach($ietspayment as $ietspayments)
				      <tr>
				        <td></td>
				        <td><a href="{{ route('ietspayinfo.edit', $users->id) }}" >
				        	{{ $users->name }}</a></td>
				        <td>{{$users->nric}}</td>
				        <td><center>{{$ietspayments->type}}</center></td>
				        <td><center>{{$ietspayments->paymentType}}</center></td>
				        <td>{{$ietspayments->status}}</td>
				        <td></td>
				      </tr>
				      @endforeach
				    @endforeach
