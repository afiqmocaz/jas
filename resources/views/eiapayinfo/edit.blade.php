		...
		<div>
			...
			<div class="navbar templatemo-nav" id="navbar">
					...
					<li class="active"><a href="{{ url('eiaindex/create') }}">HOME</a></li>
			          ...
			          <li class="dropdown"><a class="dropbtn">MANAGE</a>
					    <div class="dropdown-content">
					      ...
					      <a href="{{ url('quizModul/view/quiz/eia') }}">Quiz</a>
	      	...
	      	<div class="breadcrumb flat">
				    ...
				    <a href="#">APPLICANT</a>
				    <a href="{{ url('paymentview/eia') }}">Applicant Payment</a>
				    <a class="active" style="color:white">Payment Information</a>        
				  </div>
				</div>
				...
				{!! Form::model($array, ['route' =>['eiapayinfo.update', $user->id], 'method' => 'PUT', 'files' => true]) !!}
				...
				<table class="table">
				    ...
				    <tbody>
				      <tr>
				        ...
				        <td><center>{{ Form::date('date', null, ['readonly' => 'readonly', 'style' => 'border:0; width:90%;']) }}</center></td>
				        ...
				        <div>
					        ...
					        <a class="current-attachment" src="/uploads/{{$payinfo->slip}}" href="/uploads/{{$payinfo->slip}}" width="100px" height="150px">{{$payinfo->slip}}</a></center></td>
					        @endif
					    </div>
				        <td>
                                            <div class="row">
                                                <div class="col-sm-6" >
                                                     {{ Form::submit('Approve', ['name' => 'approve','id' => 'approve', 'class' => 'btn btn-info']) }}
                                                </div>
                                                <div class="col-sm-6">
                                                        {{ Form::submit('Decline', ['name' => 'decline','id' => 'decline','class' => 'btn btn-danger']) }}
                                                </div>
