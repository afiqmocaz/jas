            ...
            <div class="form-group">    
              ...
              <div class="form-group">    
                <text><b>Bumiputera Status</b></text><br>
                  ...
                  &nbsp &nbsp &nbsp
                  <input type='radio' name="bumiputerastatus" value="Foreigners"  />Foreigners         
      ...
      <div class="form-group" id="stateGroup">    
            ...
            <div class="form-group">    
               <text for="chkPassport">
                ...
                <text style="font-size: 12px;color:#0073e6">Check this box if you are an existing consultant
          </text> 
          ...
          <text style="font-size: 12px;color:#0073e6">Check this box if Address and Mail Address are the same.</text>
              ...
              <div class="form-group" id="poi" style="display: none">    
                 ...
                 <text for="example-text-input" style="color: #0073e6" class="col-2 col-form-label"><b>Additional Information for Non-Malaysian</b></text>
              <br>
