...
@section('content')
@section('header', ': EIA : SECTION A - PERSONAL INFORMATION')
<html>
  <head>
 ...
 <!-- <h4 class="text-center">SECTION A: PERSONAL INFORMATION</h4>
  ...
  <div class="section" style="padding: 0px">
    ...
    <div class="row" >
        ...
        {!! Form::model($eiaSectionA, ['route' =>['eiaSectionA.update', $eiaSectionA->id], 'method' => 'PUT', 'files'=>'true','id'=>'applicantForm']) !!}
          ...
          <div class="col-md-5">
            ...
            <div class="form-group">    
                <text><b>Title</b></text>
                  {{ Form::select('title', ['Mr' => 'Mr', 'Mrs' => 'Mrs', 'Miss' => 'Ms', 'Dr' => 'Dr', 'Prof' => 'Prof' ], $eiaSectionA->title, array('class' => 'form-control input-sm','style'=>'font-size:15px'))}}               
              </div>
           ...
           <text>Others</text>
            ...
            <div class="form-group">    
                <text><b>Address</b></text>
                    {{ Form::textarea('address', $eiaSectionA->address, array('id'=>'address', 'class'=>'form-control input-sm', 'rows' => 5, 'placeholder'=>'Enter your address', 'maxlength' => 255,'onchange' => 'validateaddress(this)','style'=>'font-size:15px'))}}            
              </div>

              <div class="form-group">    
                <text><b>City</b></text>
                  <input type="text" name="city" id="city" class="form-control input-sm" placeholder="Enter your city"  minlength="3" maxlength="35" oninput="this.value=this.value.replace(/[^A-Za-z ]/g,'');" onchange="cityValidation(this);" value="{{$eiaSectionA->city}}" style="font-size: 15px">           
              </div>

               <div class="form-group">    
                <text><b>Postcode</b></text>
                   <input type="text" pattern="\d+" name="postcode" id="postcode" class="form-control input-sm" placeholder="Enter your postcode"   minlength="3" maxlength="10" oninput="this.value=this.value.replace(/[^0-9]/g,'');" onchange="postcodeValidation(this);" value="{{$eiaSectionA->postcode}}" style="font-size: 15px">        
              </div>

              <div class="form-group">    
                <text><b>Country</b></text>
                 <select class="form-control input-sm" style="font-size: 15px" name="country_id" id="country_id" onchange="myFunction()">
          ...
          @endforeach
               ...
               <div class="form-group" id="stateGroup">    
                <text><b>State</b></text>
                  <select class="form-control input-sm" style="font-size: 15px" name="state" id="state" onchange="myFunction2()" >
         ...
         @else
          ...
          @endforeach
            ...
            <div class="form-group">    
               <text for="chkPassport">
                <input type="checkbox" id="chkPassport" />
                <text style="font-size: 12px">Check this box if you are an existing consultant
          </text> 

          <div class="form-group{{ $errors->has('regNo') ? ' has-error' : '' }}" id="dvPassport" style="display: none">
              <div class="cols-sm-10">
                <div class="input-group">
                  <text><b>Registered No</b></text>
                   {{ Form::text('regNo', '', array('id' => 'regNo', 'class' => 'form-control',  'placeholder'=>'Enter your registered no','style'=>'font-size:15px'))}}
            ...
            <div class="col-md-5 col-md-offset-1">
             ...
             <input name="featured_image" id="featured_image" type="file" title="Profile Picture">
                <p class="text-info" style="font-size: 12px;color: #0073e6">Attachment Specification : jpeg,jpg Only less than 10MB</p>
               ...
               <div class="form-group">    
                <text><b>Email Address</b></text>
                   <input id="email" name="email" type="text" maxlength="100" autocomplete="off" class="form-control input-sm" placeholder="Enter your email address" value="{{Auth::user()->email}}" style="font-size: 15px"> 
              </div>

               <div class="form-group">    
                <text><b>Telephone Number</b></text>
                  <input name="phoneno" id="phoneno" type="text" maxlength="12" class="form-control input-sm" placeholder="Telephone Number" value="{{$eiaSectionA->phoneno}}" style="font-size: 15px">              
                  
              </div>

              <div class="form-group">    
                <text><b>Fax Number</b></text>
                  <input name="faxno" id="faxno" type="text" maxlength="12" class="form-control input-sm" placeholder="Fax Number" value="{{$eiaSectionA->faxno}}" style="font-size: 15px">              
          ...
          <text style="font-size: 12px">Check this box if Address and Mail Address are the same.</text>

                {{ Form::textarea('mailaddress', $eiaSectionA->mailaddress, array('class'=>'form-control input-sm', 'rows' => 5, 'placeholder'=>'Enter your address', 'maxlength' => 255,'style'=>'font-size:15px'))}}     
              </div>

              <div class="form-group">    
                <text><b>Mail Postcode</b></text>
                   <input type="text" pattern="\d+" name="mailpostcode" id="mailpostcode" class="form-control input-sm" placeholder="Enter your postcode"   minlength="3" maxlength="10" oninput="this.value=this.value.replace(/[^0-9]/g,'');" onchange="postcodeValidation(this);" value="{{$eiaSectionA->mailpostcode}}" style="font-size: 15px">   
              </div>

                  
              <div class="form-group" id="poi" style="display: none">    
          
                 <text for="example-text-input" style="color: blue" class="col-2 col-form-label">Additional information for Non-Malaysian</text>
              <br>
                  <text><b>Place of Issue</b></text>
               
                   {{ Form::text('placeofissue', $eiaSectionA->placeofissue, array('id' => 'placeofissue', 'class' => 'form-control input-sm', 'placeholder'=>'Enter your place of issue', 'maxlength' => 45,'style'=>'font-size:15px'))}}
              </div>
              ...
              <div class="form-group"  id="doi" style="display: none">
                ...
                <text><b>Date of Issue</b></text>
                    {{ Form::date('dateofissue', $eiaSectionA->dateofissue, array('id' => 'dateofissue', 'class' => 'form-control input sm', 'placeholder'=>'Enter your date of issue', 'maxlength' => 45,'style'=>'font-size:15px'))}}
            ...
            <div class="col-md-11" style=" margin-top: 10px; margin-bottom: 10px;" align="right">
              <a class="btn btn-primary" href="/eiaSectionA/{{$eiaSectionA->id}}" role="button">Back</a>
