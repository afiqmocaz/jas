    ...
    <select class="purple" name="discountselection" id="discountselection" disabled required="">
        ...
        <option value="3 Years">3 Years</option>
            ...
            <em><label style="color: #aab2bd" class="col-2 col-form-label">image must be in (.png) and (.jpeg)</label></em>
              ...
              <input type="file" name="featured_image" accept="image/*" required="" onchange="ValidateSingleInput(this);">
              </br>
                </td>
        </tr>
        <tr>
    ...
    <option value="Prof">Prof</option>
      ...
      <tr>
        ...
        <td>
          ...
          <input type="text" pattern="\d+" name="postcode" class="form-control" style="width: 25%" placeholder="Eg: 42500"  title="Enter digit only. Min : 3, Max : 10" minlength="3" maxlength="10" oninput="this.value=this.value.replace(/[^0-9]/g,'');" required="">
        </td>
      </tr>
       <tr>
        <td>
...
<div class="input-group date" id="datepickerDemo17">
        ...
        <input type="text" class="form-control inputan kusus" id="dateofissue" data-format="dd-MM-yyyy" name="dateofissue"   style="width: 55%" required="" />
