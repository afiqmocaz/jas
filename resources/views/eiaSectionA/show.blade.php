 ...
 <!-- <h4 class="text-center">SECTION A: PERSONAL INFORMATION</h4>
  ...
  enctype="multipart/form-data">
	...
	<div class="form-group">    
               ...
               @foreach($eiaSectionA as $eiaSectionAs)
                      
                  <text><b>Title</b></text>
                  
                    <input name="city" id="city" type="text" maxlength="100" class="form-control input-sm" placeholder="Enter your name" value="{{ $eiaSectionAs->title }}" style="font-size: 15px" readonly="">  
         ...
         <input name="nric" id="nric" type="text" maxlength="100" class="form-control input-sm" placeholder="" value="{{ $eiaSectionAs->bumiputerastatus }}"  style="font-size: 15px" readonly="">  
        @endforeach  
        ...
        @foreach($eiaSectionA as $eiaSectionAs)
         ...
         <textarea  name="nric" id="nric" type="textarea"  rows="5" maxlength="100" class="form-control input-sm" placeholder="" value=""  style="font-size: 15px" readonly="">{{ $eiaSectionAs->address }}</textarea>  
        @endforeach  
          ...
          <input name="city" id="city" type="text" maxlength="100" class="form-control input-sm" placeholder="Enter your name" value="{{ $eiaSectionAs->city }}" style="font-size: 15px" readonly="">  
        @endforeach      
              </div>
          ...
          <input name="city" id="city" type="text" maxlength="100" class="form-control input-sm" placeholder="Enter your name" value="{{ $eiaSectionAs->postcode }}" style="font-size: 15px" readonly="">  
        @endforeach     
              </div>
          ...
          <input name="city" id="city" type="text" maxlength="100" class="form-control input-sm" placeholder="Enter your name" value="{{ $eiaSectionAs->country_id }}" style="font-size: 15px" readonly="">  
        @endforeach  
               ...
               @foreach($eiaSectionA as $eiaSectionAs)
                      @if ($eiaSectionAs->state != '')  
                <text><b>State</b></text>
                     
                    <input name="city" id="city" type="text" maxlength="100" class="form-control input-sm" placeholder="Enter your name" value="{{ $eiaSectionAs->state }}" style="font-size: 15px" readonly="">  
                     @endif
                      @endforeach 
              </div>
            ...
            <div class="form-group">    
               ...
               @foreach($eiaSectionA as $eiaSectionAs)
                      @if ($eiaSectionAs->regNo != '')
                  <text><b>Registered No</b></text>
                  
                    <input name="city" id="city" type="text" maxlength="100" class="form-control input-sm" placeholder="Enter your name" value="{{ $eiaSectionAs->regNo }}" style="font-size: 15px" readonly="">  
                     @endif
                      @endforeach 
		...
		<div class="form-group">
              ...
              @foreach($eiaSectionA as $eiaSectionAs)
      <img class="file" src="/image/{{$eiaSectionAs->image}}" href="/image/{{$eiaSectionAs->image}}" width="100px" height="150px"></img></td>
      @endforeach
   ...
   <div class="form-group">    
          ...
          <input name="city" id="city" type="text" maxlength="100" class="form-control input-sm" placeholder="Enter your name" value="{{ $eiaSectionAs->email }}" style="font-size: 15px" readonly="">  
        @endforeach  
          ...
          <input name="city" id="city" type="text" maxlength="100" class="form-control input-sm" placeholder="Enter your name" value="{{ $eiaSectionAs->phoneno }}" style="font-size: 15px" readonly="">  
        @endforeach  
                 ...
                 <div class="form-group">   
                  @foreach($eiaSectionA as $eiaSectionAs) 
                  @if ($eiaSectionAs->faxno != '')
                <text><b>Fax Number</b></text>
                 
        
          <input name="city" id="city" type="text" maxlength="100" class="form-control input-sm" placeholder="Enter your name" value="{{ $eiaSectionAs->faxno }}" style="font-size: 15px" readonly="">  
      @endif
        @endforeach  
          ...
          <textarea  name="nric" id="nric" type="textarea"  rows="5"  maxlength="100" class="form-control input-sm" placeholder="" value=""  style="font-size: 15px" readonly="">{{ $eiaSectionAs->mailaddress }}</textarea>  
        @endforeach  
          ...
          <input name="city" id="city" type="text" maxlength="100" class="form-control input-sm" placeholder="Enter your name" value="{{ $eiaSectionAs->mailpostcode }}" style="font-size: 15px" readonly="">  
        @endforeach     
              </div>
              ...
              <div class="form-group">   
              @foreach($eiaSectionA as $eiaSectionAs)
                    @if ($eiaSectionAs->placeofissue != '') 
                <text><b>Place of Issue</b></text>
                  
          <input name="city" id="city" type="text" maxlength="100" class="form-control input-sm" placeholder="Enter your name" value="{{ $eiaSectionAs->placeofissue }}" style="font-size: 15px" readonly="">  
            ...
            @endif
              ...
              <div class="form-group">   
              @foreach($eiaSectionA as $eiaSectionAs)
                    @if ($eiaSectionAs->dateofissue != '') 
                <text><b>Date of Issue</b></text>
                  
          <input name="city" id="city" type="text" maxlength="100" class="form-control input-sm" placeholder="Enter your name" value=" {{ date('d/m/Y', strtotime($eiaSectionAs->dateofissue))}}" style="font-size: 15px" readonly="">  
  ...
  <div class="row">
            <div class="col-md-11" style=" margin-top: 10px; margin-bottom: 10px;" align="right">
              ...
              <a href="{{ route('eiaSectionA.edit', $eiaSectionAs->id) }}" >
            {{ Form::button('Edit', array('class'=>'btn btn-primary ', 'type'=>'submit')) }}</a>

              <a href="/eiaSectionB/create" >
