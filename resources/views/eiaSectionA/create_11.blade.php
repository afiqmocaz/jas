...
<html>
  ...
  <div class="section" >
    ...
    <div class="container" >
          ...
          <form role="form" method="POST" action="{{ route('eiaSectionA.store')}}" name="applicantForm" id="applicantForm"  accept-charset="UTF-8"
  enctype="multipart/form-data">

        <div class="row" style=" margin-top: 10px; background-color: #FFFFFF; opacity: 0.9; filter: alpha(opacity=60);">
          
          
          <div class="col-md-5">
          <div class="form-group">
                <text>Passport Photo</text><br />
              <input name="featured_image" id="featured_image" type="file" title="Profile Picture">
                <p class="text-info" style="font-size: 12px;color: black">Attachment Specification : jpeg,jpg Only less than 10MB</p>
          ...
          <text style="font-size: 12px">Check this box if Address and Mail Address are the same.</text>
              ...
              <div class="form-group">    
                <text>Bumiputera Status</text><br>
          ...
          <div class="form-group{{ $errors->has('regNo') ? ' has-error' : '' }}" id="dvPassport" style="display: none">
              <div class="cols-sm-10">
                <div class="input-group">
                  <text>Registered No</text>
                   {{ Form::text('regNo', null, array('id' => 'regNo', 'class' => 'form-control input-sm', 'placeholder'=>'Enter your registration no', 'maxlength' => 45, 'style'=>'font-size:15px'))}}
