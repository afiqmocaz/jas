             ...
             <div class="form-group{{ $errors->has('city') ? ' has-error' : '' }}" style="margin-left: 5%">
              <div class="cols-sm-10">
                <div class="input-group">
                  ...
                  <input type="text" name="city" id="city" class="form-control" style="width: 20%" placeholder="Eg: Banting" title="Enter letters only. : 3, Max : 35" minlength="3" maxlength="35" oninput="this.value=this.value.replace(/[^A-Za-z ]/g,'');" onchange="cityValidation(this);">
                </div>
                 @if ($errors->has('city'))
                      <span class="help-block">
            ...
            <div class="form-group{{ $errors->has('postcode') ? ' has-error' : '' }}" style="margin-left: 5%">
              <div class="cols-sm-10">
                <div class="input-group">
                 ...
                 <input type="text" pattern="\d+" name="postcode" id="postcode" class="form-control" style="width: 20%" placeholder="Eg: 42500"  title="Enter digit only. Min : 3, Max : 10" minlength="3" maxlength="10" oninput="this.value=this.value.replace(/[^0-9]/g,'');" onchange="postcodeValidation(this);">
...
<div class="form-group{{ $errors->has('mailaddress') ? ' has-error' : '' }}" style="margin-left: 5%">
          ...
          <input type="value" pattern="\d+" name="mailpostcode" class="form-control" style="width: 20%" placeholder="Eg: 42500"  title="Enter digit only. Min : 3, Max : 10" minlength="3" maxlength="10" oninput="this.value=this.value.replace(/[^0-9]/g,'');">
          <text id="validationpcode" style="color:red"></text>
                </div>
           ...
           <text id="validationemail" style="color:red"></text>
             ...
             <div class="form-group{{ $errors->has('bumiputerastatus') ? ' has-error' : '' }}" style="margin-left: 5%">
              <div class="cols-sm-10">
                <div class="input-group">
                  <span class="input-group-addon">Bumiputerastatus</span>
               
                    <input type="radio" name="bumiputerastatus" value="Bumiputera" />
                    Bumiputera
                    <input type="radio" name="bumiputerastatus" value="Non-Bumiputera"/>
                    Non-Bumiputera
                    <input type="radio" name="bumiputerastatus" value="Others"/>
                    Others
              ...
              <div class="cols-sm-10">
                <div class="input-group">
                  <span class="input-group-addon">Phone No.</span>
                    ...
                    <input type="text" pattern="\d+" name="phoneno" class="form-control" style="width: 20%" placeholder="Eg: 0132458672"  minlength="10" maxlength="15"  title="Enter digit only. Min : 10, Max : 11" oninput="this.value=this.value.replace(/[^0-9]/g,'');">
