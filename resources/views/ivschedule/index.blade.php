				...
				<table class="order-table table" id="list">
				    <thead>
				      ...
				      <tr>
				        ...
				        <th onclick="sortTable(5)"><center>Action</center></th>
				      </tr></thead>
