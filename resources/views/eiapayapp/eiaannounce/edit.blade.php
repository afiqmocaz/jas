		...
		<div>
			...
			<div class="navbar templatemo-nav" id="navbar">
	      	...
	      	<div class="breadcrumb flat">
				    ...
				    <a href="{{ url('eiaannounce/show') }}">ANNOUNCEMENT</a>
				    <a class="active" style="color:white">Upload Announcement</a>        
				  </div>
				</div>
					  ...
					  {!! Form::model($eiaannounce, ['route' =>['eiaannounce.update', $eiaannounce->id], 'method' => 'PUT', 'files' => true]) !!}
					    ...
					    <div class="form-group">
						    ...
						    <div class="input-group" style="width: 100%;">
						      ...
						      <center><input id="original_filename" type="file" class="form-control" name="original_filename" accept=".pdf" onchange="myFunction()" multiple="multiple" style="width: 100%;"></center>
						    </div>
					     ...
					     <th>
					      <center>{!! Html::linkRoute('eiaannounce.show', 'Cancel', array($eiaannounce->id), array('class' => 'btn btn-danger btn-block', 'style' => 'width:150px')) !!}</center>
					      </th>
					      </tr>
					      </table></center>
