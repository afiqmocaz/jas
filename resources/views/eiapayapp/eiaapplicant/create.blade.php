		...
		<div>
			...
			<div class="navbar templatemo-nav" id="navbar">
	      	...
	      	<div class="breadcrumb flat">
				    ...
				    <a href="#">APPLICANT</a>
				    <a class="active" style="color:white">Applicant Registration</a>        
				  </div>
				</div>
				...
				<div style="width: 100%;" class="panel-group" >
				    <div class="panel panel-primary" style="border-color:#4CAF50;">
				      ...
				      <div id="collapse1" class="panel-collapse collapse">
				        ...
				        •  Secretariat EIA can click the applicant name to view the applicant registeration form from section A to Section F.<br>  
						...
						•  Secretariat EIA can view the comment that have been given at the applicant registeration form.
				        </div>
				      </div>
				    </div>
				  </div>
				...
				<table class="order-table table" id="myTable">
				    ...
				    <tbody>
				       ...
				       @foreach($eiaapplicant as $eiaapplicants)
				      <tr>
				      @if($users->id == $eiaapplicants->user_id)
				        <td></td>
				        <td><a href="{{ route('eiaappinfo.edit', $users->id) }}" >
				        	{{ $users->name }}</a></td>
				        <td>{{ $users->nric }}</td>
				        
				        <td>{{ $eiaapplicants -> comment }}</td>
				        <td>{{ $eiaapplicants -> status }}</td>
				     @endif
				      </tr>
				         @endforeach
				      @endforeach
