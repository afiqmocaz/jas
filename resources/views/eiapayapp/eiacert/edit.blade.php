			...
			<div class="navbar templatemo-nav" id="navbar">
	      	...
	      	<div class="breadcrumb flat">
				...
				<div style="width: 100%;" class="panel-group" >
				  ...
				  {!! Form::model($array, ['route' =>['eiacert.update', $eiacert->id], 'method' => 'PUT', 'files' => true]) !!}
				...
				<thead valign="top">
				    ...
				    <tbody>
				      <tr>
				        ...
				        <td><center></center></td>
				        <td><li>{{ Form::textarea('first_specialize', null, ['readonly' => 'readonly', 'style' => 'border:0;  width:87%;', 'rows' => '3']) }}</li><br>
				        <li>{{ Form::textarea('second_specialize', null, ['readonly' => 'readonly', 'style' => 'border:0;  width:87%;', 'rows' => '3']) }}</li></td>
				        <td>
				        ...
				        <td>
				        <?php
						$date = new DateTime("$eiacert->expired");
				  ...
				  <center><table width="40%">
					     ...
					     <td>
					      <center>{!! Html::linkRoute('eiacert.create', 'Cancel', array($eiacert->id), array('class' => 'btn btn-danger btn-block', 'style' => 'width:150px')) !!}</center>
					      </th>
					      </tr>
					      </table></center><br>
				  {!! form::close() !!}
