	      	...
	      	<div class="breadcrumb flat">
				...
				<thead>
				    ...
				    <tbody>
				    	...
				    	@foreach($eiacert as $eiacerts)
				      <tr>
				        <td></td>
				        <td>{{$users->name}}</td>
				        <td>{{$users->nric}}</td>
				        <td><center></center></td>
				        <td><li>{{$eiaappes->first_specialize}}</li><br>
				        <li>{{$eiaappes->second_specialize}}</li></td>
				        <td><center>{{$eiacerts->status}}</center></td>
				        <td><center>{{$eiacerts->remark}}</center></td>

				        <td><center>Aizat Hamdan Jailani</center></td>
				        <td><center><form action="{{ url('templatecerteia') }}" method="get">
				...
				<div id="myModal1" class="modal1">
				  ...
				  <div class="modal1-content">
				    <div class="modal1-header">
				      ...
				      <h2>eiaCertified Applicant List</h2>
				    </div>
				...
				<thead valign="top">
				    ...
				    @foreach($eiacert as $eiacerts)
				      <tr>
				        ...
				        <td>{{$eiacerts->endorse}}</td>
				        <td>
				        <?php
						$date = new DateTime("$eiacerts->expired");
				        ...
				        <td>{{$eiacerts->remark}}</td>
							<td>{{$eiacerts->status}}</td>
							<td><center><a href="{{ route('eiacert.edit', $eiacerts->id) }}" >
