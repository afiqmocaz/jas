		...
		<div>
			...
			<div class="navbar templatemo-nav" id="navbar">
			          ...
			          <li class="dropdown"><a class="dropbtn">MANAGE</a>
					    <div class="dropdown-content">
					      ...
					      <ul class="parent" ><a href="#">Comprehensive Examination <span class="caret"></span></a>
							...
							<a href="{{ url('quizModul/view/quiz/eia') }}">Generating Question</a></ul></ul>
	      	...
	      	<div class="breadcrumb flat">
				    ...
				    <a href="{{ url('eiaquestion/show') }}">Question Generation</a>
				    <a class="active" style="color:white">Question Bank</a>        
				  </div>
				</div>
