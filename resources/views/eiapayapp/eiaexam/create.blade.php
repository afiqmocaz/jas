		...
		<div>
			...
			<div class="navbar templatemo-nav" id="navbar">
	      	...
	      	<div class="breadcrumb flat">
				    ...
				    <a href="{{ url('schedule/eia') }}">Schedule</a>
				    <a class="active" style="color:white">Exam Attendant List</a>        
				  </div>
				</div>
    			...
    			<h1>Comprehensive Examination<br></h1>
				...
				<div style="width: 100%;" class="panel-group" >
				    <div class="panel panel-primary" style="border-color:#4CAF50;">
				      ...
				      <div id="collapse1" class="panel-collapse collapse">
						...
						•  Secretariat EIA can select the applicant attendant to take the attendant of applicant which is attend or absent.<br> 
						•  Secretariat EIA can select the Status to give the marks status of applicant which is pass,fail or acknowledge if the applicant is absent the examination.<br>
						•  Secretariat EIA can click button "Save" to save the applicant exam information that has been changes.<br>
				        </div>
				      </div>
				    </div>
				  </div>
    			...
    			<table class="table">
				    <thead valign="top">
				      ...
				      <tbody>
				      @foreach($eiaexam as $eiaexams)
				      <tr>
				        <td></td>
				        <td>{{$eiaexams->applicantname}}</td>
				        <td>{{$eiaexams->IC}}</td>
				      
				      <td>{{$eiaexams->seat}}</td>
				      <td>{{$eiaexams->mark}}</td>
				      <td>{{$eiaexams->status}}</td>
				      </tr>
				      @endforeach
				      </tbody>
				  </table>  

				  <br><input type="submit" class="btn btn-success" value="Save" name="save" href="compexam"><br><br>       
