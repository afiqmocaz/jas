				...
				<table class="order-table table" id="list" style="width:100%;">
				    <thead valign="top">
				      <tr>
				        ...
				        <th onclick="sortTable(6)" style="width:10%;"><center>Date Softcopy Received</center></th>
				        <th onclick="sortTable(7)" style="width:10%;"><center>Date Hardcopy Received</center></th>
				      </tr>
				      </thead>
