		...
		<div>
			...
			<div class="navbar templatemo-nav" id="navbar">
	      	...
	      	<div class="breadcrumb flat">
    			...
    			<br><iframe src="{{ url('eiaapp/show') }}" width="200" height="500" scrolling="yes">
  				<p>Your browser does not support iframes.</p>
				</iframe>

				<form>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
				    <input type=button name=print value="Print" class="btn btn-success" onClick="printExternal('{{ url('eiaapp/show') }}')">
				</form>

					<center><form action="{{ url('eiaapplicant/show') }}" method="get">

						<center><br><label><b>Comment : </b></label>

						<textarea rows="4" cols="80" name="comment1">Good.
						</textarea></center><br>

					    <button type="submit" class="btn btn-success" name="subject1" value="Approved"/>Approve</button>
					    <button type="submit" class="btn btn-success" name="subject1" value="Declined"/>Decline</button>
					</form></center><br><br>
