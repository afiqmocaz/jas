		...
		<div>
			...
			<div class="navbar templatemo-nav" id="navbar">
	      	...
	      	<div class="breadcrumb flat">
				...
				{!! Form::model($user, ['route' =>['eiaappinfo.update', $user->id], 'method' => 'PUT']) !!}
    			...
    			<br>
                        ...
                        <iframe src="/eiaapp/{{$user->id}}/edit" id="print" width="200" height="500" scrolling="yes">
    			
  				<p>Your browser does not support iframes.</p>
				</iframe>
					&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
				    <input type=button name=print value="Print" class="btn btn-success" onClick="printExternal('/eiaapp/{{$user->id}}/edit')">
						...
						{{ Form::textarea('comment', null, ['class' => 'form-control', 'style' => 'width:70%', 'rows' => '5', 'cols' => '60']) }}</center><br>
