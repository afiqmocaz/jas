				  ...
				  <div class="modal1-content">
				    <div class="modal1-header">
				     ...
				     <div class="modal1-body">
				      {!! Form::open(array('url'=>'eiaexamoption/uploadFiles', 'route'=> ['eiaexamoption.store'], 'data-parsley-validate' => '', 'method'=>'POST', 'enctype' => 'multipart/form-data', 'files'=>true)) !!}
				...
				<!-- end of modal -->
				  ...
				  <table class="order-table table" id="list" style="width:90%;" align="center">
                    ...
                    <td>{{ $question_option->correct == 1 ? 'Yes' : 'No' }}</td>
				        ...
				        <td><center><a href="{{ route('eiaexamoption.edit', $question_option->id) }}" >
				        	{{ HTML::image('images/edit.png', 'a Edit', array( 'width' => '20', 'title' => 'Edit')) }}</a> </center><br></td>

				        	<td>{!! Form::open(['route' => ['eiaexamoption.destroy', $question_option->id], 'method' => 'DELETE', 'onsubmit' => 'return ConfirmDelete()']) !!}
