			...
			<div class="navbar templatemo-nav" id="navbar">
	      	...
	      	<div class="breadcrumb flat">
				...
				<table class="order-table table" id="list" style="width:100%;">
				    <thead valign="top">
				      <tr>
				        <th onclick="sortTable(0)" style="width:10%;"><center>No.</center></th>
				        ...
				        <th onclick="sortTable(3)" style="width:10%;"><center>Applicant ID</center></th>
				      ...
				      <tr>
				        ...
				        <td>941203069897</td>
				        <td>EIA001</td>
				        <td><form action="{{ url('eiaivschedule/apcs') }}" method="get">
