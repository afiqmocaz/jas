				...
				<table class="order-table table" id="list" style="width:100%;">
				    <thead valign="top">
				      <tr>
				        ...
				        <th onclick="sortTable(2)" style="width:13%;"><center>NRIC/Passport</center></th>
				        <th onclick="sortTable(3)" style="width:12%;"><center>Applicant ID</center></th>
				        <th onclick="sortTable(4)" style="width:10%;"><center>Set Interview Session</center></th>
				      ...
				      <tr>
				        ...
				        <td>{{$users->nric}}</td>
				        <td></td>
				        <td><center><a href="{{ route('eiaivschedule.edit', $eiaivschedules->id) }}" style="background-color: #4CAF50; border: none; color: white; padding: 8px; text-align: center; text-decoration: none; display: font-size: 16px; margin: 4px 2px; cursor: pointer;">Assign</a>
						</center></td>
				        <td>{{date('d/m/Y', strtotime($eiaproivs->date))}}</td>
				        <td></td>
				        <td><select>
			...
			<div class="credit row">
				<center><div class="col-md-6 col-md-offset-3">
					<div id="templatemo_footer">
						Copyright © 2017 Jabatan Alam Sekitar
					</div>
				</div>
