				  ...
				  <div style="width: 100%;" class="panel-group" >
				    <div class="panel panel-primary" style="border-color:#4CAF50;">
				      ...
				      <div id="collapse1" class="panel-collapse collapse">
				        ...
				        •  Secretariat APCS can click the applicant name to view the applicant registeration form from section A to Section F.<br>
				        ...
				        •  Secretariat APCS can view the comment that have been given at the applicant registeration form.
				        </div>
				      </div>
				    </div>
				  </div>
				...
				<table class="order-table table" id="myTable">
				    ...
				    <tbody>
				       @foreach($applicant as $applicants)
                                         <tr>
                                         <td></td>
				        <td><a href="{{ route('appinfo.edit', $applicants->id) }}" >
				        	{{$applicants->user->name}}</a></td>
				        <td>{{$applicants->user->nric}}</td>
                                        
				        <td>{{ $applicants -> comment }}</td>
