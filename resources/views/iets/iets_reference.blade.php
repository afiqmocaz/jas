...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-8 col-md-offset-2">
			...
			<h2 style="margin-left:30px">Reference</h2>
 ...
 @foreach($ietsrefference as $ietsrefference)
	 <object  style="margin-left:30px"width="90%" height="500"data="/uploads/{{$ietsrefference->original_filename}}"></object><br><br>
	@endforeach
	<!-- <center> 
