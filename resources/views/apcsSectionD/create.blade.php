...
margin: -5px; } 
  ...
  <div class="section" style="padding: 0px;">
    ...
    {!! Form::open(['route' => 'apcsSectionD.store', 'data-parsley-validate'=> '', 'files'=> true,'id'=>'applicantFormD']) !!}
          ...
          <text class=""><b>Title of Proposal</b></text>
            ...
            <div class="col-md-11" style=" margin-top: 10px; margin-bottom: 10px;" align="right">
              <a class="btn btn-primary" href="/apsSectionC/create" role="button">Back</a>
...
$("#datepicker2").change(function () {
    ...
    if ((Date.parse(endDate) <= Date.parse(startDate))) {
       ...
       $('[name="datepicker2"]').val('');
          $('#applicantFormD').bootstrapValidator('revalidateField', 'datepicker2', false);
    }
});
