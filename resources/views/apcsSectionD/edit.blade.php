...
margin: -5px; } 
  ...
  <div class="section" style="padding: 0px;">
    <div class="row">
      ...
      {!! Form::model($apcsSectionD, ['route' =>['apcsSectionD.update', $apcsSectionD->id], 'method' => 'PUT', 'files' => true,'id'=>'applicantFormC']) !!}
          ...
          <div class="col-lg-6">
            ...
            <div class="input-group" >
             ...
             <input type="textbox" class="textbox" id="numdays2" name="numdays" readonly="readonly" style="width:17%;background-color:#d1e0e0" value="{{$apcsSectionD->numdays}}">
            </div>
          </div>
          <div class="col-lg-6">
            <div class="input-group">
          ...
          <input type="textbox" class="textbox" id="numMonths2" name="numMonths" readonly="readonly" style="width: 17%;background-color:#d1e0e0 " value="{{$apcsSectionD->numMonths}}">           
           </div>
          </div>   
          ...
          <text class=""><b>Title of Proposal</b></text>
            ...
            <div class="form-group">    
              ...
              <div class="form-group">    
                <text class=""><b>Supporting Document Uploaded</b></text><br>
                   <a class="file" href="/uploads/{{$apcsSectionD->supportdoc}}" style="" target="_blank">{{$apcsSectionD->supportdoc}}</a>
            ...
            <div class="col-md-11" style=" margin-top: 10px; margin-bottom: 10px;" align="right">
              <a class="btn btn-primary" href="/apcsSectionD/{{$apcsSectionD->id}}" role="button">Back</a> 
