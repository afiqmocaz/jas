		...
		<div>
			...
			<div class="navbar templatemo-nav" id="navbar">
	      	...
	      	<div class="breadcrumb flat">
				    ...
				    <a href="#">REPORT</a>
				    <a href="{{ url('ietscpd/create') }}">Continuous Professional Development (CPD)</a>
    			...
    			<h1>Competent Person (CP)<br></h1>  
    			<h2>Competent Person (CP) Profile<br></h2> 
				    ...
				    <div class="panel panel-primary" style="border-color:#4CAF50;">
				      <div class="panel-heading" style="background-color:#4CAF50;" >
				        <h4 class="panel-title" style="color:white;">
				          <a data-toggle="collapse" href="#collapse1">Competent Person (CP) Profile Instruction :</a>
				        </h4>
				      </div>
				      <div id="collapse1" class="panel-collapse collapse">
				        <div class="panel-body">
				        •  In this Form, Secretariat IETS can view the CP profile of the applicant.<br>
						•  Secretariat can select the CP status and Renewal Certificate Status according to the status of applicant.<br>
						•  Secretariat IETS can click the "Email".button to send email to the applicant of notification to renew the certificate.<br>
