...
<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal">Add New PCER</button>
  ...
  <!-- Modal content -->
	  <div class="modal-content">
	    <div class="modal-header">
          ...
          <h4 class="modal-title">Add New PCER</h4>
	    </div>
	    ...
	    <thead valign="top" class="alert-info">
	      ...
	      <tr>
	        ...
	        <td><center><a href="{{ route('assignment.edit', $assignments->id) }}" >
	        	...
	        	<td align="center">{!! Form::open(['route' => ['assignment.destroy', $assignments->id], 'method' => 'DELETE', 'onsubmit' => 'return ConfirmDelete()']) !!}
