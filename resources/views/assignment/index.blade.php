		...
		<div>
			...
			<div class="navbar templatemo-nav" id="navbar">
	      	...
	      	<div class="breadcrumb flat">
				    ...
				    <a class="active" style="color:white">PCER Format</a>        
				  </div>
				</div>
				  ...
				  <div style="width: 100%;" class="panel-group" >
				    <div class="panel panel-primary" style="border-color:#4CAF50;">
				      ...
				      <div id="collapse1" class="panel-collapse collapse">
				        ...
				        •  Secretariat APCS can fill the title of the assignment at the text field of Topic.<br>
				        •  Secretariat APCS can fill the specialized area of the assignment at the text field of Specialized Area.<br>
				        •  Secretariat APCS can upload the assignment with clicking the button "Choose File" at the text field of Upload PCER<br>
				        •  The Assign Date and Dateline can be set by date.<br>
				        •  Secretariat APCS can click the button "Save" to save the progress that have been made.<br>
				        •  Secretariat APCS can view the uploaded assignment at the table below.
				        </div>
				      </div>
				    </div>
				  </div>
				...
				<br>     
				 ...
				 {!! Form::open(array('route' => 'assignment.store', 'data-parsley-validate' => '', 'files' => true)) !!}
							...
							<label for="usr">Topic &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp : </label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
					      	<input type="text" id="tpc" name="topic" required="">
					      	...
					      	<input type="text" id="sa" name="specialized" required=""><br>
					      	...
					      	<br><center><input type="file"  name="fileToUpload" id="fileToUpload" required="" accept=".pdf , .doc , .docx , .txt" onchange="myFunction()" multiple></center>
							    ...
							    if ('files' in x) {
							        if (x.files.length == 0) {
							            ...
							            for (var i = 0; i < x.files.length; i++) {
							                ...
							                var file = x.files[i];
							                if ('name' in file) {
							                    txt += "Name: " + file.name + "&nbsp&nbsp&nbsp" + "<input type='button' value='Preview' onclick='PreviewImage();' />" + "<br>" + "<br><div style='clear:both'><iframe id='viewer' frameborder='0' scrolling='no' width='400' height='400'></iframe></div>";
							                }
							                if ('size' in file) {
					     ...
					     <label for="usr">Duration of Assignment &nbsp : </label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
					      	<input type="text" id="duration" name="duration" required="" style="width: 50px;"><label for="usr">&nbsp Days</label><br>

					      <br><label for="usr">Code Assign &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp : </label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
					      	<input type="text" id="cd" name="code" required=""><br><br>

					      {{Form::submit('Save', array('class' => 'btn btn-success'))}}<hr>
					    </div>
					  {!! Form::close() !!} 
				...
				<table class="order-table table" id="list">
				    <thead>
				      ...
				      <tr>
				        ...
				        <td>{{$assignments->specialized}}</td>
				        <td><a class="file" href="/images/{{$assignments->fileToUpload}}">{{$assignments->fileToUpload}}</a></td>
				         <td><center>{{$assignments->duration}}</center></td>
				        <td>{{$assignments->code}}</td>
				        <td id="rub"><center><form action="{{ url('rubric/create') }}" method="get">
					    <input type="submit" class="button" value="Rubric" />
					</form></center></td>
				        <td rowspan="4" id="but"><form onclick="deleteRow(this)" align="center">
