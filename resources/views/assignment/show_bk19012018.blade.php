			...
			<div class="navbar templatemo-nav" id="navbar">
	      	...
	      	<div class="breadcrumb flat">
				...
				<br>      
				 ...
				 <button id="myBtn" style="margin-left:0px;" class="btn btn-success" >Add New PCER</button>
    			...
    			<div id="myModal" class="modal">
				  ...
				  <div class="modal-content">
				    ...
				    <div class="modal-body">
				      {!! Form::open(array('url'=>'assignment/uploadFiles', 'data-parsley-validate' => '', 'method'=>'POST', 'files'=>true)) !!}

							<div class="form-group">

							<br><div class="input-group" style="width: 100%;">
						    <span class="input-group-addon" style="width: 20%;">Upload PCER</span>
						    <input type="file" id="fileToUpload" name="fileToUpload[]" class="form-control" required="" accept=".pdf" onchange="myFunction(this)" multiple style="width:100%">
						    </div>
				...
				<table class="order-table table" id="list" style="width:100%;">
				    <thead valign="top">
				      <tr>
				        ...
				        <th colspan="2" onclick="sortTable(3)" style="width:8%;"><center>Action</center></th>
				      </tr></thead>
				      ...
				      <tr>
				        ...
				        <td><center><a class="file" href="/uploads/{{$assignments->original_filename}}">{{$assignments->name}}</a></center></td>
				         <td><center>{{$assignments->duration}}</center></td>
				        
				        <td><center><a href="{{ route('assignment.edit', $assignments->id) }}" >
				        	{{ HTML::image('images/edit.png', 'a Edit', array( 'width' => '20', 'title' => 'Edit')) }}</a> </center></td>

				        	<td>{!! Form::open(['route' => ['assignment.destroy', $assignments->id], 'method' => 'DELETE', 'onsubmit' => 'return ConfirmDelete()']) !!}
