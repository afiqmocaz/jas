...
<div class="row">
	...
	<div class="col-md-3">
		<div class="well">
			...
			{{ Form::text('venue', null, ['class' => 'form-control']) }}<br>
	...
	<div class="col-md-8">
		...
		<table class="table" style="width:100%">
			...
			<tbody>
				@foreach($venues as $category)
				<tr>
					<td></td>
					<td><center>{{ $category->venue }}</center></td>
					<td><center>{!! Form::open(['route' => ['venue.destroy', $category->id], 'method' => 'DELETE', 'onsubmit' => 'return ConfirmDelete()']) !!}
