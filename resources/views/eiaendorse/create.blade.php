		...
		<div>
			...
			<div class="navbar templatemo-nav" id="navbar">
	      	...
	      	<div class="breadcrumb flat">
				    ...
				    <a href="#">REPORT</a>
				    <a href="{{ url('cert/eia') }}">Certificate Approval</a>
				    <a class="active" style="color:white">Certificate Information</a>        
				  </div>
				</div>
    			...
    			<h2>Certificate Information<br></h2> 
				    ...
				    <div class="panel panel-primary" style="border-color:#4CAF50;">
				      <div class="panel-heading" style="background-color:#4CAF50;" >
				        <h4 class="panel-title" style="color:white;">
				          <a data-toggle="collapse" href="#collapse1">Certificate Information Instruction :</a>
				        </h4>
				      </div>
				      <div id="collapse1" class="panel-collapse collapse">
				        <div class="panel-body">
				        •  In this Form, Secretariat EIA can view the status and marks of the applicant.<br>
    			...
    			<table class="table">
				    <thead valign="top">
				      <tr>
				        <th>Date Pass Exam</th>
				        <th>Exam Mark</th>
				        <th>Date of Mark</th>
				        <th>PCER Submit Date</th>
				        <th>PCER Mark</th>
				        <th>Date of Interview</th>
				        <th>Status of Interview</th>
				      </tr>
				    </thead>
				    <tbody>
				      <tr>
