		...
		<div>
			...
			<div class="navbar templatemo-nav" id="navbar">
	      	...
	      	<div class="breadcrumb flat">
				  ...
				  <div style="width: 100%;" class="panel-group" >
				    <div class="panel panel-primary" style="border-color:#4CAF50;">
				      ...
				      <div id="collapse1" class="panel-collapse collapse">
				        ...
				        •  In this form, Secretariat EIA can upload .pdf file of Self-Learning module 1 to module 5.<br>
						•  Secretariat EIA can click the button "Upload" to upload the file into the applicant login application to download by applicant.<br>
    			...
    			{!! Form::open(array('route' => 'selflearning.store', 'data-parsley-validate' => '')) !!}
					    <div class="form-group">
					    	<label for="usr"><br>Module &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp : </label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
					    	<select id="mySelect" name="module">
					    		<option data-foo="">--Please Select--</option>
							...
							<div class="form-group">
					    	<label for="usr"><br>Sub-Module &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp : </label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
					    	<select id="mySelect1" name="submodule">
					    		<option data-foo="">--Please Select--</option>
							...
							<div class="form-group">
							<label for="usr"><br>Title : </label>
					      	<input type="text" class="form-control" id="title" name="title" required="">
					    <label for="usr"><br>Material Upload(.pdf) : </label>
					      ...
					      <label><br><b>File Type: .pdf, .doc, .docx, .txt	|	Max File Upload: 10	|	Max Size Upload: 10MB</b><br></label><br>
				...
				<table class="order-table table" id="list">
				    <thead>
				      ...
				      <tr>
				        ...
				        <th onclick="sortTable(2)">Sub-Module</th>
				        <th onclick="sortTable(3)">Title Name</th>
				        <th onclick="sortTable(4)" >Upload Material</th>
				        <th onclick="sortTable(5)">Date Upload</th>
				        <th onclick="sortTable(6)"><center>Action</center></th>
				      </tr></thead>
				    ...
				    @foreach($selflearning as $selflearnings)
				      <tr>
				        <td></td>
				        <td>{{$selflearnings->module}}</td>
				        <td>{{$selflearnings->submodule}}</td>
				        <td>{{$selflearnings->title}}</td>
				        <td><a>{{$selflearnings->fileToUpload}}</a></td>
				        <td>{{ date('d F Y', strtotime($selflearnings->created_at)) }}</td>
				        <td id="but"><button>Publish</button><br><br><center><a href="{{ route('selflearning.edit', $selflearnings->id) }}" >
				        	{{ HTML::image('images/edit.png', 'a Edit', array('class' => 'img-responsive cleaner', 'width' => '15', 'height' => '15')) }}</a> </center><br>

				        	{!! Form::open(['route' => ['selflearning.destroy', $selflearnings->id], 'method' => 'DELETE', 'onsubmit' => 'return ConfirmDelete()']) !!}
