			...
			<div class="navbar templatemo-nav" id="navbar">
	      	...
	      	<div class="breadcrumb flat">
    			...
    			{!! Form::open(array('route' => 'selflearning.store', 'data-parsley-validate' => '')) !!}
					    ...
					    <br><br><label><br>Upload File : </label>
					      <br><center><input type="file"  name="fileToUpload" id="fileToUpload" accept=".png, .jpg, .pdf , .doc , .docx , .txt" onchange="myFunction()" multiple></center>
					      <br><p id="demo"></p>
					      <script>
				...
				<table class="order-table table" id="list">
				    ...
				    <tbody>
				      <tr>
				        <td></td>
				        <td>Material 1</td>
				        <td>Sub-Material 3</td>
				        <td>Effluent Discharged Standards</td>
				        <td><a>Effluent Discharged Standards.pdf</a></td>
				        <td>28/02/2017</td>
				        <td id="but"><button>Publish</button><br><br><form onclick="deleteRow(this)" align="center">
