		...
		<div>
			...
			<div class="navbar templatemo-nav" id="navbar">
	      	...
	      	<div class="breadcrumb flat">
    			...
    			<button id="myBtn" style="margin-left:15px;" class="btn btn-success btn-sm" >Add New Self-Learning</button>
...
<!--						    <div class="input-group" style="width: 100%;">
				...
				<table class="order-table table" id="list" style="width:70%;" align="center">
				    <thead valign="top">
