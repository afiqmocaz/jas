...
<html>
  ...
  <div class="section" style="padding: 0px;">
    <div class="container">
      <form id="applicantForm" action="{{ route('contactus.store')}}" method="POST" enctype="multipart/form-data" style="width: 60%;">
          ...
          <hr/>
            ...
            <div class="form-group" style="margin-left: 3%">    
                <label class="">Department name</label>
                  <input name="department" id="department" type="text" maxlength="100" class="form-control input-sm" placeholder="Enter your department name" value="" style="width:97%">  
                              
              </div>

              <div class="form-group" style="margin-left: 3%">    
                <label class="">Address</label>
                  <input name="address" id="address" type="text" maxlength="255" class="form-control input-sm" placeholder="Enter your address" value="" style="width:97%">  
                              
              </div>

              <div class="form-group" style="margin-left: 3%">    
                <label class="">Telephone No</label>
                  <input name="telno" id="telno" type="text" maxlength="100" class="form-control input-sm" placeholder="Enter your telephone no" value="" style="width:97%">  
                              
              </div>
             
              <div class="form-group" style="margin-left: 3%">    
                <label class="">Fax No</label>
                  <input name="faxno" id="faxno" type="text" maxlength="100" class="form-control input-sm" placeholder="Enter your telephone no" value="" style="width:97%">  
            ...
            <div class="col-md-12" style=" margin-top: 10px; margin-bottom: 10px;" align="right">
              <a href="show" class="btn btn-primary" role="button">Back To Lists of Contact</a>
