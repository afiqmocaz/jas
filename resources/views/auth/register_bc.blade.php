...
<strong>Instructions :</strong><br>
 ...
 &nbsp  •  &nbsp The password must be at least eight characters, one letter and one number<br>
  &nbsp <text style="color:red"> ** &nbsp Please note that all field are mandatory.</text><br>
</div>
 ...
 <div class="well well-lg"  style="margin-left: 10%; margin-right: 10%; border-color: #006600; background-color: #ccffcc">
      ...
      <div class="row main">
          <form class="form-horizontal" role="form" method="POST" action="{{ url('/register') }}" name="myForm" onsubmit="return(validate());">
            {{ csrf_field() }}
