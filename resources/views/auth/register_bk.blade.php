            ...
            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
              <div class="cols-sm-10">
                <div class="input-group">
                  ...
                  <input style="text-transform: uppercase;" type="text" class="form-control" name="name" id="name"  placeholder="Enter your Name" value="{{ old('name') }}" maxlength="255" minlength="10" required autofocus oninput="this.value=this.value.replace(/[^A-Za-z ]/g,'');" onchange="validatename(this);"/>
                  
                </div>
                <strong id="validationname" style="color:red"></strong>
              </div>
            </div>
            ...
            <div class="form-group{{ $errors->has('nric') ? ' has-error' : '' }}">
              <div class="cols-sm-10">
                <div class="input-group">
                  ...
                  <input  type="text" class="form-control" name="nric" id="nric"  placeholder="Enter your I/C or passport number" maxlength="12" style="width: 50%" value="{{ old('nric') }}" required autofocus oninput="this.value=this.value.replace(/[^a-zA-Z_0-9-]/g,'');" onchange="validatenric(this);"/>
                  @if ($errors->has('nric'))
                 ...
                 <strong id="validationnric" style="color:red"></strong>
              </div>
            </div>
            ...
            <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
              <div class="cols-sm-10">
                <div class="input-group">
                  ...
                  <input  type="text" class="form-control" name="email" id="email"  placeholder="Enter your Email" maxlength="100" style="width: 60%" value="{{ old('email') }}" required  onchange="ValidateEmail(this);"/>
                
                </div>
              </div>
                  <strong id="validationemail" style="color:red"></strong>
            </div>
            ...
            <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
              <div class="cols-sm-10">
                <div class="input-group">
                  ...
                  <input id="password" type="password" class="form-control" name="password" id="password"  placeholder="Enter your Password" style="width: 80%" required/>
                 
                  &nbsp
                  <span class="input-group-addon"><i class="fa fa-lock fa-lg" aria-hidden="true"></i></span>
                  <input  id="password_confirmation" type="password" class="form-control" name="password_confirmation" id="password-confirm"  placeholder="Confirm your Password" style="width: 80%" required/>
              ...
              <div class="cols-sm-10">
                <div class="input-group">
                      ...
                      <strong id="passwordValidation" style="color:red"></strong>
                 
                  &nbsp
                 
                     <strong id="passwordValidationC" style="color:red"></strong>
