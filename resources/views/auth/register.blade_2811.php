...
@endif 
<br>      <form id="applicantForm" action="{{ url('/register') }}" method="POST" enctype="multipart/form-data" style="width: 70%;margin:auto;">
            ...
            <div class="panel panel-default">
              ...
              <div class="form-group" style="margin-left: 3%">    
                <label class="">NRIC/Passport No.</label>
                  <input name="nric"  id="nric" type="text" maxlength="12" class="form-control input-sm" placeholder="Enter your NRIC/Passport No" value="" style="width:50%;font-size: 15px">                
              </div>
              ...
              <div class="form-group" style="margin-left: 3%">    
                <label class="">Email Address</label>
                  <input id="email" name="email" type="text" maxlength="100" autocomplete="off" class="form-control input-sm" placeholder="Enter your email address" value="" style="width: 50%;font-size: 15px">             
    ...
    fields : {
      ...
      nric:{
        validators :{
          ...
          stringLength: {
                        message: 'Applicant Address must be less than 12 characters',
                        max: function (value, validator, $field) {
