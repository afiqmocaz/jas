			...
			<div class="navbar templatemo-nav" id="navbar">
	      	...
	      	<div class="breadcrumb flat">
    			...
    			{!! Form::open(array('route' => 'ietsschedule.store', 'data-parsley-validate' => '')) !!}
						...
						<select id="exam" name="typeofexam" required="">
				        ...
				        <option data-foo="Repeat Comprehensive Exam">Repeat Comprehensive Exam</option>
							...
							<label for="usr">Exam Title &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp : </label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
					      	<select  id="mySelect" name="examtitle" required="">
				        <option data-foo="">--Please Choose--</option>
				        <option data-foo="IETS Exam">IETS Exam</option>
				        <option data-foo="Applicant IETS Exam">Applicant IETS Exam</option>
				        ...
				        <label for="usr">Add Exam Title &nbsp&nbsp&nbsp&nbsp : </label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
					      	...
					      	<input type="time" id="stime" name="start" required="">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
					      	...
					      	<input type="time" id="etime" name="end" required="">
					      	...
					      	<select id="mySelect1" name="venue" required="">
				        <option data-foo="">--Please Choose--</option>
				        ...
				        <option data-foo="JAS">JAS</option>
					      	...
					      	<textarea id="address" name="address" required="" rows="2" cols="50"></textarea>
				        ...
				        <option data-foo="Selangor">Selangor</option>
					      	...
					      	<br><br>
					      	<label for="usr">Allocation of Seat : </label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="text" id="alloc" name="seat" required="">
				...
				<table class="order-table table" id="list">
				    <thead>
				      ...
				      <tr>
				        ...
				        <td>{{$ietsschedules->venue}}<br>{{$ietsschedules->address}}<br>{{$ietsschedules->state}}</td>
				        <td><center>{{$ietsschedules->seat}}</center></td>
				        <td id="app"><center>1</center></td>
				        <td id="ex"><center><a href="{{ url('ietsexam/create') }}">Detail</a></center><br>
				        <center><a href="{{ route('ietsschedule.edit', $ietsschedules->id) }}" >
				        	{{ HTML::image('images/edit.png', 'a Edit', array('class' => 'img-responsive cleaner', 'width' => '15', 'height' => '15')) }}</a> </center><br>

				        	{!! Form::open(['route' => ['ietsschedule.destroy', $ietsschedules->id], 'method' => 'DELETE', 'onsubmit' => 'return ConfirmDelete()']) !!}
