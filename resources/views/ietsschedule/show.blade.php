		...
		<div>
			...
			<div class="navbar templatemo-nav" id="navbar">
	      	...
	      	<div class="breadcrumb flat">
    			...
    			<h2>Exam Schedule for Certified IETS Consultant<br></h2>
				    ...
				    <div class="panel panel-primary" style="border-color:#4CAF50;">
				      <div class="panel-heading" style="background-color:#4CAF50;" >
				        <h4 class="panel-title" style="color:white;">
				          <a data-toggle="collapse" href="#collapse1">Exam Schedule for Certified IETS Consultant Instruction :</a>
				        </h4>
				      </div>
				      <div id="collapse1" class="panel-collapse collapse">
				        <div class="panel-body">
				        •  Secretariat IETS can enter the title of exam at the text field provide.<br>
					    •  Secretariat IETS can choose the date, time and enter venue of exam at the text field provided.<br>
						•  Secretariat IETS can click "Confirm" button to confirm the date,time and venue that has been filled.<br>
						•  Secretariat IETS can view the date, time and date at the table below the "Confirm" button.
				        </div>
				      </div>
				    </div>
				  </div>
				...
				<button id="myBtn" style="margin-left:186px;" class="btn btn-success" >Add New Exam Schedule</button>
				...
				<button id="myBtn1" style="margin-left:20px;" class="btn btn-success" >Add New Dropdowns</button>
				  ...
				  <div class="modal2-content">
				    ...
				    <div class="modal2-body">
				      <nav>
					      	<iframe src="{{ url('ietsexamtitle') }}" width="200" height="450" scrolling="yes">
  						<p>Your browser does not support iframes.</p>
						</iframe></nav>

						<article>
						<iframe src="{{ url('ietsvenue') }}" width="200" height="450" scrolling="yes">
  						<p>Your browser does not support iframes.</p>
						</iframe></article>
					      	</div><br>
    			...
    			<div id="myModal" class="modal">
				  ...
				  <div class="modal-content">
				    ...
				    <div class="modal-body">
				      {!! Form::open(array('route' => 'ietsschedule.store', 'data-parsley-validate' => '')) !!}
						...
						<br><div class="input-group" style="width: 100%;">
						    ...
						    <span class="input-group-addon" style="width: 40%;" id="ietsexamtitle" name="ietsexamtitle_id">Exam Title</span>
						    <select style="width:97.7%" id="ietsexamtitle" name="ietsexamtitle_id" class="form-control" required="">
				        	<option value="0" disabled="true" selected="true">--Please Select--</option>
						    @foreach($ietsexamtitles as $cat)
				        	<option value="{!! $cat->id !!}">{!! $cat->ietsexamtitle !!}</option>
				        	@endforeach
				        	</select>
						    </div><br></nav><br>
				        	...
				        	<div class="input-group" style="width: 100%;">
						    <span class="input-group-addon" style="width: 40%;" name="ietsvenue_id" id="ietsvenue_id">Venue</span>
						    <select id="ietsvenue" name="ietsvenue_id" class="form-control" onchange='ChangeVal(this.value);' required="" style="width:97.7%">
				        	<option value="0" disabled="true" selected="true">--Please Select--</option>

				        	@foreach($ietsvenues as $cat)
				        	<option value="{!! $cat->id !!}">{!! $cat->ietsvenue !!}</option>
				        	@endforeach
				        	</select>
						    ...
						    <input type="number" id="seat" name="seat" class="form-control" required="" style="width:36.6%">
						    </div></div>
				...
				<input type="search" class="light-table-filter" data-table="order-table"  placeholder="Search..." class="form-control" style="width: 17%; float:right; margin-right:186px;"><br><br>

				<div class="table-responsive">
				<table class="order-table table" id="list" style="width:80%;" align="center">
				    <thead valign="top">
				      <tr style="background-color: #4CAF50; color: white;">
				        <th onclick="sortTable(0)" style="width:10%;">No.</th>
				        ...
				        <th onclick="sortTable(4)" style="width:16%;">Time</th>
				        <th onclick="sortTable(5)" style="width:15%;">Venue</th>
				        <th onclick="sortTable(6)" style="width:7%;"><center>Seat No.</center></th>
				        <th onclick="sortTable(7)" style="width:7%;"><center>No. of Applicant</center></th>
				      ...
				      <tr>
				      <tbody>
				        @foreach($ietsschedule as $ietsschedules)
				      <tr>
				        <td></td>
				        <td>{{$ietsschedules->typeofexam}}</td>
				        <td>{{$ietsschedules->ietsexamtitle->ietsexamtitle}}</td>
				        ...
				        <td>{{$ietsschedules->ietsvenue->ietsvenue}}<br>{{$ietsschedules->address}}<br>{{$ietsschedules->state}}</td>
				        <td><center>{{$ietsschedules->seat}}</center></td>
				        <td id="app"><center>
				        	@if ($ietsschedules->seat == $ietsexam) 
				        ...
				        <td id="ex">
				        <form action="{{ url('ietsexam/create') }}" method="get">
					    <input type="submit" value="Attendant"/></form></td>
				        <td><a href="{{ route('ietsschedule.edit', $ietsschedules->id) }}" >
				        	{{ HTML::image('images/edit.png', 'a Edit', array( 'width' => '20', 'title' => 'Edit')) }}</a> </td>

				        	<td>{!! Form::open(['route' => ['ietsschedule.destroy', $ietsschedules->id], 'method' => 'DELETE', 'onsubmit' => 'return ConfirmDelete()']) !!}
...
function ChangeVal(val){
 var element=document.getElementById('ietsvenue');
