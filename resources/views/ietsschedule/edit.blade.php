...
<body>
		...
		<div>
			...
			<div class="navbar templatemo-nav" id="navbar">
	      	...
	      	<div class="breadcrumb flat">
				    ...
				    <a class="active" style="color">Schedule</a>        
				  </div>
				</div>
    			...
    			{!! Form::model($ietsschedule, ['route' =>['ietsschedule.update', $ietsschedule->id], 'method' => 'PUT']) !!}
						...
						<div class="input-group" style="width: 100%;">
						    ...
						    <nav>
							<div class="input-group" style="width: 100%;">
						    <span class="input-group-addon" style="width: 40%;" id="ietsexamtitle">Exam Title</span>
						    {{ Form::select('ietsexamtitle_id', $ietsexamtitles, null, ['style' => 'width:97.7%;', 'class' => 'form-control']) }}
						    </div><br></nav>
				        <!-- 
							<article>   
							<div id="check">
					        ...
					        <iframe src="{{ url('ietsexamtitle') }}" width="200" height="225" scrolling="yes">
 ...
 -->
				        	...
				        	<div class="input-group" style="width: 100%;">
						    <span class="input-group-addon" style="width: 40%;" id="ietsvenue_id">Venue</span>
						    {{ Form::select('ietsvenue_id', $ietsvenues, null, ['style' => 'width:97.7%;', 'onChange' => 'ChangeVal(this.value);' , 'class' => 'form-control']) }}
...
<!-- 
				        ...
				        <div class="max_tickets1">
					      	<iframe src="{{ url('ietsvenue') }}" width="200" height="225" scrolling="yes">
  						<p>Your browser does not support iframes.</p>
						</iframe>
					      	</div>
					      	</div>
 ...
 -->
						    ...
						    {{ Form::textarea('address', null, ['style' => 'width:36.6%;', 'class' => 'form-control', 'id' => 'address', 'rows' => '4', 'cols' => '30']) }}
						    </div><br>
					    ...
					    <center>
					     ...
					     <th>
					      <center>{!! Html::linkRoute('ietsschedule.show', 'Cancel', array($ietsschedule->id), array('class' => 'btn btn-danger btn-block', 'style' => 'width:150px')) !!}</center>
					      </th>
					      </tr>
					      </table></center>
					  {!! Form::close() !!}
