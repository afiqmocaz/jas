 ...
 <!-- TABS ANNOUNCE EIA-->
  ...
  <div class="clearfix"></div>
      ...
      <div class="credit row">
        ...
        <footer>Copyright &#169; 2017-<?=date('Y')?> Jabatan Alam Sekitar<br>Best viewed using Internet Explorer 11+, Mozilla Firefox, Google Chrome and Safari with resolution 1280x768 pixels and above</footer>
