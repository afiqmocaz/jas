...
<head>
	...
	<title>*test* Jabatan Alam Sekitar</title>
		...
		<div>
			...
			<div class="navbar templatemo-nav" id="navbar">
	      	...
	      	<div class="breadcrumb flat">
				    ...
				    <a href="#">MANAGE</a>
				    <a href="#">Assignment</a>
				    <a class="active" style="color:white">Applicant Assignment</a>        
				  </div>
				</div>
...
<div class="container">
				...
				{!! Form::open(array('route' => 'eiaassignapp.store', 'data-parsley-validate' => '')) !!}
				
    			<h1>Assignment Course<br></h1>
				...
				<div style="width: 100%;" class="panel-group" >
				    <div class="panel panel-primary alert-success" >
				      ...
				      <div id="collapse1" class="panel-collapse collapse">
				        ...
				        •  Secretariat EIA can assign assignment to applicant with assignning the assign code that have been generate at the master file<br>  
						...
						•  Secretariat EIA can set the status pass or fail to the assignmet of the applicant<br>
				...
				<br></div> 
				<input type="search" class="light-table-filter" data-table="order-table"  placeholder="Search..." style="width: 17%; float:right; margin-right: 179px"><br><br>

				<div class="container table-responsive">
				<table class="order-table table" id="list" style="width:100%;" align="center">
                                    <thead >
				    
				        <th onclick="sortTable(0)" style="width:4%;" class="alert-success"><center>No.</center></th>
				        <th onclick="sortTable(1)" style="width:10%;" class="alert-success"><center>Applicant Name</center></th>
				        <th onclick="sortTable(2)" style="width:10%;" class="alert-success"><center>NRIC/Passport</center></th>
				        <th onclick="sortTable(4)" style="width:10%;" class="alert-success"><center>File Uploaded</center></th>
				        <th onclick="sortTable(5)" style="width:10%;" class="alert-success"><center>Assign Panel</center></th>

				        <th onclick="sortTable(6)" style="width:10%;" class="alert-success"><center>Rubric</center></th>
				        <th onclick="sortTable(7)" style="width:10%;" class="alert-success"><center>Date Softcopy Received</center></th>
				        <th onclick="sortTable(8)" style="width:5%;" class="alert-success"><center>Date Hardcopy Received</center></th>
				        <th onclick="sortTable(9)" style="width:5%;" class="alert-success"><center>Result</center></th>
				        <th onclick="sortTable(10)" style="width:10%;" class="alert-success"><center>Action</center></th>
				      </thead>

 				      @foreach($user as $users)
				     @foreach($assignupload as $assign)
				      <tr>
				  		 @if($users->id == $assign->user_id)
				        <td></td>
				        <td><input type="text" id="appname" name="appname" value='{{$users->name}}' readonly></td>
				        <td><input type="text" id="appic" name="appic" value='{{$users->nric}}' readonly></td>
				        <td> <input type="text" id="fileupload" name="fileupload" value='{{$assign->original_filename}}' readonly></td>
				        <td>
                                            
                                            <input type="text" id="panel" name="panel" value='{{$sme}}'>
                                        
                                        
                                        </td>
				        <td><center><a href="{{ route('ietsrubric.edit', $assign->id) }}" style="background-color: #4CAF50; border: none; color: white; padding: 8px; text-align: center; text-decoration: none; display: font-size: 16px; margin: 4px 2px; cursor: pointer;" >Rubric</a>
						</center></td>
				        <td><input type="date" id="softdate" name="softdate" value={{$assign->created_at}}></td>
				        <td><input type="date" id="harddate" name="harddate"></td>
				        <td></td>
				        <td><center>
				        {{ Form::submit('Send to SME', ['class' => 'btn btn-primary btn-block', 'style' => 'width:150px;']) }}
				        </center></td>
				        @endif
				        @endforeach
				        @endforeach
