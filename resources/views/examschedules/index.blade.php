...
<div class="container">
    ...
    <label style="width:90%;margin-left:30px">Please Choose Examination Date Below:</label><br>
 ...
 <div class="hide">{{$availableSeat = $ietsschedules->seat - count($ietsschedules->examCandidates)}}</div>
 ...
 <table class='table table-bordered' style="width:90%">
         ...
         <td >
            <div class="input-group {{$availableSeat <= 0?'hide':''}}" >
             ...
             <tr>
               ...
               <td><br>{{$ietsschedules->eiavenue->eiavenue}}<br>{{$ietsschedules->address}}<br>{{$ietsschedules->state}}</td>
             </tr>
  ...
  @endforeach
              ...
              <input type="submit" class="btn btn-primary" onclick='onSubmitClick();' value="Agree and Apply" /><hr><br>
              </div>
            {!! Form::close() !!} 
        </div>
        <script>
