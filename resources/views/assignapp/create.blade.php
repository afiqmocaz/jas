		...
		<div>
			...
			<div class="navbar templatemo-nav" id="navbar">
	      	...
	      	<div class="breadcrumb flat">
				...
				{!! Form::open(array('route' => 'assignapp.store', 'data-parsley-validate' => '')) !!}
				...
				<input type="search" class="light-table-filter" data-table="order-table"  placeholder="Search..." style="width: 17%; float:right; margin-right: 178px"><br><br>
				...
				<table class="order-table table" id="list" style="width:80%;" align="center">
				    <thead valign="top">
					 ...
					 @foreach($assignupload as $apcsassign)
				      <tr>
				     @if($susers->id == $apcsassign->user_id)
				        <td></td>
				        <td><input type="text" id="appname" name="appname" value='{{$users->name}}'></td>
				        <td><input type="text" id="appic" name="appic" value='{{$users->nric}}'></td>
				        <td> <input type="text" id="fileupload" name="fileupload" value='{{$apcsassign->original_filename}}'></td>
				        <td><input type="text" id="panel" name="panel" value='{{$sme}}'>
                    <p class="help-block"></p></td>
				        <td><center><a href="{{ route('rubric.edit', $users->id) }}" style="background-color: #4CAF50; border: none; color: white; padding: 8px; text-align: center; text-decoration: none; display: font-size: 16px; margin: 4px 2px; cursor: pointer;" >Rubric</a>
						</center></td>
				        <td><input type="date" id="softdate" name="softdate" value='{{$apcsassign->created_at}}'></td>
