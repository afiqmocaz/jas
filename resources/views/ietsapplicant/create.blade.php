		...
		<div>
			...
			<div class="navbar templatemo-nav" id="navbar">
	      	...
	      	<div class="breadcrumb flat">
				    ...
				    <a href="#">APPLICANT</a>
				    <a class="active">Applicant Registration</a>        
				  </div>
				</div><br>
				...
				<div style="width: 100%;" class="panel-group" >
				    <div class="panel panel-primary" style="border-color:#4CAF50;">
				      ...
				      <div id="collapse1" class="panel-collapse collapse">
				        ...
				        •  Secretariat IETS can click the applicant name to view the applicant registeration form from section A to Section F.<br>  
						...
						•  Secretariat IETS can view the comment that have been given at the applicant registeration form.
				        </div>
				      </div>
				    </div>
				  </div>
				...
				<table class="order-table table" id="myTable">
				    ...
				    <tbody>
				        ...
				        @foreach($ietsapplicant as $ietsapplicants)
                                         <tr>
                                         <td></td>
				        <td><a href="{{ route('ietsappinfo.edit', $ietsapplicants->id) }}" >
				        	{{$ietsapplicants->user->name}}</a></td>
				        <td>{{$ietsapplicants->user->nric}}</td>
                                        
				        <td>{{ $ietsapplicants -> comment }}</td>
				        <td>{{ $ietsapplicants -> status }}</td>
                                         </tr>
				        @endforeach
