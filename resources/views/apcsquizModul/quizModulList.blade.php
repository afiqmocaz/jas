...
{{ Form::open(array('url' => 'apcsquizModul/save')) }}
<div id="formId"></div>
...
<form id="formExamSetting" action="/apcsquizModul/saveExamSetting" method="POST">
...
{{ Form::open(array('url' => 'apcsquizModul/remove')) }}
        ...
        columns: [
            ...
            },
            {
                render: function (data, type, row, meta) {
                    ...
                    return '<a href="/apcsquestion/' + row.id + '">' + row.name + '</a>';
                }, width: "60%"
                , orderable: false
            },
            {
