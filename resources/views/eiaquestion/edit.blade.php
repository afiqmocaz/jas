		...
		<div>
			...
			<div class="navbar templatemo-nav" id="navbar">
	      	...
	      	<div class="breadcrumb flat">
    			...
    			{!! Form::model($question, ['route' =>['eiaquestion.update', $question->id], 'method' => 'PUT', 'files' => true]) !!}
					    <div class="form-group">
					     ...
					     <th>
					      <center>{!! Html::linkRoute('eiaquestion.show', 'Cancel', array($question->id), array('class' => 'btn btn-danger btn-block', 'style' => 'width:150px')) !!}</center>
					      </th>
					      </tr>
					      </table></center><br>
