...
<h1 style="margin: 0px;font-size: 24px">Announcement Upload (Edit)&nbsp;<a id="popoverData" class="btn btn-primary" href="#" data-content='&bull;  Secretariat APCS can enter announcement in the text area and click button "Update".<br>
						&bull;  The announcement entered by Secretariat APCS will be shown in the announcement box at the Home Page.'
        data-html="true" data-placement="right" data-original-title="Announcement Upload Instruction" data-trigger="hover"><i class="glyphicon glyphicon-info-sign"></i></a></h1>
    		...
    		<!-- <h1>Announcement Upload <br></h1> -->  
				...
				<br> 
					...
					{!! Form::model($announce, ['route' =>['announce.update', $announce->id], 'method' => 'PUT', 'files' => true]) !!}
    				...
    				<div class="form-group">
						    ...
						    <div class="input-group" style="width: 100%;">
						      ...
						      <center><input id="original_filename" type="file" class="form-control" name="original_filename" accept=".pdf" onchange="myFunction(this)" multiple="multiple" style="width: 100%;">
					     ...
					     <th>
					      <center>{!! Html::linkRoute('announce.show', 'Cancel', array($announce->id), array('class' => 'btn btn-danger btn-block', 'style' => 'width:150px')) !!}</center>
					      </th>
					      </tr>
					      </table></center> -->
					      ...
					      <div align="right">
						  	...
						  	{!! Html::linkRoute('announce.show', 'Cancel', array($announce->id), array('class' => 'btn btn-primary')) !!}
						  </div>
