...
<div class="table-responsive">
  ...
  <table class="table">
    ...
    {!! Form::open(['route' => 'eiaSectionC.store', 'data-parsley-validate'=> '']) !!}
      ...
      <select class="form-control" name="course" id="course" required=""  style="width:99%">
      ...
      <tr>
        ...
        <input type="text" class="form-control inputan kusus" id="date_complete" data-format="dd-MM-yyyy" name="date_complete"  required="" style="width: 55%"/>
      ...
      <tr>
        ...
        <td>
          {{ Form::text('cert_no', null, array('class' => 'form-control', 'style' => 'width: 30%', 'placeholder'=>'Eg: AF 32457', 'required' => '','maxlength'=>10,'minlength'=>5))}}
        </td>
      </tr>
    </tbody>
  </table>
