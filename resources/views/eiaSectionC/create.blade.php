...
<link rel="stylesheet" href="//cdnjs.cloudflare.com/ajax/libs/bootstrap-datepicker/1.3.0/css/datepicker3.min.css" />
  ...
  enctype="multipart/form-data">
    ...
    <div class="form-group" >
        ...
        <div class="col-xs-8">
             <select class="form-control input-sm" name="course" id="course" style="font-size: 15px;width: 140%">
      ...
      <div class="row">
            <div style=" margin-top: 10px; margin-bottom: 10px;" align="right">
              <a class="btn btn-primary" href="/eiaSectionB/create" role="button">Back</a>
               <a href="/eiaSectionD/create" class="btn btn-primary" role="button">Skip</a>
