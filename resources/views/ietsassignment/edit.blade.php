...
@section('js')
@endsection
@section('header', 'IETS: Course Assignment')
@section('content')
...
<h1 style="margin: 0px;font-size: 24px">PCER Format&nbsp;<a id="popoverData" class="btn btn-primary" href="#" data-content='&bull;  The purpose of this page is to generate the assignment and assign code to be use in the page of applicant assignment and panel assignment.<br>  
						&bull;  Secretariat IETS can fill the title of the assignment at the text field of Topic.<br>
						&bull;  Secretariat IETS can fill the specialized area of the assignment at the text field of Specialized Area.<br>
						&bull;  Secretariat IETS can upload the assignment with clicking the button "Choose File" at the text field of Upload PCER<br>
						&bull;  The Assign Date and Dateline can be set by date.<br>
						&bull;  Secretariat IETS can fill the code of assign for example "APCS01" at the text field of Assign Code to be assign to applicant and panel.<br>
						&bull;  Secretariat IETS can click the button "Save" to save the progress that have been made.<br>
						&bull;  Secretariat IETS can view the uploaded assignment at the table below.'
...
{!! Form::model($ietsassignment, ['route' =>['ietsassignment.update', $ietsassignment->id], 'method' => 'PUT', 'files' => true]) !!}

<div class="form-group">
							
	<div class="input-group" style="width: 100%;">
	    <span class="input-group-addon" style="width: 20%;text-align: left;">Upload PCER</span>
	    <input type="file" id="original_filename" name="original_filename" class="form-control" required="" accept=".pdf , .doc , .docx , .txt" onchange="myFunction()" multiple style="width:100%">
	    </div>
    ...
    <!-- <center>
     ...
     <th>
      <center>{!! Html::linkRoute('ietsassignment.show', 'Cancel', array($ietsassignment->id), array('class' => 'btn btn-danger btn-block', 'style' => 'width:150px')) !!}</center>
      </th>
      </tr>
      </table></center><br> -->
      ...
      <div align="right">
    	...
    	{!! Html::linkRoute('ietsassignment.show', 'Cancel', array($ietsassignment->id), array('class' => 'btn btn-primary')) !!}
    </div>
