	...
	<div class="modal-dialog">
	  ...
	  <div class="modal-content">
	    ...
	    <div class="modal-body">
	      {!! Form::open(array('url'=>'ietsassignment/uploadFiles', 'method'=>'POST', 'files'=>true)) !!}

				<div class="form-group">
				
		      	<br><div class="input-group" style="width: 100%;">
			    <span class="input-group-addon" style="width: 28%;text-align: left;">Upload PCER</span>
		      ...
		      <label><center><b>File Type: .pdf, .doc, .docx, .txt	|	Max File Upload: 10	|	Max Size Upload: 10MB</b></center></label><br>
			    ...
			    <span class="input-group-addon" style="width: 28%;text-align: left;" id="name">PCER Name</span>
      ...
      <tbody>
		@foreach($ietsassignment as $ietsassignments)
	      <tr>
        	...
        	<center>{!! Form::image('images/delete.ico', 'a Delete', ['type' => 'submit',  'class' => 'btnimg', 'title' => 'Edit'] ) !!}</center>
