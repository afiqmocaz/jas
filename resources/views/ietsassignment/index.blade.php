	      	...
	      	<div class="breadcrumb flat">
				...
				<br>            
				 ...
				 {!! Form::open(array('route' => 'ietsassignment.store', 'data-parsley-validate' => '', 'files' => true)) !!}
					     ...
					     <br><br><label for="usr">Duration of Assignment &nbsp&nbsp&nbsp&nbsp : </label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
					      	<input type="text" id="duration" name="duration" required="" style="width: 50px;"><label for="usr">&nbsp Days</label><br>

					      <br><label for="usr">Code Assign &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp : </label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
				...
				<table class="order-table table" id="list">
				    <thead>
				      ...
				      <tr>
				        <td></td>
				        <td>{{$ietsassignments->topic}}</td>
				        <td>{{$ietsassignments->specialized}}</td>
				        <td><a class="file" href="/images/{{$ietsassignments->fileToUpload}}">{{$ietsassignments->fileToUpload}}</a></td>
				         <td><center>{{$ietsassignments->duration}}</center></td>
				        <td>{{$ietsassignments->code}}</td>
				        <td id="rub"><center><form action="{{ url('ietsrubric/create') }}" method="get">
				        ...
				        <td><center><a href="{{ route('ietsassignment.edit', $ietsassignments->id) }}" >
				        	...
				        	{!! Form::open(['route' => ['ietsassignment.destroy', $ietsassignments->id], 'method' => 'DELETE', 'onsubmit' => 'return ConfirmDelete()']) !!}
