		...
		<div>
			...
			<div class="navbar templatemo-nav" id="navbar">
	      	...
	      	<div class="breadcrumb flat">
				    ...
				    <a href="#">REPORT</a>
				    <a href="{{ url('eiacpd/create') }}">Continuous Professional Development (CPD)</a>
				    <a class="active">Qualified Person (QP) Profile</a>        
				  </div>
				</div>
				    ...
				    <div class="panel panel-primary" style="border-color:#4CAF50;">
				      <div class="panel-heading" style="background-color:#4CAF50;" >
				        <h4 class="panel-title" style="color:white;">
				          <a data-toggle="collapse" href="#collapse1">Qualified Person (QP) Profile Instruction :</a>
				        </h4>
				      </div>
				      <div id="collapse1" class="panel-collapse collapse">
				        <div class="panel-body">
				        •  In this Form, Secretariat EIA can view the QP profile of the applicant.<br>
						•  Secretariat can select the QP status and Renewal Certificate Status according to the status of applicant.<br>
						•  Secretariat EIA can click the "Email".button to send email to the applicant of notification to renew the certificate.<br>
