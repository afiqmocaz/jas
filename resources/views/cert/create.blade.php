		...
		<div>
			...
			<div class="navbar templatemo-nav" id="navbar">
	      	...
	      	<div class="breadcrumb flat">
				    ...
				    <a href="#">REPORT</a>
				    <a class="active" style="color:white">Certificate Approval</a>        
				  </div>
				</div>
				...
				<!-- INSTRUCTION -->
				  <div style="width: 100%;" class="panel-group" >
				    <div class="panel panel-primary" style="border-color:#4CAF50;">
				      ...
				      <div id="collapse1" class="panel-collapse collapse">
						...
						•  Secretariat APCS can view the marks and status of applicant procedure with clicking the button "View".<br>
						•  Secretariat APCS can fill the specialized area of the assignment at the text field of Specialized Area.<br>
						•  Secretariat APCS can endorse the certificate with select approve or reject at the field of Endorsement.<br>
						•  Secretariat APCS can give remarks or commend about the status and marks of the applicant procedure at the text area of Remarks(Comment)<br>
						•  Secretariat APCS can certified or not certified the certification at the field of Status<br>
				  ...
				  <br><button id="myBtn" style="margin-left:0px;" class="btn btn-success" >Certified Applicant List</button>

				  <button id="myBtn1" style="margin-left:20px;" class="btn btn-success" >Renewal Certificate</button>
    			...
    			<div id="myModal" class="modal">
				  ...
				  <div class="modal-content">
				    <div class="modal-header">
				      ...
				      <h2>Certified Applicant List</h2>
				    </div>
				    <div class="modal-body">

     				<br><input type="search" class="light-table-filter1" data-table="order-table1"  placeholder="Search..." style="width: 222px;"><br><br>

				<div class="table-responsive">
				<table class="order-table1" id="list1" style="width:200%;">
				<thead>
				      <tr>
				        <th onclick="sortTable1(0)" style="width:3%;"><center>No.</center></th>
				        <th onclick="sortTable1(1)" style="width:8%;"><center>Applicant Name</center></th>
				        <th onclick="sortTable1(2)" style="width:8%;"><center>NRIC/Passport</center></th>
				        <th onclick="sortTable1(3)" style="width:8%;"><center>Title</center></th>
				        <th onclick="sortTable1(4)" style="width:30%;"><center>Specialized Area</center></th>
				        <th onclick="sortTable1(5)" style="width:8%;"><center>Certification Status</center></th>
				        <th onclick="sortTable1(6)" style="width:8%;"><center>Remark(Comment)</center></th>
				        
				        <th onclick="sortTable1(7)" style="width:8%;"><center>Certified By</center></th>
				        <th onclick="sortTable1(8)" style="width:8%;"><center>Generate Certificate</center></th>
				      </tr></thead>
				    <tbody>
				      ...
				      <tr>
				        ...
				        <td>{{$users->nric}}</td>
				        <td><center></center></td>
				        <td><li>{{$apcsappbs->specialize_0}}</li><br>
				        <li>{{$apcsappbs->specialize_1}}</li><br>
				        <li>{{$apcsappbs->specialize_2}}</li><br>
				        <li>{{$apcsappbs->specialize_3}}</li></td>
				...
				<thead>
				      <tr>
				        ...
				        <th onclick="sortTable1(3)" style="width:8%;"><center>Title</center></th>
				        <th onclick="sortTable1(4)" style="width:30%;"><center>Specialized Area</center></th>
				        <th onclick="sortTable1(5)" style="width:8%;"><center>Renewal Status</center></th>
				        <th onclick="sortTable1(6)" style="width:8%;"><center>Renewal Action</center></th>
				        <th onclick="sortTable1(7)" style="width:8%;"><center>Generate Certificate</center></th>
				      </tr></thead>
				    <tbody>
				      	@foreach($user as $users)
				    	@foreach($apcsappb as $apcsappbs)
				...
				<thead valign="top">
				      <tr>
				        ...
				        <th onclick="sortTable(4)" style="width:30%;"><center>Specialized Area</center></th>
				        <th onclick="sortTable(5)" style="width:8%;"><center>Certification Information</center></th>
				        <th onclick="sortTable(6)" style="width:8%;"><center>Endorsement</center></th>
				        <th onclick="sortTable(7)" style="width:12%;"><center>Expired Date</center></th>
				        <th onclick="sortTable(8)" style="width:8%;"><center>Remark(Comment)</center></th>
				        <th onclick="sortTable(9)" style="width:8%;"><center>Status</center></th>
				        <th onclick="sortTable(10)" style="width:8%;"><center>Action</center></th>
				      </tr>
				      </thead>
				    ...
				    @foreach($cert as $certs)
				      <tr>
				        ...
				        <li>{{$apcsappbs->specialize_2}}</li><br>
				        <li>{{$apcsappbs->specialize_3}}</li></td>
				        <td><form action="{{ url('endorse/create') }}" method="get">
					    	<input type="submit" value="View"/>
							</form></td>
				        <td>{{$certs->endorse}}</td>
				        <td>
				        <?php
						$date = new DateTime("$certs->expired");
				        ...
				        <td>{{$certs->remark}}</td>
							<td>{{$certs->status}}</td>
							<td><center><a href="{{ route('cert.edit', $certs->id) }}" >
				  ...
				  <button href="" class="btn btn-success" style="margin-left: 170px">Save</button><br><br>
