			...
			<div class="navbar templatemo-nav" id="navbar">
	      	...
	      	<div class="breadcrumb flat">
				...
				<!-- INSTRUCTION -->
				  ...
				  {!! Form::model($array, ['route' =>['cert.update', $cert->id], 'method' => 'PUT', 'files' => true]) !!}
				...
				<thead valign="top">
				    ...
				    <tbody>
				      <tr>
				        ...
				        <td><center></center></td>
				        <td><li>{{ Form::textarea('specialize_0', null, ['readonly' => 'readonly', 'style' => 'border:0;  width:87%;', 'rows' => '7']) }}</li><br>
				        <li>{{ Form::textarea('specialize_1', null, ['readonly' => 'readonly', 'style' => 'border:0;  width:87%;', 'rows' => '7']) }}</li><br>
				        <li>{{ Form::textarea('specialize_2', null, ['readonly' => 'readonly', 'style' => 'border:0;  width:87%;', 'rows' => '7']) }}</li><br>
				        <li>{{ Form::textarea('specialize_3', null, ['readonly' => 'readonly', 'style' => 'border:0;  width:87%;', 'rows' => '7']) }}</li></td>
				        <td><form action="{{ url('endorse/create') }}" method="get">
					    	<input type="submit" value="View"/>
							</form></td>
				        <td>
				        <select id="endorse" name="endorse">
				        ...
				        <td>
				        <?php
						$date = new DateTime("$cert->expired");
				  ...
				  <center><table width="40%">
					     ...
					     <td>
					      <center>{!! Html::linkRoute('cert.create', 'Cancel', array($cert->id), array('class' => 'btn btn-danger btn-block', 'style' => 'width:150px')) !!}</center>
					      </th>
					      </tr>
					      </table></center><br>
				  {!! form::close() !!}
