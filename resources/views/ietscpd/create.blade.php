		...
		<div>
			...
			<div class="navbar templatemo-nav" id="navbar">
	      	...
	      	<div class="breadcrumb flat">
				    ...
				    <a href="#">REPORT</a>
				    <a class="active">Continuous Professional Development (CPD)</a>        
				  </div>
				</div>
    			...
    			<h1>Continuous Professional Development(CPD)<br></h1>  
    			<h2>CPD Points<br></h2> 
				    ...
				    <div class="panel panel-primary" style="border-color:#4CAF50;">
				      <div class="panel-heading" style="background-color:#4CAF50;" >
				        <h4 class="panel-title" style="color:white;">
				          <a data-toggle="collapse" href="#collapse1">CPD Points Instruction :</a>
				        </h4>
				      </div>
				      <div id="collapse1" class="panel-collapse collapse">
				        <div class="panel-body">
				        •  In this Form, Secretariat IETS can view the CPD points of the applicant.<br>
						•  Secretariat can click the name of applicant to view the QP profile of the applicant.<br>
						•  Secretariat IETS can click "Save" button to save the changes that has been made.
				        </div>
				      </div>
				    </div>
				  </div>
				...
				<table class="order-table table" id="list">
				    <thead valign="top">
				      <tr>
				        ...
				        <th onclick="sortTable(3)">Applicant ID</th>
				        <th onclick="sortTable(4)">Competent Person (CP) ID</th>
				        <th onclick="sortTable(5)">CPD Points</th>
				        <th onclick="sortTable(6)">Expired Date</th>
				        <th onclick="sortTable(7)">Renewal</th>
				      </tr>
				      </thead>
				    <tbody>
				      <tr>
				        ...
				        <td></td>
				        <td><a href="{{ url('ietscp/create') }}">Muhd Izzat</a></td>
				        <td>941203069897</td>
				        <td>IETS001</td>
				        <td>CPIETS01</td>
				        <td>150</td>
