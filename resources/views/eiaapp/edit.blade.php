...
<table style="width:100%">
  ...
  <tr>
    ...
    @foreach($eiaappb as $eiaappb)
  <tr>
    <th width="30%">Name / Course Title</th>
    <td width="70%">{{ Form::text('coursetitle', $eiaappb->coursetitle, ['readonly' => 'readonly', 'style' => 'border:0; width:95%;']) }}</td>
  </tr>
  <tr>
    <th>Major</th>
    <td>{{ Form::text('major', $eiaappb->major, ['readonly' => 'readonly', 'style' => 'border:0; width:95%;']) }}</td>
  </tr>
  <tr>
    <th>Name of University / College</th>
    <td>{{ Form::text('universityname', $eiaappb->universityname, ['readonly' => 'readonly', 'style' => 'border:0; width:95%;']) }}</td>
  </tr>
  <tr>
    <th>Year of Study</th>
    <td>From {{ Form::text('date_from', $eiaappb->date_from, ['readonly' => 'readonly', 'style' => 'border:0; width:90%;']) }}  Until {{ Form::text('date_to', $eiaappb->date_to, ['readonly' => 'readonly', 'style' => 'border:0; width:90%;']) }}</td>
  </tr>
  
  <tr>
    <div>
        @if(! empty($eiaappb->cert))
        ...
        <a class="current-attachment" src="/uploads/{{$eiaappb->cert}}" href="/uploads/{{$eiaappb->cert}}" width="100px" height="150px">{{$eiaappb->cert}}</a></td>
        @endif
    </div>
    </tr>
@endforeach
...
@foreach($eiaappc as $eiaappc)
  <tr>
    <th width="30%">Name / Course Title</th>
    <td width="70%">{{ Form::text('course',  $eiaappc->course, ['readonly' => 'readonly', 'style' => 'border:0; width:95%;']) }}</td>
  </tr>
  <tr>
    <th>Date Completed</th>
    <td>{{ Form::text('date_complete', $eiaappc->date_complete, ['readonly' => 'readonly', 'style' => 'border:0; width:90%;']) }}</td>
  </tr>
  <tr>
    <th>Certificate No.</th>
    <td>{{ Form::text('cert_no', $eiaappc->cert_no, ['readonly' => 'readonly', 'style' => 'border:0; width:95%;']) }}</td>
  </tr>
@endforeach
  </table>
  ...
  <tr>
	...
	@foreach($eiaappd as $eiaappd)
  <tr>
    <th width="30%">Participation in</th>
    <td width="70%">{{ Form::text('participate', $eiaappd->participate, ['readonly' => 'readonly', 'style' => 'border:0; width:95%;']) }}</td>
  </tr>
  <tr>
    <th>Name of Project</th>
    <td>{{ Form::text('project_name', $eiaappd->project_name, ['readonly' => 'readonly', 'style' => 'border:0; width:95%;']) }}</td>
  </tr>
  <tr>
    <th>Position</th>
    <td>{{ Form::text('position', $eiaappd->position, ['readonly' => 'readonly', 'style' => 'border:0; width:95%;']) }}</td>
  </tr>
  <tr>
    <th>Responsibilities</th>
    <td>{{ Form::text('responsibilities', $eiaappd->responsibilities, ['readonly' => 'readonly', 'style' => 'border:0; width:95%;']) }}</td>
  </tr>
  <tr>
    <th>Date Start</th>
    <td>{{ date('d-m-Y', strtotime($eiaappd->dateStart))}}</td>
  </tr>
  <tr>
    <th>Date End</th>
    <td>{{ date('d-m-Y', strtotime($eiaappd->dateEnd))}}</td>
  </tr>

  <tr>
     <div>
        @if(! empty($eiaappd->supportdoc))
        ...
        <a class="current-attachment" src="/uploads/{{$eiaappd->supportdoc}}" target="_blank" href="/uploads/{{$eiaappd->supportdoc}}" width="100px" height="150px">{{$eiaappd->supportdoc}}</a></td>
        @endif
    </div>
    </tr>
  ...
  <tr>
    <th>Name</th>
    <td>{{ Form::text('ref_name', $eiaappd->ref_name, ['readonly' => 'readonly', 'style' => 'border:0; width:95%;']) }}</td>
  </tr>
  <tr>
    <th>Address</th>
    <td>{{ Form::text('ref_address',  $eiaappd->ref_address, ['readonly' => 'readonly', 'style' => 'border:0; width:95%;']) }}</td>
  </tr>
  <tr>
    <th>Email</th>
    <td>{{ Form::text('ref_email',  $eiaappd->ref_email, ['readonly' => 'readonly', 'style' => 'border:0; width:95%;']) }}</td>
  </tr>
