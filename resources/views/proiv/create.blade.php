		...
		<div>
			...
			<div class="navbar templatemo-nav" id="navbar">
	      	...
	      	<div class="breadcrumb flat">
				    ...
				    <a href="#">MANAGE</a>
				    <a class="active" style="color:white">Profesional Interview</a>        
				  </div>
				</div>
				  ...
				  <div style="width: 100%;" class="panel-group" >
				    <div class="panel panel-primary" style="border-color:#4CAF50;">
				      ...
				      <div id="collapse1" class="panel-collapse collapse">
				        ...
				        •  In this Form, Secretariat APCS can set the interview session for applicant and can set the attendance of the applicant.<br>
						•  Secretariat can click "Assign" button to set the date, time and venue of interview session.<br>
						•  Secretariat APCS can select the attendance of the applicant.
				        </div>
				      </div>
				    </div>
				  </div>
				...
				<table class="order-table table" id="list" style="width:100%;">
				    <thead valign="top">
				      <tr>
				        <th onclick="sortTable(0)" style="width:8%;"><center>No.</center></th>
				        ...
				        <th onclick="sortTable(3)" style="width:8%;"><center>Applicant ID</center></th>
				        <th onclick="sortTable(4)" style="width:8%;"><center>Set Interview Session</center></th>
				        <th onclick="sortTable(5)" style="width:8%;"><center>Date of Interview</center></th>
				        <th onclick="sortTable(6)" style="width:8%;"><center>Applicant Status</center></th>
				        <th onclick="sortTable(7)" style="width:8%;"><center>Attendance</center></th>
				      </tr></thead>
				      @foreach($user as $users)
				      @foreach($proiv as $proivs)
				      @foreach($ivschedule as $ivschedules)
				      <tr>
				        ...
				        <td>{{$users->nric}}</td>
				        <td></td>
				        <td><center><a href="{{ route('ivschedule.edit', $ivschedules->id) }}" style="background-color: #4CAF50; border: none; color: white; padding: 8px; text-align: center; text-decoration: none; display: font-size: 16px; margin: 4px 2px; cursor: pointer;">Assign</a>
						</center></td>
				        <td>{{date('d/m/Y', strtotime($proivs->date))}}</td>
				        <td></td>
				        <td><select>
