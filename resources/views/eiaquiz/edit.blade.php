		...
		<div>
			...
			<div class="navbar templatemo-nav" id="navbar">
	      	...
	      	<div class="breadcrumb flat">
    			...
    			{!! Form::model($quiz, ['route' =>['eiaquiz.update', $quiz->id], 'method' => 'PUT', 'files' => true]) !!}
					    <div class="form-group">
					      ...
					      <div class="input-group" style="width: 100%;">
				        	...
				        	<div class="input-group" style="width: 100%;">
						    <span class="input-group-addon" style="width: 40%;" id="related" name="related_id">Related Refference</span>
					     ...
					     <th>
					      <center>{!! Html::linkRoute('eiaquiz.show', 'Cancel', array($quiz->id), array('class' => 'btn btn-danger btn-block', 'style' => 'width:150px')) !!}</center>
					      </th>
					      </tr>
					      </table></center><br>
