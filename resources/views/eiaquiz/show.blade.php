		...
		<div>
			...
			<div class="navbar templatemo-nav" id="navbar">
	      	...
	      	<div class="breadcrumb flat">
    			...
    			<button id="myBtn" style="margin-left:15px;" class="btn btn-success" >Add New Quiz</button>
    			<button id="myBtn1" style="margin-left:20px;" class="btn btn-success" >Add Related Refference</button><br><br>
    			...
    			<div id="myModal1" class="modal2">
				  ...
				  <div class="modal2-content">
				    <div class="modal2-header">
				      ...
				      <h2>Add New Related Refference</h2>
				    </div>
