...
@endif 
<br>
      <form id="applicantForm" action="{{ route('users.store')}}" method="POST" enctype="multipart/form-data" style="width: 70%;">
        <div class="col-md-8 ">
            <div class="panel panel-default">
                <div class="panel-heading" style="background-color:#222d32;color:white;height:10%;padding-top: 3%;font-family: arial"><center><h4>CREATE NEW USER</h4></center></div>
