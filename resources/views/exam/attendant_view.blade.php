				...
				<div style="width: 100%;" class="panel-group" >
				    <div class="panel panel-primary" style="border-color:#4CAF50;">
				      ...
				      <div id="collapse1" class="panel-collapse collapse">
						...
						•  Secretariat APCS can select the applicant attendant to take the attendant of applicant which is attend or absent.<br> 
						•  Secretariat APCS can select the Status to give the marks status of applicant which is pass,fail or acknowledge if the applicant is absent the examination.<br>
						•  Secretariat APCS can click button "Save" to save the applicant exam information that has been changes.
				        </div>
				      </div>
				    </div>
				  </div>
