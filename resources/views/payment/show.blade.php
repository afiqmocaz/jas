				  ...
				  <div style="width: 100%;" class="panel-group" >
				    <div class="panel panel-primary" style="border-color:#4CAF50;">
				      ...
				      <div id="collapse1" class="panel-collapse collapse">
				        ...
				        •  In this form, Secretariat APCS can view the list of applicant payment with proof.<br>
						•  Secretariat APCS can click the payment proof link to view applicant payment proof.<br>
						•  Secretariat APCS can click success if the payment is successful and the pending if the payment amount is not enough.<br>
						•  Secretariat APCS can click button "Save" to save the list of applicant payment after make changes.
				        </div>
				      </div>
				    </div>
				  </div>
				...
				<table class="order-table table" id="myTable">
				    ...
				    @foreach($payment as $payments)
				      <tr>
				        ...
				        <td>{{$users->name}}</a></td>
				        <td>{{$users->nric}}</td>
				        <td><center>{{$payments->type}}</center></td>
				        <td><center>{{$payments->paymentType}}</center></td>
				        <td><?php if( $_GET["pay"])
									{ 
										echo $_GET['pay']; 
									}?></td>
				        <td>Aizat Hamdan Jailani</td>
				      </tr>
				      @endforeach
				    @endforeach
				    </tbody>
				  ...
				  <button href="payment" class="btn btn-success">Save</button><br><br>      
