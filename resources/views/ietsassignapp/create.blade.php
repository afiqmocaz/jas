		...
		<div>
			...
			<div class="navbar templatemo-nav" id="navbar">
	      	...
	      	<div class="breadcrumb flat">
				...
				{!! Form::open(array('route' => 'ietsassignapp.store', 'data-parsley-validate' => '')) !!}
				...
				<div style="width: 100%;" class="panel-group" >
				    <div class="panel panel-primary" style="border-color:#4CAF50;">
				      ...
				      <div id="collapse1" class="panel-collapse collapse">
				        ...
				        •  Secretariat IETS can assign assignment to applicant with assignning the assign code that have been generate at the master file<br>  
						...
						•  Secretariat IETS can set the status pass or fail to the assignmet of the applicant<br>
				...
				<table class="order-table table" id="list" style="width:80%;" align="center">
				    <thead valign="top">
				      <tr>
				        <th onclick="sortTable(0)" style="width:4%;"><center>No.</center></th>
				        <th onclick="sortTable(1)" style="width:12%;"><center>Applicant Name</center></th>
				        <th onclick="sortTable(2)" style="width:12%;"><center>NRIC/Passport</center></th>
				        <th onclick="sortTable(3)" style="width:12%;"><center>Applicant ID</center></th>
				        <th onclick="sortTable(4)" style="width:10%;"><center>File Uploaded</center></th>
				        <th onclick="sortTable(5)" style="width:10%;"><center>Assign Panel</center></th>

				        <th onclick="sortTable(6)" style="width:8%;"><center>Rubric</center></th>
				        <th onclick="sortTable(7)" style="width:10%;"><center>Date Softcopy Received</center></th>
				        <th onclick="sortTable(8)" style="width:10%;"><center>Date Hardcopy Received</center></th>
				        <th onclick="sortTable(9)" style="width:10%;"><center>Result</center></th>
				      ...
				      <tr>
				        ...
				        <td></td>
				        <td><input type="text" id="appname" name="appname" value='{{$users->name}}'></td>
				        <td><input type="text" id="appic" name="appic" value='{{$users->nric}}'></td>
				        <td> <input type="text" id="fileupload" name="fileupload" value='{{$assign->original_filename}}'></td>
				        <td><input type="text" id="panel" name="panel" value='{{$sme}}'>
                    <p class="help-block"></p></td>
				        <td><center><a href="{{ route('ietsrubric.edit', $users->id) }}" style="background-color: #4CAF50; border: none; color: white; padding: 8px; text-align: center; text-decoration: none; display: font-size: 16px; margin: 4px 2px; cursor: pointer;" >Rubric</a>
						</center></td>
