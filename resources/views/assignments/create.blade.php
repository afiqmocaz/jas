...
<div class="container">
   ...
   <h4 style="padding-left:2%"><li><b>General Question:</b></li></h4><br>
	...
	@if(!empty($question->general_assignment_id))
    @foreach($question as $questions)
	
	<p style="padding-left:2%;padding-right:5%">{{$questions->general->question}}
	</p><br/>
	@endforeach
	<h4 style="padding-left:2%"><li><b>Specific Question:</b></li></h4><br>
	@foreach($question as $questions)
	<p style="padding-left:2%;padding-right:5%">{{$questions->specific->question}}
	</p><br/>
   ...
   <center>   
      <a href="/eiaupload" class="btn btn-primary">Upload Assignments</a>
  </center>  
