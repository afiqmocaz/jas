...
<div class="container">
   ...
   <label style="padding-left:5%">Congratulations! You already finish quiz for Module 1</label><br><br>
   ...
   <center>
                ...
                <label style="padding-left:5%">You may proceed to Module 2</label><br/>
       

      <center>
   <div class="text">
        <label class="text-danger"><strong>* Please click next button to proceed to Module 2</strong></label>
      </div>
      <a href="/modules2" class="btn btn-primary">Next</a>
  </center>
