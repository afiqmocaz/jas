		...
		<div>
			...
			<div class="navbar templatemo-nav" id="navbar">
	      	...
	      	<div class="breadcrumb flat">
				    ...
				    <a href="{{ url('apcsquestion/show') }}">Question Generation</a>
				    <a class="active">Question Bank</a>        
				  </div>
				</div>
				    ...
				    <div class="panel panel-primary" style="border-color:#4CAF50;">
				      <div class="panel-heading" style="background-color:#4CAF50;" >
				        <h4 class="panel-title" style="color:white;">
				          <a data-toggle="collapse" href="#collapse1">Question Bank Instruction :</a>
				        </h4>
				      </div>
				...
				<br>    
				      ...
				      <tr>
				        ...
				        <td rowspan="4">Specific Question</td>
				        <td rowspan="4"><img src="images/nric.jpeg" width="200"></td>
				        <td rowspan="4">What is essential in an APCS?:</td>
				        <td>i</td>
				        ...
				        <td rowspan="4">Low</td>
				        <td rowspan="4" id="but"><center><form onclick="deleteRow(this)" align="center">
