...
<h1 style="margin: 0px;font-size: 24px;">Upload Material&nbsp;<a id="popoverData" class="btn btn-primary" href="#" data-content='&bull;  In this form, Secretariat IETS can upload .pdf file of Refference.<br>
        ...
        data-html="true" data-placement="right" data-original-title="Upload Material Instruction" data-trigger="hover"><i class="glyphicon glyphicon-info-sign"></i></a></h1>
    			...
    			{!! Form::model($ietsrefference, ['route' =>['ietsrefference.update', $ietsrefference->id], 'method' => 'PUT', 'files' => true]) !!}
					    ...
					    <!-- <center>
					     ...
					     <th>
					      <center>{!! Html::linkRoute('ietsrefference.show', 'Cancel', array($ietsrefference->id), array('class' => 'btn btn-danger btn-block', 'style' => 'width:150px')) !!}</center>
					      </th>
					      </tr>
					      </table></center> --><br>
					      ...
					      <div align="right">
					    	...
					    	{!! Html::linkRoute('ietsrefference.show', 'Cancel', array($ietsrefference->id), array('class' => 'btn btn-primary')) !!}
					    </div>
					  {!! Form::close() !!}
