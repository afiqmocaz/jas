		...
		<div>
			...
			<div class="navbar templatemo-nav" id="navbar">
	      	...
	      	<div class="breadcrumb flat">
				    ...
				    <a href="#">MANAGE</a>
				    <a class="active" style="color:white">Reference</a>        
				  </div>
				</div>
    			...
    			{!! Form::open(array('route' => 'ietsrefference.store', 'data-parsley-validate' => '', 'files' => true)) !!}
					    ...
					    <label for="usr"><br>Reference Upload (.pdf) : </label>
					      <br><center><input type="file"  name="fileToUpload" id="fileToUpload" required="" accept=".pdf " onchange="myFunction()" multiple></center>
					      <br><p id="demo"></p>
					      <script>
				...
				<table class="order-table table" id="list">
				    ...
				    @foreach($ietsrefference as $ietsrefferences)
				      <tr>
				        ...
				        <td><a class="file" href="/images/{{$ietsrefferences->fileToUpload}}">{{$ietsrefferences->fileToUpload}}</a></td>
				        <td>{{ date('d F Y', strtotime($ietsrefferences->created_at)) }}</td>
				       <td id="but"><center><button>Publish</button></center><br>
				       <center><a href="{{ route('ietsrefference.edit', $ietsrefferences->id) }}" >
				        	{{ HTML::image('images/edit.png', 'a Edit', array('class' => 'img-responsive cleaner', 'width' => '15', 'height' => '15')) }}</a> </center><br>

				        	{!! Form::open(['route' => ['ietsrefference.destroy', $ietsrefferences->id], 'method' => 'DELETE', 'onsubmit' => 'return ConfirmDelete()']) !!}
