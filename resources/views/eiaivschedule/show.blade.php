		...
		<div>
			...
			<div class="navbar templatemo-nav" id="navbar">
	      	...
	      	<div class="breadcrumb flat">
				...
				<button id="myBtn1" style="margin-left:20px;" class="btn btn-success" >Add Venue</button>
				...
				<input type="search" class="light-table-filter" data-table="order-table"  placeholder="Search..." class="form-control" style="width: 17%; float:right; margin-right:187px;"><br><br>
