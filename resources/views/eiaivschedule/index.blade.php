				...
				<table class="order-table table" id="list">
				    <thead>
				      ...
				      <tr>
				        ...
				        <td>{{$eiaivschedules->venue}}<br>{{$eiaivschedules->address}}<br>{{$eiaivschedules->state}}</td>
				        <td id="but">
				        	...
				        	{!! Form::open(['route' => ['eiaivschedule.destroy', $eiaivschedules->id], 'method' => 'DELETE', 'onsubmit' => 'return ConfirmDelete()']) !!}
