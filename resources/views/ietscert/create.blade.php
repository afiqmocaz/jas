	      	...
	      	<div class="breadcrumb flat">
				...
				<thead>
				      <tr>
				        ...
				        <th onclick="sortTable1(4)" style="width:8%;"><center>Certification Status</center></th>
				        <th onclick="sortTable1(5)" style="width:8%;"><center>Remark(Comment)</center></th>
				        
				        <th onclick="sortTable1(6)" style="width:8%;"><center>Certified By</center></th>
				        <th onclick="sortTable1(7)" style="width:8%;"><center>Generate Certificate</center></th>
				      </tr></thead>
				    <tbody>
				      	@foreach($user as $users)
				    	@foreach($ietscert as $ietscerts)
				      <tr>
				        <td></td>
				        <td>{{$users->name}}</td>
				        <td>{{$users->nric}}</td>
				        <td><center></center></td>
				        <td><center>{{$ietscerts->status}}</center></td>
				        <td><center>{{$ietscerts->remark}}</center></td>

				        <td><center>Aizat Hamdan Jailani</center></td>
				        <td><center><form action="{{ url('templatecert') }}" method="get">
				...
				<div id="myModal1" class="modal1">
				  ...
				  <div class="modal1-content">
				    <div class="modal1-header">
				      ...
				      <h2>ietsCertified Applicant List</h2>
				    </div>
				...
				<thead valign="top">
				    ...
				    @foreach($ietscert as $ietscerts)
				      <tr>
				        ...
				        <td>{{$users->nric}}</td>
				        <td><center></center></td>
				        <td><form action="{{ url('ietsendorse/create') }}" method="get">
					    	<input type="submit" value="View"/>
							</form></td>
				        <td>{{$ietscerts->endorse}}</td>
				        <td>
				        <?php
						$date = new DateTime("$ietscerts->expired");
				        ...
				        <td>{{$ietscerts->remark}}</td>
							<td>{{$ietscerts->status}}</td>
							<td><center><a href="{{ route('ietscert.edit', $ietscerts->id) }}" >
