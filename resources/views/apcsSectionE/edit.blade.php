...
margin: -5px; } 
  ...
  <div class="section" style="padding: 0px;">
   ...
   {!! Form::model($apcsSectionE, ['route' =>['apcsSectionE.update', $apcsSectionE->id], 'method' => 'PUT', 'files' => true,'id'=>'applicantFormD']) !!}
          ...
          <div class="col-md-5">
            ...
            <div class="input-group" >
              ...
              <input type="date" class="form-control input-sm" id="datepicker" name="starttrainning" onchange="cal();calculate();dateValidate(this)" style="font-size: 15px;width: 100%" value="{{$apcsSectionE->starttrainning}}"  />
            </div>
          </div>
          ...
          <div class="col-lg-6">
            <div class="input-group">
             ...
             <input type="date" class="form-control input-sm" id="datepicker2" name="endtraining" onchange="cal();calculate()" style="font-size: 15px;width: 100%" value="{{$apcsSectionE->endtraining}}" />
            ...
            <div class="col-md-11" style=" margin-top: 10px; margin-bottom: 10px;" align="right">
              <a class="btn btn-primary" href="/apcsSectionE/{{$apcsSectionE->id}}" role="button">Back</a>
