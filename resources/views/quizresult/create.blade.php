		...
		<div>
			...
			<div class="navbar templatemo-nav" id="navbar">
	      	...
	      	<div class="breadcrumb flat">
				    ...
				    <a class="active">Quizes Result</a>        
				  </div>
				</div>
				    ...
				    <div class="panel panel-primary" style="border-color:#4CAF50;">
				      <div class="panel-heading" style="background-color:#4CAF50;" >
				        <h4 class="panel-title" style="color:white;">
				          <a data-toggle="collapse" href="#collapse1">Summary of Applicant Quiz Result Instruction :</a>
				        </h4>
				      </div>
				      <div id="collapse1" class="panel-collapse collapse">
				        <div class="panel-body">
				        •  This page show the summary of the quiz result of the applicant.<br>
					    •  Secretariat EIA can choose the ready or not ready to proceed the comprehensive exam.<br>
				...
				<input type="search" class="light-table-filter" data-table="order-table"  placeholder="Search..." style="width: 222px; margin-left: 683px"><br><br>
