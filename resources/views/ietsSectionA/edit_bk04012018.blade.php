...
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css">
  ...
  if(f.sameas.checked == true) {
    if(f.state.value==''){f.mailaddress.value = f.address.value + ", " + f.city.value  + ", " + f.country_id.value;
...
<!-- <td colspan="4">
    ...
    {{ Form::select('title', ['Mr' => 'Mr', 'Mrs' => 'Mrs', 'Miss' => 'Ms', 'Dr' => 'Dr', 'Prof' => 'Prof' ], $ietsSectionA->title, array('class' => 'form-control', 'style' => 'width: 20%', 'required' => ''))}}
      ...
      <tr>
        ...
        <td>
          <input type="value" pattern="\d+" id="postcode" name="postcode" class="form-control" style="width: 25%" placeholder="Eg: 42500" required title="Enter digit only. Min : 3, Max : 10" minlength="3" maxlength="10" oninput="this.value=this.value.replace(/[^0-9]/g,'');" value="{{$ietsSectionA->postcode}}"> 
      ...
      <tr>
       ...
       <tr>
        ...
        <td>
          <input type="value" pattern="\d+" id="mailpostcode" name="mailpostcode" class="form-control" style="width: 25%" placeholder="Eg: 42500" required title="Enter digit only. Min : 3, Max : 10" minlength="3" maxlength="10" oninput="this.value=this.value.replace(/[^0-9]/g,'');" value="{{$ietsSectionA->mailpostcode}}"> 
...
<div class="input-group date" id="datepickerDemo17">
        ...
        <input type="text" class="form-control inputan kusus" id="dateofissue" data-format="dd-MM-yyyy" name="dateofissue"  value="{{$ietsSectionA->dateofissue}}" style="width: 55%" />  
        </div>
