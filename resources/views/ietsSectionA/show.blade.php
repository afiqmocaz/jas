 ...
 <!-- <h4 class="text-center">SECTION A: PERSONAL INFORMATION</h4>
  ...
  enctype="multipart/form-data">
	...
	<div class="form-group">    
               ...
               @foreach($ietsSectionA as $ietsSectionAs)
                      
                  <text><b>Title</b></text>
                  
                    <input name="city" id="city" type="text" maxlength="100" class="form-control input-sm" placeholder="Enter your name" value="{{ $ietsSectionAs->title }}" style="font-size: 15px" readonly="">  
         ...
         <input name="nric" id="nric" type="text" maxlength="100" class="form-control input-sm" placeholder="" value="{{ $ietsSectionAs->bumiputerastatus }}"  style="font-size: 15px" readonly="">  
        @endforeach  
        ...
        @foreach($ietsSectionA as $ietsSectionAs)
         ...
         <textarea  name="nric" id="nric" type="textarea" maxlength="100" class="form-control input-sm" placeholder="" value=""  style="font-size: 15px" readonly="">{{ $ietsSectionAs->address }}</textarea>  
        @endforeach  
          ...
          <input name="city" id="city" type="text" maxlength="100" class="form-control input-sm" placeholder="Enter your name" value="{{ $ietsSectionAs->city }}" style="font-size: 15px" readonly="">  
        @endforeach      
              </div>
          ...
          <input name="city" id="city" type="text" maxlength="100" class="form-control input-sm" placeholder="Enter your name" value="{{ $ietsSectionAs->postcode }}" style="font-size: 15px" readonly="">  
        @endforeach     
              </div>
          ...
          <input name="city" id="city" type="text" maxlength="100" class="form-control input-sm" placeholder="Enter your name" value="{{ $ietsSectionAs->country_id }}" style="font-size: 15px" readonly="">  
        @endforeach  
               ...
               @foreach($ietsSectionA as $ietsSectionAs)
                      @if ($ietsSectionAs->state != '')  
                <text><b>State</b></text>
                     
                    <input name="city" id="city" type="text" maxlength="100" class="form-control input-sm" placeholder="Enter your name" value="{{ $ietsSectionAs->state }}" style="font-size: 15px" readonly="">  
                     @endif
                      @endforeach 
              </div>
            ...
            <div class="form-group">    
               ...
               @foreach($ietsSectionA as $ietsSectionAs)
                      @if ($ietsSectionAs->regNo != '')
                  <text><b>Registered No</b></text>
                  
                    <input name="city" id="city" type="text" maxlength="100" class="form-control input-sm" placeholder="Enter your name" value="{{ $ietsSectionAs->regNo }}" style="font-size: 15px" readonly="">  
                     @endif
                      @endforeach 
		...
		<div class="form-group">
              ...
              @foreach($ietsSectionA as $ietsSectionAs)
      <img class="file" src="/image/{{$ietsSectionAs->image}}" href="/image/{{$ietsSectionAs->image}}" width="100px" height="150px"></img></td>
      @endforeach
   ...
   <div class="form-group">    
          ...
          <input name="city" id="city" type="text" maxlength="100" class="form-control input-sm" placeholder="Enter your name" value="{{ $ietsSectionAs->email }}" style="font-size: 15px" readonly="">  
        @endforeach  
          ...
          <input name="city" id="city" type="text" maxlength="100" class="form-control input-sm" placeholder="Enter your name" value="{{ $ietsSectionAs->phoneno }}" style="font-size: 15px" readonly="">  
        @endforeach  
                 ...
                 <div class="form-group">   
                  @foreach($ietsSectionA as $ietsSectionAs) 
                  @if ($ietsSectionAs->faxno != '')
                <text><b>Fax Number</b></text>
                 
        
          <input name="city" id="city" type="text" maxlength="100" class="form-control input-sm" placeholder="Enter your name" value="{{ $ietsSectionAs->faxno }}" style="font-size: 15px" readonly="">  
      @endif
        @endforeach  
          ...
          <textarea  name="nric" id="nric" type="textarea" maxlength="100" class="form-control input-sm" placeholder="" value=""  style="font-size: 15px" readonly="">{{ $ietsSectionAs->mailaddress }}</textarea>  
        @endforeach  
          ...
          <input name="city" id="city" type="text" maxlength="100" class="form-control input-sm" placeholder="Enter your name" value="{{ $ietsSectionAs->mailpostcode }}" style="font-size: 15px" readonly="">  
        @endforeach     
              </div>
              ...
              <div class="form-group">   
              @foreach($ietsSectionA as $ietsSectionAs)
                    @if ($ietsSectionAs->placeofissue != '') 
                <text><b>Place of Issue</b></text>
                  
          <input name="city" id="city" type="text" maxlength="100" class="form-control input-sm" placeholder="Enter your name" value="{{ $ietsSectionAs->placeofissue }}" style="font-size: 15px" readonly="">  
            ...
            @endif
              ...
              <div class="form-group">   
              @foreach($ietsSectionA as $ietsSectionAs)
                    @if ($ietsSectionAs->dateofissue != '') 
                <text><b>Place of Issue</b></text>
                  
          <input name="city" id="city" type="text" maxlength="100" class="form-control input-sm" placeholder="Enter your name" value=" {{ date('d/m/Y', strtotime($ietsSectionAs->dateofissue))}}" style="font-size: 15px" readonly="">  
  ...
  <div class="row">
            <div class="col-md-11" style=" margin-top: 10px; margin-bottom: 10px;">
              ...
              <a href="/ietsSectionB/create" >
            {{ Form::button('Next', array('class'=>'btn btn-primary pull-right', 'type'=>'submit')) }}</a>

              <a href="{{ route('ietsSectionA.edit', $ietsSectionAs->id) }}" >
            {{ Form::button('Edit', array('class'=>'btn btn-primary ', 'type'=>'submit','style'=>'margin-left: 88%')) }}</a>
            </div>
          </div>
    </div>
  </div>
