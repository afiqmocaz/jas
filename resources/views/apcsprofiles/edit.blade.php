...
<div class="container">
  ...
  <tbody>
    ...
    {!! Form::model($sectionA, ['route' =>['apcsprofiles.update', $sectionA->id], 'method' => 'PUT']) !!}
      <tr>
      <td style="width: 35%; background-color: #d9d9d9">
...
<center>
               ...
               <tr>
                <td width="50%">
               <center>{{ Form::submit('Update', ['class' => 'btn btn-primary']) }}&nbsp;<a href="{{route('apcsprofiles.create')}}" class="btn btn-primary"">Cancel</a></center></td>
               <!-- <th width="50%">
               <center>{{ Form::submit('Update', ['class' => 'btn btn-primary btn-block', 'style' => 'width:100px;']) }}</center></th>

               <th>
                <center><a href="{{route('ietsprofiles.index')}}" class="btn btn-danger" style="width:100px;">Cancel</a></center>
                </th> -->
                </tr>
                </table></center>
