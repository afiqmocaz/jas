			          ...
			          <li class="dropdown"><a class="dropbtn">MANAGE</a>
					    <div class="dropdown-content">
					      ...
					      <ul class="parent" ><a href="#">Comprehensive Examination <span class="caret"></span></a>
							...
							<a href="{{ url('quizModul/view/exam') }}">Generating Question</a></ul></ul>
				...
				<table class="order-table table" id="myTable">
				    ...
				    @foreach($eiaannounce as $eiaannounces)
				      <tr>
				        ...
				        <td><a class="file" href="/images/{{$eiaannounces->fileToUpload}}">{{$eiaannounces->fileToUpload}}</a></td>
				        <td id="but">
				        	<center><a href="{{ route('eiaannounce.edit', $eiaannounces->id) }}" >
