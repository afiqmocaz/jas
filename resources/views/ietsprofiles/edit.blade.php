...
<div class="container">
  ...
  <tbody>
    ...
    {!! Form::model($sectionA, ['route' =>['ietsprofiles.update', $sectionA->id], 'method' => 'PUT']) !!}
      <tr>
      <td style="width: 35%; background-color: #d9d9d9">
...
<center>
               ...
               <tr>
               <td width="50%">
               <center>{{ Form::submit('Update', ['class' => 'btn btn-primary']) }}&nbsp;<a href="{{route('ietsprofiles.create')}}" class="btn btn-primary"">Cancel</a></center></td>
                </tr>
                </table></center>
