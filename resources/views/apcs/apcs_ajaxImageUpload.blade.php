...
<div class="container">
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
			...
			<h2 style="margin-left:30px">PCER Upload</h2>
    ...
    <div class="panel panel-primary"style="width:90%;margin-left:30px">
	 ...
	 <form style="width:90%;margin-left:30px" action="{{ route('ajaxImageUpload') }}" enctype="multipart/form-data" method="POST">
	...
	<div class="form-group">
      <label style="margin-left:10px">File upload:</label></br>
	  <small>Files must be uploaded in PDF format only and the maximum file size is 10MB</small>
      <input type="file" name="image" class="form-control">
    </div>
	<div class="form-group">
      <label style="margin-left:10px">Save as:</label>
      <input type="text" name="title" class="form-control" placeholder="Add Title">
    </div>

    <div class="form-group">
      <button style="margin-left:30px" class="btn btn-success upload-image" type="submit">Upload Image</button>
    </div>

  </form>
	<center> <a href="/examschedules/iets" class="btn btn-primary">Next</a></center>
        </div>
