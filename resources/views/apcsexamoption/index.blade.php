		...
		<div>
			...
			<div class="navbar templatemo-nav" id="navbar">
	      	...
	      	<div class="breadcrumb flat">
    			...
    			<button id="myBtn" style="margin-left:60px;" class="btn btn-success" >Add New Quiz</button><br><br>
				  ...
				  <div class="modal1-content">
				    <div class="modal1-header">
				     ...
				     <div class="modal1-body">
				      {!! Form::open(array('url'=>'apcsexamoption/uploadFiles', 'route'=> ['apcsexamoption.store'], 'data-parsley-validate' => '', 'method'=>'POST', 'enctype' => 'multipart/form-data', 'files'=>true)) !!}
				...
				<!-- end of modal -->
				  ...
				  <table class="order-table table" id="list" style="width:90%;" align="center">
				     ...
				     @foreach($questions_option as $question_option)
				      <tbody>
					
					 <th style="width:3%;">1.</th>
					 
                    <td>{{ $question_option->question->question or '' }}</td>
                    <td>{{ $question_option->option }}</td>
                    <td>{{ $question_option->correct == 1 ? 'Yes' : 'No' }}</td>
                    
				        <td><center><a href="{{ route('apcsexamoption.edit', $question_option->id) }}" >
				        	{{ HTML::image('images/edit.png', 'a Edit', array( 'width' => '20', 'title' => 'Edit')) }}</a> </center><br></td>

				        	<td>{!! Form::open(['route' => ['apcsexamoption.destroy', $question_option->id], 'method' => 'DELETE', 'onsubmit' => 'return ConfirmDelete()']) !!}
