@extends($master)
@section('header', 'IETS: Syllabus')
@section('content')

<h1 style="margin: 0px;font-size: 24px;">Upload Material&nbsp;<a id="popoverData" class="btn btn-primary" href="#" data-content='&bull;  In this form, Secretariat IETS can upload .pdf file of Syllibus.<br>
        ...
        data-html="true" data-placement="right" data-original-title="Upload Material Instruction" data-trigger="hover"><i class="glyphicon glyphicon-info-sign"></i></a></h1>
				...
				<table class="table table-bordered" id="list" align="center">
				    ...
				    @foreach($ietssyllabus as $syllabus)
				      <tr>
				        <td>{{$count++}}</td>
				        ...
				        <td>{{ date('d F Y', strtotime($syllabus->created_at)) }}</td>
				        	...
				        	<td><center><a href="{{ route('ietssyllabus.edit', $syllabus->id) }}" >
                                                 {!! Form::image('images/edit.png', 'a Delete', ['type' => 'submit',  'class' => 'btnimg', 'title' => 'Edit'] ) !!}
				        	<td>{!! Form::open(['route' => ['ietssyllabus.destroy', $syllabus->id], 'method' => 'DELETE', 'onsubmit' => 'return ConfirmDelete()']) !!}
    			...
    			<div class="modal-dialog">
				  ...
				  <div class="modal-content">
				    ...
				    <div class="modal-body">
				      {!! Form::open(array('url'=>'ietssyllabus/uploadFiles', 'data-parsley-validate' => '', 'method'=>'POST', 'files'=>true)) !!}
