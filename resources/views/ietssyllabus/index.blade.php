		...
		<div>
			...
			<div class="navbar templatemo-nav" id="navbar">
	      	...
	      	<div class="breadcrumb flat">
    			...
    			<div style="width: 100%;" class="panel-group" >
				    <div class="panel panel-primary" style="border-color:#4CAF50;">
				      ...
				      <div id="collapse1" class="panel-collapse collapse">
				        ...
				        •  In this form, Secretariat IETS can upload .pdf file of Syllibus.<br>
    			...
    			{!! Form::open(array('route' => 'ietssyllabus.store', 'data-parsley-validate' => '', 'files' => true)) !!}
					    
							<div class="form-group">
							<label for="usr"><br>Title : </label>
					      	<input type="text" class="form-control" name="title" id="title" required="" maxlength="255">
					    <br><br><label><br>Upload File(If Needed) : </label>
					      <br><center><input type="file"  name="fileToUpload" id="fileToUpload" accept=".pdf" onchange="myFunction()" multiple></center>
					      <br><p id="demo"></p>
					      <script>
				...
				<table class="order-table table" id="list">
				    <thead>
				      <tr>
				        ...
				        <th onclick="sortTable(4)"><center>Action</center></th>
				      </tr></thead>
				    <tbody>
				    @foreach($ietssyllabus as $ietssyllabi)
				      <tr>
				        <td></td>
				        <td>{{$ietssyllabi->title}}</td>
				        <td><a class="file" href="/images/{{$ietssyllabi->fileToUpload}}">{{$ietssyllabi->fileToUpload}}</a></td>
				        <td>{{ date('d F Y', strtotime($ietssyllabi->created_at)) }}</td>
				       <td id="but"><center><button>Publish</button></center><br>
				        	<center><a href="{{ route('ietssyllabi.edit', $ietssyllabi->id) }}" >
				        	{{ HTML::image('images/edit.png', 'a Edit', array('class' => 'img-responsive cleaner', 'width' => '15', 'height' => '15')) }}</a> </center><br>

				        	{!! Form::open(['route' => ['ietssyllabi.destroy', $ietssyllabi->id], 'method' => 'DELETE', 'onsubmit' => 'return ConfirmDelete()']) !!}
