...
<h1 style="margin: 0px;font-size: 24px;">Upload Material&nbsp;<a id="popoverData" class="btn btn-primary" href="#" data-content='&bull;  In this form, Secretariat IETS can upload .pdf file of Syllibus.<br>
        ...
        <br>
    			...
    			{!! Form::model($ietssyllabus, ['route' =>['ietssyllabus.update', $ietssyllabus->id], 'method' => 'PUT', 'files' => true]) !!}
					    ...
					    <!-- <center>
					     ...
					     <th>
					      <center>{!! Html::linkRoute('ietssyllabus.show', 'Cancel', array($ietssyllabus->id), array('class' => 'btn btn-danger btn-block', 'style' => 'width:150px')) !!}</center>
					      </th>
					      </tr>
					      </table></center> --><br>
					    ...
					    <div align="right">
					    	...
					    	{!! Html::linkRoute('ietssyllabus.show', 'Cancel', array($ietssyllabus->id), array('class' => 'btn btn-primary')) !!}
					    </div>
					  {!! Form::close() !!}
