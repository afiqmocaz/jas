		...
		<div>
			...
			<div class="navbar templatemo-nav" id="navbar">
	      	...
	      	<div class="breadcrumb flat">
				    ...
				    <a href="#">REPORT</a>
				    <a class="active" style="color:white">Continuous Professional Development (CPD)</a>        
				  </div>
				</div>
    			...
    			<div style="width: 100%;" class="panel-group" >
				    <div class="panel panel-primary" style="border-color:#4CAF50;">
				      ...
				      <div id="collapse1" class="panel-collapse collapse">
				        ...
				        •  In this Form, Secretariat EIA can view the CPD points of the applicant.<br>
						•  Secretariat can click the name of applicant to view the QP profile of the applicant.<br>
						•  Secretariat EIA can click "Save" button to save the changes that has been made.
				        </div>
				      </div>
				    </div>
				  </div>
				...
				<table class="order-table table" id="list">
				    <thead valign="top">
				      <tr>
				        ...
				        <th onclick="sortTable(4)">Qualified Person (QP) ID</th>
				    ...
				    <tbody>
				      <tr>
				        ...
				        <td></td>
				        <td><a href="{{ url('qp/create') }}">Muhd Izzat</a></td>
				        <td>941203069897</td>
				        <td>EIA001</td>
				        <td>QPEIA01</td>
				        <td>150</td>
				      ...
				      <tr>
				        ...
				        <td></td>
				        <td><a href="{{ url('qp/create') }}">Nasih Ulwan</a></td>
				        <td>931203069897</td>
				        <td>EIA002</td>
				        <td>QPEIA02</td>
				        <td>150</td>
