 ...
 <table style="width: 70%">
  ...
  <table style="width: 100%">
    ...
    <tr>
      ...
      <br>
      <div>
        <input class="button" a href="{{ url('/logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" style="display: block; margin: 0 auto; width: 95px" value="Signout">
