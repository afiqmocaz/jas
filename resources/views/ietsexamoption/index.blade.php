				  ...
				  <div class="modal1-content">
				    <div class="modal1-header">
				     ...
				     <div class="modal1-body">
				      {!! Form::open(array('url'=>'ietsexamoption/uploadFiles', 'route'=> ['ietsexamoption.store'], 'data-parsley-validate' => '', 'method'=>'POST', 'enctype' => 'multipart/form-data', 'files'=>true)) !!}
				...
				<!-- end of modal -->
				  ...
				  <table class="order-table table" id="list" style="width:90%;" align="center">
                    ...
                    <td>{{ $question_option->correct == 1 ? 'Yes' : 'No' }}</td>
				        ...
				        <td><center><a href="{{ route('ietsexamoption.edit', $question_option->id) }}" >
