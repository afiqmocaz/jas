...
<html>
 ...
 <div class="navbar-header">                 
                      ...
                      <li class="dropdown"><a class="dropbtn">MANAGE</a>
                        <div class="dropdown-content">
                          ...
                          <ul class="parent" ><a href="#">Comprehensive Examination <span class="caret"></span></a>
                            ...
                            <a href="{{ url('ietsquizModul/quiz/exam') }}">Generating Question</a></ul></ul>
            ...
            <!-- Modal -->
             {!! Form::open(array('url'=>'ietsquestion/uploadFiles', 'route'=> [''], 'data-parsley-validate' => '', 'method'=>'POST', 'enctype' => 'multipart/form-data', 'files'=>true)) !!}
