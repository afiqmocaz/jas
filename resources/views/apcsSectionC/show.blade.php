 ...
 <!-- <h4 class="text-center">SECTION A: PERSONAL INFORMATION</h4>
      ...
      <tr  style="border-bottom: 1px solid #ddd;background-color:">
       <td>{{ $no++ }}</td>
        ...
        <a href="{{ route('apcsSectionC.edit', $apcsSectionCs->id) }}" >
          ...
          <center>{!! Form::image('/image/delete.png', 'a Delete', ['type' => 'submit', 'class' => 'btnimg', 'title' => 'Delete'] ) !!}</center>
          {!! Form::close() !!}
        </center></td>
  ...
  <div class="row">
            <div class="col-md-11" style=" margin-top: 10px; margin-bottom: 10px;" align="right">
              ...
              <a  data-toggle="modal" data-target="#apcsSecC" >
            {{ Form::button('Add New', array('class'=>'btn btn-primary ', 'type'=>'submit')) }}</a>
              <a href="/apcsSectionD/create" >
	...
	<br><br>  
      ...
      <div class="row">
            <div class="col-md-11" style=" margin-top: 10px; margin-bottom: 10px;">
              <button id="btnSubmit" type="submit" class="btn btn-primary pull-right" style="cursor:default">Next</button>
            </div>
          </div>
      </form>
     </div>
