...
<div class="section" style="padding: 0px;">
  ...
  <div class="row" >
   ...
   {!! Form::model($apcsSectionC, ['route' =>['apcsSectionC.update', $apcsSectionC->id], 'method' => 'PUT', 'files' => true,'id'=>'myform']) !!}
           ...
           <br>
             ...
             <div class="form-group{{ $errors->has('address') ? ' has-error' : '' }}" >
                  <text><b>File Uploaded</b></text><br>
                   <a class="file" href="/uploads/{{$apcsSectionC->cert}}" style="cursor: default;" target="_blank">{{$apcsSectionC->cert}}</a>
            </div>
      ...
      <div class="row">
            <div class="col-md-11" style=" margin-top: 10px; margin-bottom: 10px;" align="right">
              <a class="btn btn-primary" href="/apcsSectionC/{{$apcsSectionC->id}}" role="button">Back</a> 
