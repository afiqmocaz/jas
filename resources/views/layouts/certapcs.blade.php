...
<head>
    ...
    <title>{{ config('app.name', 'APCS Certified Person') }}</title>
      ...
      <img src="{{URL::asset('/image/banner1.png')}}" alt="profile Pic" height="100" width="2048", class="img-responsive cleaner">
                ...
                <div class="collapse navbar-collapse" id="app-navbar-collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="{{ Request::is('') ? "active" : "" }}"><a href=""><strong>PERSONAL PROFILE</strong></a></li>

                        <li class="{{ Request::is('') ? "active" : "" }}"><a href=""><strong>CONTINUOUS PROFESSIONAL DEVELOPMENT</strong></a></li>

                        <li class="{{ Request::is('eiacertrenew.index') ? "active" : "" }}"><a href="{{ route('eiacertrenew.index') }}"><strong>CERTIFICATE RENEWAL</strong></a></li>
