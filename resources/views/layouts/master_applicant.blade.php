 ...
 <center> <label id="demo" style=""></label></center>
                            <script>
                                ...
                                var x2 = setInterval(function () {
                                    ...
                                    var table = "<table class='table table-bordered' style='width:80%'><tr><td class='alert-warning'><b>Time Remaining &nbsp &nbsp &nbsp &nbsp &nbsp</b></td><td width='20%'>"+days2+" days</td><td width='20%'>"+hours2+" hour</td><td width='20%'>"+minutes2+" minutes</td><td width='20%'>"+seconds2+" second</td></tr></table>";
