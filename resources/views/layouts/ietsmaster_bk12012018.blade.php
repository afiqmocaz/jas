...
<script src="{{ asset('assets/datatables-plugins/dataTables.bootstrap.min.js')}}"></script>
       ...
       <script>
          ...
          function openGlobalProfile($id){
              $("#globalIFProfile").attr("src", "/ietsapp/"+$id+"/edit");
            ...
            <div class="navbar templatemo-nav" id="navbar">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav nav-justified" id="menu">
                        <li class="dropdown"><a class="dropbtn" href="{{ url('ietsindex/create') }}">HOME</a></li>
                        <li class="dropdown"><a class="dropbtn" href="{{ url('ietsannounce/show') }}">ANNOUNCEMENT</a></li>
                            ...
                            <div class="dropdown-content">
                                ...
                                <ul class="parent1" ><a href="#">Assignment&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<span class="caret"></span></a>
                                    <ul class="child1" >
                                        ...
                                        <a href="{{ url('secretariat_assigment/iets') }}">Applicant Assignment</a></ul></ul>
