...
margin: -5px; } 
  ...
  <div class="section" style="padding: 0px;">
    ...
    {!! Form::open(['route' => 'ietsSectionC.store', 'data-parsley-validate'=> '', 'files'=> true,'id'=>'applicantFormD']) !!}
          ...
          <div class="col-lg-6">
            ...
            <div class="input-group" >
             ...
             <input type="textbox" class="textbox" id="numdays2" name="numdays" readonly="readonly" style="width:17%">
            </div>
          </div>
          <div class="col-lg-6">
            <div class="input-group">
          ...
          <input type="textbox" class="textbox" id="numMonths2" name="numMonths" readonly="readonly" style="width: 17%">            </div>
          </div>   
...
$("#datepicker2").change(function () {
    ...
    if ((Date.parse(endDate) <= Date.parse(startDate))) {
       ...
       $('[name="projectComplete"]').val('');
          $('#applicantFormD').bootstrapValidator('revalidateField', 'projectComplete', false);
    }
});
