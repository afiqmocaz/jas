    ...
    {!! Form::open(['route' => 'eiaSectionD.store', 'data-parsley-validate'=> '', 'files'=> true,'id'=>'applicantFormD']) !!}
          ...
          <div class="col-md-5">
            ...
            <div class="input-group" >
              ...
              <input type="date" data-date="" data-date-format="DD/MM/YYYY" value="<?=date('Y-m-d', strtotime('-2 days'))?>" id="datepicker" required="" name="dateStart" onchange="cal();calculate()" />
            </div>
          </div>
          <div class="col-lg-5">
            <div class="input-group">
              <text><b>Date End</b></text><br>
             <input type="date" data-date="" data-date-format="DD/MM/YYYY" value="<?=date('Y-m-d')?>" id="datepicker2" required="" name="dateEnd" onchange="cal();calculate()" />
            ...
            <br><br><br><br>
              ...
              <div class="form-group">    
             <text id="numdays">Number of days:</text><input type="textbox" class="textbox" id="numdays2" name="numdays" readonly="readonly" style="width:10%;background-color:#d1e0e0 ">           &nbsp&nbsp&nbsp&nbsp
		 ...
		 <p class="text-info" style="font-size: 12px;color: #0073e6">Attachment Specification : pdf Only less than 10MB and file name not more than 10 characters</p>          
            ...
            <div class="col-md-11" style=" margin-top: 10px; margin-bottom: 10px;" align="right">
              ...
              <a href="/eiaSectionE/create" class="btn btn-primary" role="button">Skip</a>
