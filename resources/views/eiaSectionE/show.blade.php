    ...
    <div class="row" >
          ...
          <div class="col-md-5">
            ...
            <div class="form-group">    
                <text><b>First Specialized</b></text>
                 @foreach($eiaSectionE as $eiaSectionEs)
        
          <input name="city" id="city" type="text" maxlength="100" class="form-control input-sm" placeholder="Enter your name" value="{{ $eiaSectionEs->first_specialize }}" style="font-size: 15px" readonly="">  
        @endforeach  
            ...
            <div class="form-group">    
                <text><b>Second Specialized</b></text>
                 @foreach($eiaSectionE as $eiaSectionEs)
        
          <input name="city" id="city" type="text" maxlength="100" class="form-control input-sm" placeholder="Enter your name" value="{{ $eiaSectionEs->second_specialize }}" style="font-size: 15px" readonly="">  
        @endforeach  
            ...
            <div class="col-md-11" style=" margin-top: 10px; margin-bottom: 10px;" align="right">
              ...
              <a href="{{ route('eiaSectionE.edit', $eiaSectionEs->id) }}" class="btn btn-primary" role="button">Edit</a>
              <a href="/eiaSectionF/create" class="btn btn-primary" role="button">Next</a>
            </div>
          </div>
          </div>
