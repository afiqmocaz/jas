...
<html>
 ...
 <!-- <h4 class="text-center">SECTION E: SPECIALIZED AREA</h4>
  ...
  <div class="section" style="padding: 0px;">
...
], $eiaSectionE->first_specialize, array('id' => 'select1', 'class' => 'form-control input-sm','style'=>'font-size:15px'))}}
    ...
    'Waste Management - Environmental Planning' => 'Environmental Planning',
    'Waste Management - Risk Assessment' => 'Risk Assessment'],    
], $eiaSectionE->second_specialize, array('id' => 'select2', 'class' => 'form-control input-sm','style'=>'font-size:15px'))}}   
              </div>
            ...
            <div class="col-md-11" style=" margin-top: 10px; margin-bottom: 10px;" align="right">
              <a class="btn btn-primary" href="/eiaSectionE/{{$eiaSectionE->id}}" role="button">Back</a>
