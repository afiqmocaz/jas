...
<html>
  ...
  <div class="section" style="padding: 0px;">
    <div class="container">
    {!! Form::model($eiaguideline, ['route' =>['eiaguideline.update', $eiaguideline->id], 'method' => 'PUT', 'files' => true,'class'=>'formmodel']) !!}   
          ...
          <hr/>
            ...
            <div class="form-group" style="margin-left: 3%">    
                <label class="">Subject</label>
                  <input name="subject" id="subject" type="text" maxlength="100" class="form-control input-sm" placeholder="Enter your subject" value="{{$eiaguideline->subject}}" style="width:97%" >  
                              
              </div>

              <div class="form-group" style="margin-left: 3%">
						    <label class="">File Uploaded</label><br />
						  <a style="color:blue" class="file" src="/guideline/{{$eiaguideline->original_filename}}" href="/guideline/{{$eiaguideline->original_filename}}" target="_blank">{{$eiaguideline->original_filename}}</a>
            ...
            <div class="col-md-12" style=" margin-top: 10px; margin-bottom: 10px;" align="right">
              <a href="/eiaguideline/show" class="btn btn-primary" role="button">Back To EIA Guidelines</a>
