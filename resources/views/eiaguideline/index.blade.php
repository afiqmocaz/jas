				 ...
				 <div style="width: 100%;" class="panel-group" >
				    <div class="panel panel-primary" style="border-color:#4CAF50;">
				      ...
				      <div id="collapse1" class="panel-collapse collapse">
				        ...
				        •  Secretariat EIA can enter Guidelines by clicking the "Add Guidelines" button.<br>
					    •  The Guidelines can be view, edit or delete in the table below.<br>
						•  The Guidelines entered by Secretariat EIA will be shown in the Guidelines box at the Home Page.
				        </div>
				      </div>
				    </div>
				  </div>
