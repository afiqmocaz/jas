		...
		<div>
			...
			<div class="navbar templatemo-nav" id="navbar">
	      	...
	      	<div class="breadcrumb flat">
				...
				{!! Form::model($array, ['route' =>['ietspayinfo.update', $user->id], 'method' => 'PUT', 'files' => true]) !!}
				...
				<table class="table">
				    ...
				    <tbody>
				      <tr>
				        ...
				        <div>
					        @if(! empty($ietspayinfo->slip))
					        <td><center><div class="attachment-replace" style="display:none;">

					        {{ Form::file('slip', null, array('class' => 'form-control' )) }}

					        </div>
					        <a class="current-attachment" src="/uploads/{{$ietspayinfo->slip}}" href="/uploads/{{$ietspayinfo->slip}}" width="100px" height="150px">{{$ietspayinfo->slip}}</a></center></td>
					        @endif
					    </div>
				        <td><center>{{ Form::submit('Approve', ['name' => 'approve','id' => 'approve', 'class' => 'btn btn-primary btn-block', 'style' => 'width:150px;']) }}<br>
				        {{ Form::submit('Decline', ['name' => 'decline','id' => 'decline','class' => 'btn btn-primary btn-block', 'style' => 'width:150px;']) }}
				        </center></td>
				      </tr>
				    </tbody>
				  </table>  
