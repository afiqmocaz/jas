		...
		<div>
			...
			<div class="navbar templatemo-nav" id="navbar">
	      	...
	      	<div class="breadcrumb flat">
				    ...
				    <a href="#">APPLICANT</a>
				    <a href="{{ url('paymentview/iets') }}">Applicant Payment</a>
				    <a class="active">Payment Information</a>        
				  </div>
				</div>
				...
				<table class="table">
				    <thead valign="top">
				      <tr>
				        ...
				        <th><center>Payment Transaction Date</center></th>
				        <th><center>Receipt No.</center></th>
				        <th><center>Payment Receipt</center></th>
				    ...
				    @foreach($ietspayinfo as $ietspayinfos)
				      <tr>
				        <td>{{$users->name}}</td>
				        <td>{{$users->nric}}</td>
				        <td><center>{{$ietspayinfos->amount}}</center></td>
				        <td><center>{{date('d/m/Y', strtotime($ietspayinfos->date))}}</center></td>
				        <td><center>{{$ietspayinfos->referenceNo}}</center></td>
				        <td><center><a style="color: blue;" href="/backend/uploads/{{$ietspayinfos->slip}}">{{$ietspayinfos->slip}}</a></center></td>
				        <td><center><form action="{{ url('ietspayment/show') }}" method="get">
				        <!-- <button type="submit" style="width:80px;" name="pay2" value="Approved"/>Approve</button><br><br> -->
				        <a href="{{route('approve')}}" class="btn btn-block btn-primary" style="width:80px;" name="pay2" value="Approved">Approve</a><br>
				        <a href="" class="btn btn-block btn-primary" style="width:80px;" name="pay2" value="Declined">Decline</a>
					    <!-- <button type="submit" style="width:80px;" name="pay2" value="Declined"/>Decline</button> -->
					</form></td>
				      </tr>
				      @endforeach
				    @endforeach
