			...
			<div class="navbar templatemo-nav" id="navbar">
	      	...
	      	<div class="breadcrumb flat">
    			...
    			{!! Form::open(array('route' => 'syllabus.store', 'data-parsley-validate' => '', 'files' => true)) !!}
					    ...
					    <label for="usr"><br>Syllabus Upload (.pdf) : </label>
					      <br><center><input type="file"  name="fileToUpload" id="fileToUpload" accept=".pdf " onchange="myFunction()" required="" multiple></center>
					      <br><p id="demo"></p>
					      <script>
				...
				<table class="order-table table" id="list">
				    ...
				    @foreach($syllabi as $syllabus)
				      <tr>
				        ...
				        <td><a class="file" href="/images/{{$syllabus->fileToUpload}}">{{$syllabus->fileToUpload}}</a></td>
				        <td>{{ date('d F Y', strtotime($syllabus->created_at)) }}</td>
				       <td id="but"><center><button>Publish</button></center><br><form onclick="deleteRow(this)" align="center">
