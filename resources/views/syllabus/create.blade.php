		...
		<div>
			...
			<div class="navbar templatemo-nav" id="navbar">
	      	...
	      	<div class="breadcrumb flat">
    			...
    			{!! Form::open(array('route' => 'syllabus.store', 'data-parsley-validate' => '', 'files' => true)) !!}

					      	<div class="input-group" style="width: 100%;">
						      <span class="input-group-addon" style="width: 20%;" id="title">Title</span>
				    ...
				    <tbody>
				      <tr>
				        ...
				        <td id="but" align="right"><button>Publish</button></td>
				        	...
				        	{{ HTML::image('images/edit.png', 'a Edit', array('class' => 'img-responsive cleaner', 'width' => '15', 'height' => '15')) }}</a></center></td>

				        	<td>{!! Form::open(['route' => ['syllabus.destroy', $syllabus->id], 'method' => 'DELETE', 'onsubmit' => 'return ConfirmDelete()']) !!}

				        	{!! Form::image('images/delete.ico', 'a Delete', ['type' => 'submit', 'class' => 'img-responsive cleaner', 'width' => '15', 'height' => '15'] ) !!}
