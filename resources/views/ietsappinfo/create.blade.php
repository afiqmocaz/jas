		...
		<div>
			...
			<div class="navbar templatemo-nav" id="navbar">
	      	...
	      	<div class="breadcrumb flat">
				    ...
				    <a href="#">APPLICANT</a>
				    <a href="{{ url('ietsapplicant/create') }}">Applicant Registration</a>
				    <a class="active">Applicant Information</a>        
				  </div>
				</div>
				...
				<div style="width: 100%;" class="panel-group" >
				    <div class="panel panel-primary" style="border-color:#4CAF50;">
				      ...
				      <div id="collapse1" class="panel-collapse collapse">
				        ...
				        •  In this form, Secretariat IETS can view the selected applicant personal information that had been filled by applicant.<br>
						•  Secretariat IETS can approve and decline the applicant personal information.<br>
						•  Secretariat IETS can comment the applicant personal information.<br>
    			...
    			<br><iframe src="{{ url('ietsapp/show') }}" width="200" height="500" scrolling="yes">
  				<p>Your browser does not support iframes.</p>
				</iframe>

				<form>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
				<input type=button name=print value="Print" class="btn btn-success" onClick="printExternal('{{ url('ietsapp/show') }}')">
				</form>

					<center><form action="{{ url('ietsapplicant/show') }}" method="get">

						<center><br><label><b>Comment : </b></label>

						<textarea rows="4" cols="80" name="comment2">Good.
						</textarea></center><br>

					    <button type="submit" class="btn btn-success" name="subject2" value="Approved"/>Approve</button>
					    <button type="submit" class="btn btn-success" name="subject2" value="Declined"/>Decline</button>
					</form></center><br><br>
