...
@section('content') 
				...
				{!! Form::model($user, ['route' =>['ietsappinfo.update', $ietsApplicant->id], 'method' => 'PUT', 'files' => true]) !!}
    			...
    			<br>
                        ...
                        <iframe src="/ietsapp/{{$user->id}}/edit" id="print" width="100%" height="1000" scrolling="yes" >
                            <p>Your browser does not support iframes.</p>
			</iframe>
                      
                            <input type=button name=print value="Print" class="btn btn-success " style="width:150px;" onClick="printExternal('/ietsapp/{{$user->id}}/edit')">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr>
                                 ...
                                 <td>
                                    comment :
                                    {{ Form::textarea('comment', $ietsApplicant->comment, ['class' => 'form-control', 'rows' => '5', 'cols' => '60', 'placeholder'=>'comment']) }}
                                    
                                    <br>
                                   <b>
                                    {{Form::radio('status', 'Approved',array('selected'=>'true'))}}
                                    Approve
                                    &nbsp;  &nbsp;  &nbsp;  
...
<!--
						...
						{{ Form::textarea('comment', $ietsApplicant->comment, ['class' => 'form-control', 'style' => 'width:70%', 'rows' => '5', 'cols' => '60']) }}</center><br>
