        ...
        <div id="main_container">
            <div>
                ...
                <div class="breadcrumb flat">
                    ...
                    <a href="#">MANAGE</a>
                    <a href="#">Comprehensive Examination</a>
            ...
            <div class="container" >
                ...
                <table class="table table-bordered" width="50%" align="center">
                    ...
                    <td>{{$eiaquestions->ietsrelated->ietsrelated}}</td>
                    <td>
                    <center>
                        <a href="{{ route('ietsquestion.edit', $eiaquestions->id) }}" >
                            {{ HTML::image('images/edit.png', 'a Edit', array( 'width' => '20', 'title' => 'Edit')) }}</a> 

                        {!! Form::open(['route' => ['ietsquestion.destroy', $eiaquestions->id], 'method' => 'DELETE', 'onsubmit' => 'return ConfirmDelete()']) !!}
            ...
            <!-- Modal -->
             {!! Form::open(array('url'=>'ietsquestion/uploadFiles', 'route'=> ['ietsquestion.store'], 'data-parsley-validate' => '', 'method'=>'POST', 'enctype' => 'multipart/form-data', 'files'=>true)) !!}
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <table class="table table-bordered">
                                            <tr>
                                                <td>
                                                    <select id="ietsrelated" name="ietsrelated_id" class="form-control" required="" style="width:97.7%">
                                                        <option value="0" disabled="true" selected="true">--Please Select--</option>

                                                        @foreach($ietsrelates as $catr)
                                                        <option value="{!! $catr->id !!}">{!! $catr->ietsrelated !!}</option>
                                                        @endforeach
                                                    </select>
                                                </td>
                                            </tr>
