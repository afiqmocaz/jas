		...
		<div>
			...
			<div class="navbar templatemo-nav" id="navbar">
	      	...
	      	<div class="breadcrumb flat">
				    ...
				    <a href="#">MANAGE</a>
				    <a class="active">Profesional Interview</a>        
				  </div>
				</div>
				...
				<div style="width: 100%;" class="panel-group" >
				    <div class="panel panel-primary" style="border-color:#4CAF50;">
				      ...
				      <div id="collapse1" class="panel-collapse collapse">
				        ...
				        •  In this Form, Secretariat IETS can set the interview session for applicant and can set the attendance of the applicant.<br>
						•  Secretariat can click "Assign" button to set the date, time and venue of interview session.<br>
						•  Secretariat IETS can select the attendance of the applicant.
				        </div>
				      </div>
				    </div>
				  </div>
				...
				<input type="search" class="light-table-filter" data-table="order-table"  placeholder="Search..." style="width: 222px; float:right; margin-right: 0px"><br><br>
				...
				<table class="order-table table" id="list" style="width: 100%;">
				    <thead valign="top">
				      <tr>
				        ...
				        <th onclick="sortTable(1)" style="width: 14%;"><center>Applicant Name</center></th>
				        <th onclick="sortTable(2)" style="width: 14%;"><center>NRIC/Passport</center></th>
				        <th onclick="sortTable(3)" style="width: 14%;"><center>Applicant ID</center></th>
				        <th onclick="sortTable(4)" style="width: 12%;"><center>Set Interview Session</center></th>
				        <th onclick="sortTable(5)" style="width: 10%;"><center>Date of Interview</center></th>
				        <th onclick="sortTable(6)" style="width: 10%;"><center>Applicant Status</center></th>
				        <th onclick="sortTable(7)" style="width: 10%;"><center>Attendance</center></th>
				      </tr></thead>

				      <tbody>
				      @foreach($user as $users)
				      @foreach($ietsproiv as $ietsproivs)
				      <tr>
				        ...
				        <td><center><a href="{{ route('ietsivschedule.edit', $ietsivschedules->id) }}" style="background-color: #4CAF50; border: none; color: white; padding: 8px; text-align: center; text-decoration: none; display: font-size: 16px; margin: 4px 2px; cursor: pointer;">Assign</a>
						</center></td>
						@endforeach
				        <td>{{date('d/m/Y', strtotime($ietsproivs->date))}}</td>
				        <td></td>
				        <td><select>
