		...
		<div>
			...
			<div class="navbar templatemo-nav" id="navbar">
	      	...
	      	<div class="breadcrumb flat">
				    ...
				    <a class="active" style="color:white">ANNOUNCEMENT</a>        
				  </div>
				</div>
				...
				<div style="width: 100%;" class="panel-group" >
				    <div class="panel panel-primary" style="border-color:#4CAF50;">
				      ...
				      <div id="collapse1" class="panel-collapse collapse">
				        ...
				        •  Secretariat IETS can enter announcement by clicking the "Add Announcement" button.<br>
				...
				<table class="order-table table" id="myTable">
				    ...
				    @foreach($ietsannounce as $ietsannounces)
				      <tr>
				        ...
				        <td><a class="file" href="/images/{{$ietsannounces->fileToUpload}}">{{$ietsannounces->fileToUpload}}</a></td>
				        <td id="but">
				        	...
				        	{!! Form::open(['route' => ['ietsannounce.destroy', $ietsannounces->id], 'method' => 'DELETE', 'onsubmit' => 'return ConfirmDelete()']) !!}
