...
<h1 style="margin: 0px;font-size: 24px">Announcement Upload (Edit)&nbsp;<a id="popoverData" class="btn btn-primary" href="#" data-content='&bull;  Secretariat IETS can enter announcement in the text area and click button "Update".<br>
                        &bull;  The announcement entered by Secretariat IETS will be shown in the announcement box at the Home Page.'
...
{!! Form::model($ietsannounce, ['route' =>['ietsannounce.update', $ietsannounce->id], 'method' => 'PUT', 'files' => true]) !!}

<div class="form-group">

    <div class="input-group" style="width: 100%;">
        <span class="input-group-addon" style="width: 20%;" id="subject">Subject</span>
        {{ Form::text('subject', null, ['style' => 'width:100%', 'class' => 'form-control']) }}
    </div><br>

    <div class="input-group" style="width: 100%;">
        <span class="input-group-addon" style="width: 20%;" id="announcement">Announcement</span>
        {{ Form::textarea('announcement', null, ['style' => 'width:100%', 'class' => 'form-control', 'rows' => '4', 'cols' => '50']) }}
    </div><br>
    <div class="input-group" style="width: 100%;">
        <span class="input-group-addon" style="width: 20%;">Filename Uploaded </span>

        {{ Form::text('original_filename', null, ['style' => 'width:36.6%', 'class' => 'form-control','readonly']) }}
    </div><br>
    <div class="input-group" style="width: 100%;">
        <span class="input-group-addon" style="width: 20%;">Upload File (If Needed)</span>
        <center>
            <input id="original_filename" type="file" class="form-control" name="original_filename" accept=".pdf " onchange="myFunction(this)" multiple="multiple" style="width: 100%;">
        </center>
    </div>
    ...
    <div align="right">
        ...
        {!! Html::linkRoute('ietsannounce.show', 'Cancel', array($ietsannounce->id), array('class' => 'btn btn-primary')) !!}
    </div>
    ...
    <!-- <center>
        <table width="40%">
            ...
            <th>
            <center>{!! Html::linkRoute('ietsannounce.show', 'Cancel', array($ietsannounce->id), array('class' => 'btn btn-danger btn-block', 'style' => 'width:150px')) !!}</center>
            </th>
            </tr>
        </table></center> -->
