		...
		<div>
			...
			<div class="navbar templatemo-nav" id="navbar">
	      	...
	      	<div class="breadcrumb flat">
				    ...
				    <a href="#">APPLICANT</a>
				    <a href="{{ url('applicant/create') }}">Applicant Registration</a>
				    <a class="active" style="color:white">Applicant Information</a>        
				  </div>
				</div>
    			...
    			<br><iframe src="/apcsapp/{{$users->id}}/edit" id="print" width="200" height="500" scrolling="yes">
    			@endforeach
  				<p>Your browser does not support iframes.</p>
				</iframe>
					<form>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
				    <input type=button name=print value="Print" class="btn btn-success" onClick="printExternal('{{ url('apcsapp/1/edit') }}')">
				</form>

					

						<!-- <center><form action="{{ url('sendmail') }}" method="post"> -->

						<center><br><label><b>Comment : </b></label>

						<textarea rows="4" cols="80" name="comment">Good.
						</textarea></center><br>
					    ...
					    <!-- <button type="submit" class="btn btn-success" name="subject" value="Approved"/>Approve</button>
					    {{ csrf_field() }} -->
					    <center>
					    <table>
					    <tr>
					    <td>
					    <a href="{{route('sendEmail')}}" class="btn btn-block btn-primary" style="width:100%; padding-left: 15px; padding-right: 15px;">Approve</a>
					    </td>
					    <td style="width:10%;"></td>
					    <td>
					    <a href="" class="btn btn-block btn-primary" style="width:100%; padding-left: 15px; padding-right: 15px;">Decline</a></center>
					    </td>
					    </tr>
					    </table>
					    <!-- <button type="submit" class="btn btn-success" name="subject" value="Declined"/>Decline</button> -->
					<!-- </form></center> -->
					<br>

					@foreach($apcsSectionA as $apcsSectionAs)
					<input type="text" name="email" placeholder="{{$apcsSectionAs->email}}" hidden></input>
					@endforeach
