...
<div class="row">
	...
	<div class="col-md-3">
		<div class="well">
			...
			{!! Form::open(['route' => 'ietsexamtitle.store', 'method' => 'POST']) !!}

			{{ Form::label('ietsexamtitle', 'Exam Title:') }}
			{{ Form::text('ietsexamtitle', null, ['class' => 'form-control']) }}<br>
	...
	<div class="col-md-8">
		...
		<table class="table" style="width:100%">
			...
			<tbody>
				@foreach($ietsexamtitles as $category)
				<tr>
					<td></td>
					<td><center>{{ $category->ietsexamtitle }}</td>
					<td><center>{!! Form::open(['route' => ['ietsexamtitle.destroy', $category->id], 'method' => 'DELETE', 'onsubmit' => 'return ConfirmDelete()']) !!}
