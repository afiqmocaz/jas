		...
		<div>
			...
			<div class="navbar templatemo-nav" id="navbar">
	      	...
	      	<div class="breadcrumb flat">
				    ...
				    <a href="#">MANAGE</a>
				    <a href="{{ url('interview/iets') }}">Profesional Interview</a>
    			...
    			<div style="width: 100%;" class="panel-group" >
				    <div class="panel panel-primary" style="border-color:#4CAF50;">
				      ...
				      <div id="collapse1" class="panel-collapse collapse">
				        ...
				        •  Secretariat IETS can choose the date, time and enter venue of interview session at the text field provided.<br>
						•  Secretariat IETS can click "Confirm" button to confirm the date,time and venue that has been filled.<br>
						•  Secretariat IETS can view the date, time and date at the table below the "Confirm" button.<br>
						•  Secretariat IETS can click the "Email Applicant" to send the information of interview session to the applicant email.
				        </div>
				      </div>
				    </div>
				  </div>
				...
				<button id="myBtn" style="margin-left:15px;" class="btn btn-success" >Add New Interview Schedule</button>

				<button id="myBtn1" style="margin-left:20px;" class="btn btn-success" >Add New Venue</button>
    			...
    			<div id="myModal" class="modal">
				  ...
				  <div class="modal-content">
				    <div class="modal-header">
				      ...
				      <h2>Add New Interview Schedule</h2>
				    </div>
				    <div class="modal-body">
				      {!! Form::open(array('route' => 'ietsivschedule.store', 'data-parsley-validate' => '')) !!}
				        	...
				        	<div class="input-group" style="width: 100%;">
						    <span class="input-group-addon" style="width: 40%;" id="ietsvenue_id" name="ietsvenue_id">Venue</span>
						    <select id="ietsvenue" name="ietsvenue_id" onchange='ChangeVal(this.value);' class="form-control" required="" style="width:97.7%">
				...
				<input type="search" class="light-table-filter" data-table="order-table"  placeholder="Search..." class="form-control" style="width: 17%; float:right; margin-right:16px;"><br><br>
				...
				<table class="order-table table" id="list" style="width:80%;" align="center">
				    <thead valign="top">
				      ...
				      <tbody>
						@foreach($ietsivschedule as $ietsivschedules)
				      <tr>
				        <td></td>
				        <td>{{$ietsivschedules->title}}</td>
				        <td>{{ date('d/m/Y', strtotime($ietsivschedules->date))}}</td>
				        <td>{{ date('h:i A', strtotime($ietsivschedules->time))}}</td>
				        <td>{{$ietsivschedules->ietsvenue->ietsvenue}}<br>{{$ietsivschedules->address}}<br>{{$ietsivschedules->state}}</td>
				        <td id="but">
				        	<!-- <center>{!! HTML::linkRoute('ietsivschedule.edit', 'Edit', array($ietsivschedules->id), array('class' => 'btn btn-primary btn-block')) !!}</center><br> -->
				        	<center><a href="{{ route('ietsivschedule.edit', $ietsivschedules->id) }}" >
				        	{{ HTML::image('images/edit.png', 'a Edit', array( 'width' => '20', 'title' => 'Edit')) }}</a> </center><br></td>

				        	<td>{!! Form::open(['route' => ['ietsivschedule.destroy', $ietsivschedules->id], 'method' => 'DELETE', 'onsubmit' => 'return ConfirmDelete()']) !!}
