			...
			<div class="navbar templatemo-nav" id="navbar">
	      	...
	      	<div class="breadcrumb flat">
    			...
    			<div style="width: 100%;" class="panel-group" >
				  ...
				  <br><button id="myBtn1" style="margin-left:20px;" class="btn btn-success" >Add New Venue</button><br>
    			...
    			{!! Form::model($ietsivschedule, ['route' =>['ietsivschedule.update', $ietsivschedule->id], 'method' => 'PUT']) !!}
						    ...
						    {{ Form::select('ietsvenue_id', $ietsvenues, null, ['style' => 'width:97.7%;', 'class' => 'form-control', 'onChange' => 'ChangeVal(this.value);']) }}
...
<!-- 
 ...
 -->
					     ...
					     <th>
					      <center>{!! Html::linkRoute('ietsproiv.create', 'Cancel', array($ietsivschedule->id), array('class' => 'btn btn-danger btn-block', 'style' => 'width:150px')) !!}</center>
					      </th>
					      </tr>
					      </table></center>
					    </div>
