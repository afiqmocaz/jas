				...
				<table class="order-table table" id="list">
				    <thead>
				      ...
				      <tr>
				        ...
				        <td>{{$ietsivschedules->venue}}<br>{{$ietsivschedules->address}}<br>{{$ietsivschedules->state}}</td>
				        <td id="but">
				        	...
				        	{!! Form::open(['route' => ['ietsivschedule.destroy', $ietsivschedules->id], 'method' => 'DELETE', 'onsubmit' => 'return ConfirmDelete()']) !!}
